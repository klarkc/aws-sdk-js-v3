...
const AWS_TEMPLATE = "servicediscovery.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "servicediscovery.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "servicediscovery.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "servicediscovery.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "servicediscovery.{region}.amazonaws.com";
// Partition regions
