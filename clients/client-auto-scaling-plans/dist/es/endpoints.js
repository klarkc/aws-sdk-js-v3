...
var AWS_TEMPLATE = "autoscaling-plans.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "autoscaling-plans.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "autoscaling-plans.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "autoscaling-plans.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "autoscaling-plans.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
  ...
  return Promise.resolve(__assign({ signingService: "autoscaling-plans" }, regionInfo));
};
