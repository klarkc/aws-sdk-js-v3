...
var AWS_TEMPLATE = "ds.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "ds.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "ds.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "ds.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "ds.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "eu-south-1":
            regionInfo = {
                hostname: "ds.eu-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-west-1":
        ...
        case "eu-west-3":
            regionInfo = {
                hostname: "ds.eu-west-3.amazonaws.com",
                partition: "aws",
            };
            break;
        ...
        case "me-south-1":
            regionInfo = {
                hostname: "ds.me-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "sa-east-1":
    ...
    return Promise.resolve(__assign({ signingService: "ds" }, regionInfo));
};
