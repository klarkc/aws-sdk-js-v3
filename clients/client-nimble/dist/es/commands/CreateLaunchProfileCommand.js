...
import { deserializeAws_restJson1CreateLaunchProfileCommand, serializeAws_restJson1CreateLaunchProfileCommand, } from "../protocols/Aws_restJson1";
 ...
 *
 */
var CreateLaunchProfileCommand = /** @class */ (function (_super) {
    __extends(CreateLaunchProfileCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function CreateLaunchProfileCommand(input) {
        var _this = 
     ...
     * @internal
     */
    CreateLaunchProfileCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "NimbleClient";
        var commandName = "CreateLaunchProfileCommand";
    ...
    CreateLaunchProfileCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1CreateLaunchProfileCommand(input, context);
    };
    CreateLaunchProfileCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1CreateLaunchProfileCommand(output, context);
    };
    return CreateLaunchProfileCommand;
}($Command));
export { CreateLaunchProfileCommand };
//# sourceMappingURL=CreateLaunchProfileCommand.js.map