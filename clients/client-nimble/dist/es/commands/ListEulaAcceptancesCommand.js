...
import { deserializeAws_restJson1ListEulaAcceptancesCommand, serializeAws_restJson1ListEulaAcceptancesCommand, } from "../protocols/Aws_restJson1";
 ...
 *
 */
var ListEulaAcceptancesCommand = /** @class */ (function (_super) {
    __extends(ListEulaAcceptancesCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListEulaAcceptancesCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListEulaAcceptancesCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "NimbleClient";
        var commandName = "ListEulaAcceptancesCommand";
    ...
    ListEulaAcceptancesCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1ListEulaAcceptancesCommand(input, context);
    };
    ListEulaAcceptancesCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1ListEulaAcceptancesCommand(output, context);
    };
    return ListEulaAcceptancesCommand;
}($Command));
export { ListEulaAcceptancesCommand };
//# sourceMappingURL=ListEulaAcceptancesCommand.js.map