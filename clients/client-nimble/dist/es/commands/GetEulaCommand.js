...
import { deserializeAws_restJson1GetEulaCommand, serializeAws_restJson1GetEulaCommand, } from "../protocols/Aws_restJson1";
 ...
 *
 */
var GetEulaCommand = /** @class */ (function (_super) {
    __extends(GetEulaCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function GetEulaCommand(input) {
        var _this = 
     ...
     * @internal
     */
    GetEulaCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "NimbleClient";
        var commandName = "GetEulaCommand";
    ...
    GetEulaCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1GetEulaCommand(input, context);
    };
    GetEulaCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1GetEulaCommand(output, context);
    };
    return GetEulaCommand;
}($Command));
export { GetEulaCommand };
//# sourceMappingURL=GetEulaCommand.js.map