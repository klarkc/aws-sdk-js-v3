...
import { deserializeAws_json1_1GetAggregateConformancePackComplianceSummaryCommand, serializeAws_json1_1GetAggregateConformancePackComplianceSummaryCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var GetAggregateConformancePackComplianceSummaryCommand = /** @class */ (function (_super) {
    __extends(GetAggregateConformancePackComplianceSummaryCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function GetAggregateConformancePackComplianceSummaryCommand(input) {
        var _this = 
     ...
     * @internal
     */
    GetAggregateConformancePackComplianceSummaryCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "ConfigServiceClient";
        var commandName = "GetAggregateConformancePackComplianceSummaryCommand";
    ...
    GetAggregateConformancePackComplianceSummaryCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1GetAggregateConformancePackComplianceSummaryCommand(input, context);
    };
    GetAggregateConformancePackComplianceSummaryCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1GetAggregateConformancePackComplianceSummaryCommand(output, context);
    };
    return GetAggregateConformancePackComplianceSummaryCommand;
}($Command));
export { GetAggregateConformancePackComplianceSummaryCommand };
