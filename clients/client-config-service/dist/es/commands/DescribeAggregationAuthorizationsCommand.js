...
import { deserializeAws_json1_1DescribeAggregationAuthorizationsCommand, serializeAws_json1_1DescribeAggregationAuthorizationsCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var DescribeAggregationAuthorizationsCommand = /** @class */ (function (_super) {
    __extends(DescribeAggregationAuthorizationsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DescribeAggregationAuthorizationsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DescribeAggregationAuthorizationsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "ConfigServiceClient";
        var commandName = "DescribeAggregationAuthorizationsCommand";
    ...
    DescribeAggregationAuthorizationsCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DescribeAggregationAuthorizationsCommand(input, context);
    };
    DescribeAggregationAuthorizationsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DescribeAggregationAuthorizationsCommand(output, context);
    };
    return DescribeAggregationAuthorizationsCommand;
}($Command));
export { DescribeAggregationAuthorizationsCommand };
