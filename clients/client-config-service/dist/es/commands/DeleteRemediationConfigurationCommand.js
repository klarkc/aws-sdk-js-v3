...
import { deserializeAws_json1_1DeleteRemediationConfigurationCommand, serializeAws_json1_1DeleteRemediationConfigurationCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var DeleteRemediationConfigurationCommand = /** @class */ (function (_super) {
    __extends(DeleteRemediationConfigurationCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DeleteRemediationConfigurationCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DeleteRemediationConfigurationCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "ConfigServiceClient";
        var commandName = "DeleteRemediationConfigurationCommand";
    ...
    DeleteRemediationConfigurationCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DeleteRemediationConfigurationCommand(input, context);
    };
    DeleteRemediationConfigurationCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DeleteRemediationConfigurationCommand(output, context);
    };
    return DeleteRemediationConfigurationCommand;
}($Command));
export { DeleteRemediationConfigurationCommand };
//# sourceMappingURL=DeleteRemediationConfigurationCommand.js.map