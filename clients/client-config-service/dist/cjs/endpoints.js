...
const AWS_TEMPLATE = "config.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "config.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "config.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "config.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "config.{region}.amazonaws.com";
// Partition regions
