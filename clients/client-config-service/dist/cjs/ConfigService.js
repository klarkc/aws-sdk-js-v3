...
const DeleteStoredQueryCommand_1 = require("./commands/DeleteStoredQueryCommand");
...
const GetAggregateConformancePackComplianceSummaryCommand_1 = require("./commands/GetAggregateConformancePackComplianceSummaryCommand");
...
const GetStoredQueryCommand_1 = require("./commands/GetStoredQueryCommand");
...
const PutExternalEvaluationCommand_1 = require("./commands/PutExternalEvaluationCommand");
...
const PutStoredQueryCommand_1 = require("./commands/PutStoredQueryCommand");
const SelectAggregateResourceConfigCommand_1 = require("./commands/SelectAggregateResourceConfigCommand");
...
class ConfigService extends ConfigServiceClient_1.ConfigServiceClient {
    ...
    deleteStoredQuery(args, optionsOrCb, cb) {
        const command = new DeleteStoredQueryCommand_1.DeleteStoredQueryCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
    ...
    describeAggregateComplianceByConformancePacks(args, optionsOrCb, cb) {
        const command = new DescribeAggregateComplianceByConformancePacksCommand_1.DescribeAggregateComplianceByConformancePacksCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
    ...
    getAggregateConformancePackComplianceSummary(args, optionsOrCb, cb) {
        const command = new GetAggregateConformancePackComplianceSummaryCommand_1.GetAggregateConformancePackComplianceSummaryCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
    ...
    getStoredQuery(args, optionsOrCb, cb) {
        const command = new GetStoredQueryCommand_1.GetStoredQueryCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
    ...
    listStoredQueries(args, optionsOrCb, cb) {
        const command = new ListStoredQueriesCommand_1.ListStoredQueriesCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
    ...
    putExternalEvaluation(args, optionsOrCb, cb) {
        const command = new PutExternalEvaluationCommand_1.PutExternalEvaluationCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
    ...
    putStoredQuery(args, optionsOrCb, cb) {
        const command = new PutStoredQueryCommand_1.PutStoredQueryCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
    ...
    selectAggregateResourceConfig(args, optionsOrCb, cb) {
        const command = new SelectAggregateResourceConfigCommand_1.SelectAggregateResourceConfigCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
