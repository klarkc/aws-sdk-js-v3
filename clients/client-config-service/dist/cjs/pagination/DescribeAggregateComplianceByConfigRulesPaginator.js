...
exports.paginateDescribeAggregateComplianceByConfigRules = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeAggregateComplianceByConfigRulesCommand_1.DescribeAggregateComplianceByConfigRulesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeAggregateComplianceByConfigRules(config, input, ...additionalArguments) {
