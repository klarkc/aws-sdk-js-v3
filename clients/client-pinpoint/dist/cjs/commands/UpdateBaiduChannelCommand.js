...
exports.UpdateBaiduChannelCommand = void 0;
 ...
 *
 */
class UpdateBaiduChannelCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.UpdateBaiduChannelRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_1_1.UpdateBaiduChannelResponse.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1UpdateBaiduChannelCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1UpdateBaiduChannelCommand(output, context);
    }
}
exports.UpdateBaiduChannelCommand = UpdateBaiduChannelCommand;
