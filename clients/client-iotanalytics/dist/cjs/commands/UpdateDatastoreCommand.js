...
exports.UpdateDatastoreCommand = void 0;
 ...
 *
 */
class UpdateDatastoreCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.UpdateDatastoreRequest.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1UpdateDatastoreCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1UpdateDatastoreCommand(output, context);
    }
}
exports.UpdateDatastoreCommand = UpdateDatastoreCommand;
