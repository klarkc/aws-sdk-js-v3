...
exports.DeleteDatasetContentCommand = void 0;
 ...
 *
 */
class DeleteDatasetContentCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DeleteDatasetContentRequest.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1DeleteDatasetContentCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1DeleteDatasetContentCommand(output, context);
    }
}
exports.DeleteDatasetContentCommand = DeleteDatasetContentCommand;
