...
exports.GetDatasetContentCommand = void 0;
 ...
 *
 */
class GetDatasetContentCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.GetDatasetContentRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.GetDatasetContentResponse.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1GetDatasetContentCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1GetDatasetContentCommand(output, context);
    }
}
exports.GetDatasetContentCommand = GetDatasetContentCommand;
