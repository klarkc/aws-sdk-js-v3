...
var AWS_TEMPLATE = "iotanalytics.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "iotanalytics.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "iotanalytics.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "iotanalytics.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "iotanalytics.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "ap-southeast-2":
            regionInfo = {
                hostname: "iotanalytics.ap-southeast-2.amazonaws.com",
                partition: "aws",
            };
            break;
        case "cn-north-1":
    ...
    return Promise.resolve(__assign({ signingService: "iotanalytics" }, regionInfo));
};
