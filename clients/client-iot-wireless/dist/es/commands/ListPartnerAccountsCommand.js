 ...
 *
 */
var ListPartnerAccountsCommand = /** @class */ (function (_super) {
    __extends(ListPartnerAccountsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListPartnerAccountsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListPartnerAccountsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "IoTWirelessClient";
        var commandName = "ListPartnerAccountsCommand";
    ...
    ListPartnerAccountsCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1ListPartnerAccountsCommand(input, context);
    };
    ListPartnerAccountsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1ListPartnerAccountsCommand(output, context);
    };
    return ListPartnerAccountsCommand;
}($Command));
export { ListPartnerAccountsCommand };
