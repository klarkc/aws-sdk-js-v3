 ...
 *
 */
var ListWirelessGatewaysCommand = /** @class */ (function (_super) {
    __extends(ListWirelessGatewaysCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListWirelessGatewaysCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListWirelessGatewaysCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "IoTWirelessClient";
        var commandName = "ListWirelessGatewaysCommand";
    ...
    ListWirelessGatewaysCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1ListWirelessGatewaysCommand(output, context);
    };
    return ListWirelessGatewaysCommand;
}($Command));
