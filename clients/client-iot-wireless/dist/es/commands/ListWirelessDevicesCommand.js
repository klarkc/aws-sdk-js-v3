 ...
 *
 */
var ListWirelessDevicesCommand = /** @class */ (function (_super) {
    __extends(ListWirelessDevicesCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListWirelessDevicesCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListWirelessDevicesCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "IoTWirelessClient";
        var commandName = "ListWirelessDevicesCommand";
    ...
    ListWirelessDevicesCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1ListWirelessDevicesCommand(output, context);
    };
    return ListWirelessDevicesCommand;
}($Command));
