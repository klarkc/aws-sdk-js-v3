 ...
 *
 */
var DisassociateAwsAccountFromPartnerAccountCommand = /** @class */ (function (_super) {
    __extends(DisassociateAwsAccountFromPartnerAccountCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DisassociateAwsAccountFromPartnerAccountCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DisassociateAwsAccountFromPartnerAccountCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "IoTWirelessClient";
        var commandName = "DisassociateAwsAccountFromPartnerAccountCommand";
    ...
    DisassociateAwsAccountFromPartnerAccountCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1DisassociateAwsAccountFromPartnerAccountCommand(output, context);
    };
    return DisassociateAwsAccountFromPartnerAccountCommand;
}($Command));
