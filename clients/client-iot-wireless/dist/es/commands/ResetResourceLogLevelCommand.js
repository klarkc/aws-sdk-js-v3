 ...
 *
 */
var ResetResourceLogLevelCommand = /** @class */ (function (_super) {
    __extends(ResetResourceLogLevelCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ResetResourceLogLevelCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ResetResourceLogLevelCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "IoTWirelessClient";
        var commandName = "ResetResourceLogLevelCommand";
    ...
    ResetResourceLogLevelCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1ResetResourceLogLevelCommand(output, context);
    };
    return ResetResourceLogLevelCommand;
}($Command));
