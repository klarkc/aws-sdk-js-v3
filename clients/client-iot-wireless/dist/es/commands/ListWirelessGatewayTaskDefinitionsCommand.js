 ...
 *
 */
var ListWirelessGatewayTaskDefinitionsCommand = /** @class */ (function (_super) {
    __extends(ListWirelessGatewayTaskDefinitionsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListWirelessGatewayTaskDefinitionsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListWirelessGatewayTaskDefinitionsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "IoTWirelessClient";
        var commandName = "ListWirelessGatewayTaskDefinitionsCommand";
    ...
    ListWirelessGatewayTaskDefinitionsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1ListWirelessGatewayTaskDefinitionsCommand(output, context);
    };
    return ListWirelessGatewayTaskDefinitionsCommand;
}($Command));
