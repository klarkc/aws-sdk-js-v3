...
var AWS_TEMPLATE = "api.ecr.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "api.ecr.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "api.ecr.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "api.ecr.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "api.ecr.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "ecr" }, regionInfo));
};
