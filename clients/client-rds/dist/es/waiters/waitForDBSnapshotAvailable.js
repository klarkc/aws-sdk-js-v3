...
var checkState = function (client, input) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_u) {
        switch (_u.label) {
            case 0:
                _u.trys.push([0, 2, , 3]);
                return [4 /*yield*/, client.send(new DescribeDBSnapshotsCommand(input))];
            case 1:
                result_1 = _u.sent();
                reason = result_1;
                try {
                    returnComparator = function () {
                        var flat_1 = [].concat.apply([], __spreadArray([], __read(result_1.DBSnapshots)));
...
//# sourceMappingURL=waitForDBSnapshotAvailable.js.map