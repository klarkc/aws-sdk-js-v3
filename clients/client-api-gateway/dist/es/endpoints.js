...
var AWS_TEMPLATE = "apigateway.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "apigateway.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "apigateway.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "apigateway.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "apigateway.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
  ...
  switch (region) {
    ...
    case "eu-south-1":
      regionInfo = {
        hostname: "apigateway.eu-south-1.amazonaws.com",
        partition: "aws",
      };
      break;
    case "eu-west-1":
  ...
  return Promise.resolve(__assign({ signingService: "apigateway" }, regionInfo));
};
