...
const audio = fs_1.createReadStream(path_1.join(__dirname, "speech.wav"));
describe("TranscribeStream client", () => {
    const client = new index_1.TranscribeStreaming({});
    afterAll(() => {
        client.destroy();
    });
...
//# sourceMappingURL=index.integ.spec.js.map