...
class TranscribeStreamingClient extends smithy_client_1.Client {
    constructor(configuration) {
        ...
        let _config_7 = middleware_sdk_transcribe_streaming_1.resolveWebSocketConfig(_config_6);
        let _config_8 = middleware_user_agent_1.resolveUserAgentConfig(_config_7);
        let _config_9 = eventstream_serde_config_resolver_1.resolveEventStreamSerdeConfig(_config_8);
        super(_config_9);
