...
var AWS_TEMPLATE = "transcribestreaming.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "transcribestreaming.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "transcribestreaming.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "transcribestreaming.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "transcribestreaming.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "transcribe" }, regionInfo));
};
