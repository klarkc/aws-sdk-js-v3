 ...
 *
 */
var DescribeModelExplainabilityJobDefinitionCommand = /** @class */ (function (_super) {
    __extends(DescribeModelExplainabilityJobDefinitionCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DescribeModelExplainabilityJobDefinitionCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DescribeModelExplainabilityJobDefinitionCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SageMakerClient";
        var commandName = "DescribeModelExplainabilityJobDefinitionCommand";
    ...
    DescribeModelExplainabilityJobDefinitionCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DescribeModelExplainabilityJobDefinitionCommand(input, context);
    };
    DescribeModelExplainabilityJobDefinitionCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DescribeModelExplainabilityJobDefinitionCommand(output, context);
    };
    return DescribeModelExplainabilityJobDefinitionCommand;
}($Command));
export { DescribeModelExplainabilityJobDefinitionCommand };
//# sourceMappingURL=DescribeModelExplainabilityJobDefinitionCommand.js.map