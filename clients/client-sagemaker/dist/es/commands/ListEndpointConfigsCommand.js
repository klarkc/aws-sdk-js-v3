...
import { deserializeAws_json1_1ListEndpointConfigsCommand, serializeAws_json1_1ListEndpointConfigsCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var ListEndpointConfigsCommand = /** @class */ (function (_super) {
    __extends(ListEndpointConfigsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListEndpointConfigsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListEndpointConfigsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SageMakerClient";
        var commandName = "ListEndpointConfigsCommand";
    ...
    ListEndpointConfigsCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1ListEndpointConfigsCommand(input, context);
    };
    ListEndpointConfigsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1ListEndpointConfigsCommand(output, context);
    };
    return ListEndpointConfigsCommand;
}($Command));
export { ListEndpointConfigsCommand };
