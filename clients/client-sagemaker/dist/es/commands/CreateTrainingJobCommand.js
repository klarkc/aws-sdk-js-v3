...
import { deserializeAws_json1_1CreateTrainingJobCommand, serializeAws_json1_1CreateTrainingJobCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var CreateTrainingJobCommand = /** @class */ (function (_super) {
    __extends(CreateTrainingJobCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function CreateTrainingJobCommand(input) {
        var _this = 
     ...
     * @internal
     */
    CreateTrainingJobCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SageMakerClient";
        var commandName = "CreateTrainingJobCommand";
    ...
    CreateTrainingJobCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1CreateTrainingJobCommand(input, context);
    };
    CreateTrainingJobCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1CreateTrainingJobCommand(output, context);
    };
    return CreateTrainingJobCommand;
}($Command));
export { CreateTrainingJobCommand };
