...
import { deserializeAws_json1_1ListDeviceFleetsCommand, serializeAws_json1_1ListDeviceFleetsCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var ListDeviceFleetsCommand = /** @class */ (function (_super) {
    __extends(ListDeviceFleetsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListDeviceFleetsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListDeviceFleetsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SageMakerClient";
        var commandName = "ListDeviceFleetsCommand";
    ...
    ListDeviceFleetsCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1ListDeviceFleetsCommand(input, context);
    };
    ListDeviceFleetsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1ListDeviceFleetsCommand(output, context);
    };
    return ListDeviceFleetsCommand;
}($Command));
export { ListDeviceFleetsCommand };
