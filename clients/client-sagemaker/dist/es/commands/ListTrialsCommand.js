 ...
 *
 */
var ListTrialsCommand = /** @class */ (function (_super) {
    __extends(ListTrialsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListTrialsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListTrialsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SageMakerClient";
        var commandName = "ListTrialsCommand";
    ...
    ListTrialsCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1ListTrialsCommand(input, context);
    };
    ListTrialsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1ListTrialsCommand(output, context);
    };
    return ListTrialsCommand;
}($Command));
export { ListTrialsCommand };
//# sourceMappingURL=ListTrialsCommand.js.map