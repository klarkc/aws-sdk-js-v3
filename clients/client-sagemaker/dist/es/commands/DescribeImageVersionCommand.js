 ...
 *
 */
var DescribeImageVersionCommand = /** @class */ (function (_super) {
    __extends(DescribeImageVersionCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DescribeImageVersionCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DescribeImageVersionCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SageMakerClient";
        var commandName = "DescribeImageVersionCommand";
    ...
    DescribeImageVersionCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DescribeImageVersionCommand(input, context);
    };
    DescribeImageVersionCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DescribeImageVersionCommand(output, context);
    };
    return DescribeImageVersionCommand;
}($Command));
export { DescribeImageVersionCommand };
