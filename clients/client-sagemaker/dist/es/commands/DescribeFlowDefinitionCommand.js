 ...
 *
 */
var DescribeFlowDefinitionCommand = /** @class */ (function (_super) {
    __extends(DescribeFlowDefinitionCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DescribeFlowDefinitionCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DescribeFlowDefinitionCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SageMakerClient";
        var commandName = "DescribeFlowDefinitionCommand";
    ...
    DescribeFlowDefinitionCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DescribeFlowDefinitionCommand(input, context);
    };
    DescribeFlowDefinitionCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DescribeFlowDefinitionCommand(output, context);
    };
    return DescribeFlowDefinitionCommand;
}($Command));
export { DescribeFlowDefinitionCommand };
