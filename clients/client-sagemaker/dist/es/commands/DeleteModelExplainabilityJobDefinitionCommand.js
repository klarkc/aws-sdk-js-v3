...
import { deserializeAws_json1_1DeleteModelExplainabilityJobDefinitionCommand, serializeAws_json1_1DeleteModelExplainabilityJobDefinitionCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var DeleteModelExplainabilityJobDefinitionCommand = /** @class */ (function (_super) {
    __extends(DeleteModelExplainabilityJobDefinitionCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DeleteModelExplainabilityJobDefinitionCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DeleteModelExplainabilityJobDefinitionCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SageMakerClient";
        var commandName = "DeleteModelExplainabilityJobDefinitionCommand";
    ...
    DeleteModelExplainabilityJobDefinitionCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DeleteModelExplainabilityJobDefinitionCommand(input, context);
    };
    DeleteModelExplainabilityJobDefinitionCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DeleteModelExplainabilityJobDefinitionCommand(output, context);
    };
    return DeleteModelExplainabilityJobDefinitionCommand;
}($Command));
export { DeleteModelExplainabilityJobDefinitionCommand };
