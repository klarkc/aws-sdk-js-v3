...
import { deserializeAws_json1_1DeleteActionCommand, serializeAws_json1_1DeleteActionCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var DeleteActionCommand = /** @class */ (function (_super) {
    __extends(DeleteActionCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DeleteActionCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DeleteActionCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SageMakerClient";
        var commandName = "DeleteActionCommand";
    ...
    DeleteActionCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DeleteActionCommand(input, context);
    };
    DeleteActionCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DeleteActionCommand(output, context);
    };
    return DeleteActionCommand;
}($Command));
export { DeleteActionCommand };
