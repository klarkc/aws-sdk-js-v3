...
import { deserializeAws_json1_1CreateLabelingJobCommand, serializeAws_json1_1CreateLabelingJobCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var CreateLabelingJobCommand = /** @class */ (function (_super) {
    __extends(CreateLabelingJobCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function CreateLabelingJobCommand(input) {
        var _this = 
     ...
     * @internal
     */
    CreateLabelingJobCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SageMakerClient";
        var commandName = "CreateLabelingJobCommand";
    ...
    CreateLabelingJobCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1CreateLabelingJobCommand(input, context);
    };
    CreateLabelingJobCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1CreateLabelingJobCommand(output, context);
    };
    return CreateLabelingJobCommand;
}($Command));
export { CreateLabelingJobCommand };
