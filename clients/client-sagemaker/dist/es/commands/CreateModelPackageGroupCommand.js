...
import { deserializeAws_json1_1CreateModelPackageGroupCommand, serializeAws_json1_1CreateModelPackageGroupCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var CreateModelPackageGroupCommand = /** @class */ (function (_super) {
    __extends(CreateModelPackageGroupCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function CreateModelPackageGroupCommand(input) {
        var _this = 
     ...
     * @internal
     */
    CreateModelPackageGroupCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SageMakerClient";
        var commandName = "CreateModelPackageGroupCommand";
    ...
    CreateModelPackageGroupCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1CreateModelPackageGroupCommand(input, context);
    };
    CreateModelPackageGroupCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1CreateModelPackageGroupCommand(output, context);
    };
    return CreateModelPackageGroupCommand;
}($Command));
export { CreateModelPackageGroupCommand };
