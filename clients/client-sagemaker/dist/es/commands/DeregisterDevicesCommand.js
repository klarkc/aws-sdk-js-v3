...
import { deserializeAws_json1_1DeregisterDevicesCommand, serializeAws_json1_1DeregisterDevicesCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var DeregisterDevicesCommand = /** @class */ (function (_super) {
    __extends(DeregisterDevicesCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DeregisterDevicesCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DeregisterDevicesCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SageMakerClient";
        var commandName = "DeregisterDevicesCommand";
    ...
    DeregisterDevicesCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DeregisterDevicesCommand(input, context);
    };
    DeregisterDevicesCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DeregisterDevicesCommand(output, context);
    };
    return DeregisterDevicesCommand;
}($Command));
export { DeregisterDevicesCommand };
//# sourceMappingURL=DeregisterDevicesCommand.js.map