...
import { deserializeAws_json1_1CreateProcessingJobCommand, serializeAws_json1_1CreateProcessingJobCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var CreateProcessingJobCommand = /** @class */ (function (_super) {
    __extends(CreateProcessingJobCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function CreateProcessingJobCommand(input) {
        var _this = 
     ...
     * @internal
     */
    CreateProcessingJobCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SageMakerClient";
        var commandName = "CreateProcessingJobCommand";
    ...
    CreateProcessingJobCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1CreateProcessingJobCommand(input, context);
    };
    CreateProcessingJobCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1CreateProcessingJobCommand(output, context);
    };
    return CreateProcessingJobCommand;
}($Command));
export { CreateProcessingJobCommand };
