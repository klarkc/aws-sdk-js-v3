 ...
 *
 */
var ListWorkforcesCommand = /** @class */ (function (_super) {
    __extends(ListWorkforcesCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListWorkforcesCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListWorkforcesCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SageMakerClient";
        var commandName = "ListWorkforcesCommand";
    ...
    ListWorkforcesCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1ListWorkforcesCommand(input, context);
    };
    ListWorkforcesCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1ListWorkforcesCommand(output, context);
    };
    return ListWorkforcesCommand;
}($Command));
export { ListWorkforcesCommand };
//# sourceMappingURL=ListWorkforcesCommand.js.map