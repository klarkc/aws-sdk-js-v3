...
import { deserializeAws_json1_1CreateModelQualityJobDefinitionCommand, serializeAws_json1_1CreateModelQualityJobDefinitionCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var CreateModelQualityJobDefinitionCommand = /** @class */ (function (_super) {
    __extends(CreateModelQualityJobDefinitionCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function CreateModelQualityJobDefinitionCommand(input) {
        var _this = 
     ...
     * @internal
     */
    CreateModelQualityJobDefinitionCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SageMakerClient";
        var commandName = "CreateModelQualityJobDefinitionCommand";
    ...
    CreateModelQualityJobDefinitionCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1CreateModelQualityJobDefinitionCommand(input, context);
    };
    CreateModelQualityJobDefinitionCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1CreateModelQualityJobDefinitionCommand(output, context);
    };
    return CreateModelQualityJobDefinitionCommand;
}($Command));
export { CreateModelQualityJobDefinitionCommand };
