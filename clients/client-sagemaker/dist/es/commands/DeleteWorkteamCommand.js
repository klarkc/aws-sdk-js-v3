 ...
 *
 */
var DeleteWorkteamCommand = /** @class */ (function (_super) {
    __extends(DeleteWorkteamCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DeleteWorkteamCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DeleteWorkteamCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SageMakerClient";
        var commandName = "DeleteWorkteamCommand";
    ...
    DeleteWorkteamCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DeleteWorkteamCommand(input, context);
    };
    DeleteWorkteamCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DeleteWorkteamCommand(output, context);
    };
    return DeleteWorkteamCommand;
}($Command));
export { DeleteWorkteamCommand };
//# sourceMappingURL=DeleteWorkteamCommand.js.map