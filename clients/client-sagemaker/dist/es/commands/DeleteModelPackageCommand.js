...
import { deserializeAws_json1_1DeleteModelPackageCommand, serializeAws_json1_1DeleteModelPackageCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var DeleteModelPackageCommand = /** @class */ (function (_super) {
    __extends(DeleteModelPackageCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DeleteModelPackageCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DeleteModelPackageCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SageMakerClient";
        var commandName = "DeleteModelPackageCommand";
    ...
    DeleteModelPackageCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DeleteModelPackageCommand(input, context);
    };
    DeleteModelPackageCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DeleteModelPackageCommand(output, context);
    };
    return DeleteModelPackageCommand;
}($Command));
export { DeleteModelPackageCommand };
