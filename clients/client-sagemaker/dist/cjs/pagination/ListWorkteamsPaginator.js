...
exports.paginateListWorkteams = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListWorkteamsCommand_1.ListWorkteamsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListWorkteams(config, input, ...additionalArguments) {
