...
exports.paginateListNotebookInstanceLifecycleConfigs = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListNotebookInstanceLifecycleConfigsCommand_1.ListNotebookInstanceLifecycleConfigsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListNotebookInstanceLifecycleConfigs(config, input, ...additionalArguments) {
