...
exports.paginateListLabelingJobs = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListLabelingJobsCommand_1.ListLabelingJobsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListLabelingJobs(config, input, ...additionalArguments) {
