...
exports.paginateListDataQualityJobDefinitions = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListDataQualityJobDefinitionsCommand_1.ListDataQualityJobDefinitionsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListDataQualityJobDefinitions(config, input, ...additionalArguments) {
