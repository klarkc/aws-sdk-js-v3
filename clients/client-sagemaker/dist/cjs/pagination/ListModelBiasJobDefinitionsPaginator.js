...
exports.paginateListModelBiasJobDefinitions = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListModelBiasJobDefinitionsCommand_1.ListModelBiasJobDefinitionsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListModelBiasJobDefinitions(config, input, ...additionalArguments) {
