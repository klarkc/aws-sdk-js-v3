...
exports.paginateListDeviceFleets = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListDeviceFleetsCommand_1.ListDeviceFleetsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListDeviceFleets(config, input, ...additionalArguments) {
