...
exports.paginateListCodeRepositories = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListCodeRepositoriesCommand_1.ListCodeRepositoriesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListCodeRepositories(config, input, ...additionalArguments) {
