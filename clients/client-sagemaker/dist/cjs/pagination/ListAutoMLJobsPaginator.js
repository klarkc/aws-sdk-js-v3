...
exports.paginateListAutoMLJobs = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListAutoMLJobsCommand_1.ListAutoMLJobsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListAutoMLJobs(config, input, ...additionalArguments) {
