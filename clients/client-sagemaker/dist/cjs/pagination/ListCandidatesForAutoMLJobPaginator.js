...
exports.paginateListCandidatesForAutoMLJob = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListCandidatesForAutoMLJobCommand_1.ListCandidatesForAutoMLJobCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListCandidatesForAutoMLJob(config, input, ...additionalArguments) {
