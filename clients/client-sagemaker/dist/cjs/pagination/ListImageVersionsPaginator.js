...
exports.paginateListImageVersions = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListImageVersionsCommand_1.ListImageVersionsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListImageVersions(config, input, ...additionalArguments) {
