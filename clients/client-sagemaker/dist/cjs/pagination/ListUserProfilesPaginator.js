...
exports.paginateListUserProfiles = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListUserProfilesCommand_1.ListUserProfilesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListUserProfiles(config, input, ...additionalArguments) {
