...
exports.paginateListMonitoringSchedules = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListMonitoringSchedulesCommand_1.ListMonitoringSchedulesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListMonitoringSchedules(config, input, ...additionalArguments) {
