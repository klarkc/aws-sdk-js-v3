...
exports.paginateListTransformJobs = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListTransformJobsCommand_1.ListTransformJobsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListTransformJobs(config, input, ...additionalArguments) {
