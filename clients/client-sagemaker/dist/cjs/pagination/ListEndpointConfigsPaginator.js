...
exports.paginateListEndpointConfigs = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListEndpointConfigsCommand_1.ListEndpointConfigsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListEndpointConfigs(config, input, ...additionalArguments) {
