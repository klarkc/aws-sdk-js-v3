...
exports.paginateListSubscribedWorkteams = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListSubscribedWorkteamsCommand_1.ListSubscribedWorkteamsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListSubscribedWorkteams(config, input, ...additionalArguments) {
