...
exports.paginateListProcessingJobs = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListProcessingJobsCommand_1.ListProcessingJobsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListProcessingJobs(config, input, ...additionalArguments) {
