...
exports.paginateListLabelingJobsForWorkteam = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListLabelingJobsForWorkteamCommand_1.ListLabelingJobsForWorkteamCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListLabelingJobsForWorkteam(config, input, ...additionalArguments) {
