...
exports.paginateListHumanTaskUis = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListHumanTaskUisCommand_1.ListHumanTaskUisCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListHumanTaskUis(config, input, ...additionalArguments) {
