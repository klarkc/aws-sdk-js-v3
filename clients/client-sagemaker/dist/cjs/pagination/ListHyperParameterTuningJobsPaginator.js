...
exports.paginateListHyperParameterTuningJobs = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListHyperParameterTuningJobsCommand_1.ListHyperParameterTuningJobsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListHyperParameterTuningJobs(config, input, ...additionalArguments) {
