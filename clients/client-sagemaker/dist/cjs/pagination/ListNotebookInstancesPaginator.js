...
exports.paginateListNotebookInstances = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListNotebookInstancesCommand_1.ListNotebookInstancesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListNotebookInstances(config, input, ...additionalArguments) {
