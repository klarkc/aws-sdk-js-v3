...
exports.DeleteModelPackageGroupPolicyCommand = void 0;
...
class DeleteModelPackageGroupPolicyCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.DeleteModelPackageGroupPolicyInput.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_json1_1_1.serializeAws_json1_1DeleteModelPackageGroupPolicyCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_json1_1_1.deserializeAws_json1_1DeleteModelPackageGroupPolicyCommand(output, context);
    }
}
