...
exports.DeleteDataQualityJobDefinitionCommand = void 0;
...
class DeleteDataQualityJobDefinitionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.DeleteDataQualityJobDefinitionRequest.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_json1_1_1.serializeAws_json1_1DeleteDataQualityJobDefinitionCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_json1_1_1.deserializeAws_json1_1DeleteDataQualityJobDefinitionCommand(output, context);
    }
}
