...
const AWS_TEMPLATE = "api.sagemaker.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "api.sagemaker.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "api.sagemaker.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "api.sagemaker.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "api.sagemaker.{region}.amazonaws.com";
// Partition regions
