...
var AWS_TEMPLATE = "fsx.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "fsx.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "fsx.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "fsx.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "fsx.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "ap-northeast-2":
            regionInfo = {
                hostname: "fsx.ap-northeast-2.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-south-1":
            regionInfo = {
                hostname: "fsx.ap-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-southeast-1":
        ...
        case "cn-northwest-1":
            regionInfo = {
                hostname: "fsx.cn-northwest-1.amazonaws.com.cn",
                partition: "aws-cn",
            };
            break;
        case "eu-central-1":
        ...
        case "sa-east-1":
            regionInfo = {
                hostname: "fsx.sa-east-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "us-east-1":
    ...
    return Promise.resolve(__assign({ signingService: "fsx" }, regionInfo));
};
