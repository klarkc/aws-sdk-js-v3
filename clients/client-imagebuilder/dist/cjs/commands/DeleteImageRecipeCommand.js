...
exports.DeleteImageRecipeCommand = void 0;
 ...
 *
 */
class DeleteImageRecipeCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DeleteImageRecipeRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.DeleteImageRecipeResponse.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1DeleteImageRecipeCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1DeleteImageRecipeCommand(output, context);
    }
}
exports.DeleteImageRecipeCommand = DeleteImageRecipeCommand;
//# sourceMappingURL=DeleteImageRecipeCommand.js.map