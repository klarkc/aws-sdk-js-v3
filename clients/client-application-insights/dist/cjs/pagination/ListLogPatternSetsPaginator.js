...
const makePagedClientRequest = async (client, input, ...args) => {
  // @ts-ignore
  return await client.send(new ListLogPatternSetsCommand_1.ListLogPatternSetsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListLogPatternSets(config, input, ...additionalArguments) {
