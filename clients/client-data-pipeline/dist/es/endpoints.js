...
var AWS_TEMPLATE = "datapipeline.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "datapipeline.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "datapipeline.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "datapipeline.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "datapipeline.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "datapipeline" }, regionInfo));
};
