...
import { deserializeAws_restJson1GetBotAliasCommand, serializeAws_restJson1GetBotAliasCommand, } from "../protocols/Aws_restJson1";
 ...
 *
 */
var GetBotAliasCommand = /** @class */ (function (_super) {
    __extends(GetBotAliasCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function GetBotAliasCommand(input) {
        var _this = 
     ...
     * @internal
     */
    GetBotAliasCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "LexModelBuildingServiceClient";
        var commandName = "GetBotAliasCommand";
    ...
    GetBotAliasCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1GetBotAliasCommand(input, context);
    };
    GetBotAliasCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1GetBotAliasCommand(output, context);
    };
    return GetBotAliasCommand;
}($Command));
export { GetBotAliasCommand };
//# sourceMappingURL=GetBotAliasCommand.js.map