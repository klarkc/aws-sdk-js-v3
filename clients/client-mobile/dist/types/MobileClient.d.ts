...
export declare type ServiceInputTypes = CreateProjectCommandInput | DeleteProjectCommandInput | DescribeBundleCommandInput | DescribeProjectCommandInput | ExportBundleCommandInput | ExportProjectCommandInput | ListBundlesCommandInput | ListProjectsCommandInput | UpdateProjectCommandInput;
export declare type ServiceOutputTypes = CreateProjectCommandOutput | DeleteProjectCommandOutput | DescribeBundleCommandOutput | DescribeProjectCommandOutput | ExportBundleCommandOutput | ExportProjectCommandOutput | ListBundlesCommandOutput | ListProjectsCommandOutput | UpdateProjectCommandOutput;
...
declare type MobileClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & RetryInputConfig & HostHeaderInputConfig & AwsAuthInputConfig & UserAgentInputConfig;
/**
...
declare type MobileClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & RetryResolvedConfig & HostHeaderResolvedConfig & AwsAuthResolvedConfig & UserAgentResolvedConfig;
/**
 ...
 *         </p>
 */
export declare class MobileClient extends __Client<__HttpHandlerOptions, ServiceInputTypes, ServiceOutputTypes, MobileClientResolvedConfig> {
    /**
