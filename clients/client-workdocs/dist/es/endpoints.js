...
var AWS_TEMPLATE = "workdocs.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "workdocs.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "workdocs.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "workdocs.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "workdocs.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "workdocs" }, regionInfo));
};
