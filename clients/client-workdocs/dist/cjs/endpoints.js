...
const AWS_TEMPLATE = "workdocs.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "workdocs.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "workdocs.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "workdocs.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "workdocs.{region}.amazonaws.com";
// Partition regions
