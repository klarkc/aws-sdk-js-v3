 ...
 *
 */
var CancelQuantumTaskCommand = /** @class */ (function (_super) {
  __extends(CancelQuantumTaskCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function CancelQuantumTaskCommand(input) {
    var _this =
   ...
   * @internal
   */
  CancelQuantumTaskCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "BraketClient";
    var commandName = "CancelQuantumTaskCommand";
  ...
  CancelQuantumTaskCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_restJson1CancelQuantumTaskCommand(output, context);
  };
  return CancelQuantumTaskCommand;
})($Command);
