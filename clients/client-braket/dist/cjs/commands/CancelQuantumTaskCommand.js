...
exports.CancelQuantumTaskCommand = void 0;
...
class CancelQuantumTaskCommand extends smithy_client_1.Command {
  ...
  resolveMiddleware(clientStack, configuration, options) {
    ...
    const handlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: models_0_1.CancelQuantumTaskRequest.filterSensitiveLog,
      outputFilterSensitiveLog: models_0_1.CancelQuantumTaskResponse.filterSensitiveLog,
    };
    const { requestHandler } = configuration;
    return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
  }
  serialize(input, context) {
    return Aws_restJson1_1.serializeAws_restJson1CancelQuantumTaskCommand(input, context);
  }
  deserialize(output, context) {
    return Aws_restJson1_1.deserializeAws_restJson1CancelQuantumTaskCommand(output, context);
  }
}
exports.CancelQuantumTaskCommand = CancelQuantumTaskCommand;
//# sourceMappingURL=CancelQuantumTaskCommand.js.map
