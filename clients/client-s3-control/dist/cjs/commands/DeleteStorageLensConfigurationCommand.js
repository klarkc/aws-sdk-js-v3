...
class DeleteStorageLensConfigurationCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DeleteStorageLensConfigurationRequest.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_restXml_1.serializeAws_restXmlDeleteStorageLensConfigurationCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restXml_1.deserializeAws_restXmlDeleteStorageLensConfigurationCommand(output, context);
    }
}
