...
exports.GetAccessPointForObjectLambdaCommand = void 0;
...
class GetAccessPointForObjectLambdaCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.GetAccessPointForObjectLambdaRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.GetAccessPointForObjectLambdaResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_restXml_1.serializeAws_restXmlGetAccessPointForObjectLambdaCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restXml_1.deserializeAws_restXmlGetAccessPointForObjectLambdaCommand(output, context);
    }
}
exports.GetAccessPointForObjectLambdaCommand = GetAccessPointForObjectLambdaCommand;
//# sourceMappingURL=GetAccessPointForObjectLambdaCommand.js.map