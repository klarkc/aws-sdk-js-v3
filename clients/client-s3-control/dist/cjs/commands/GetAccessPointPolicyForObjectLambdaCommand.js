...
exports.GetAccessPointPolicyForObjectLambdaCommand = void 0;
...
class GetAccessPointPolicyForObjectLambdaCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.GetAccessPointPolicyForObjectLambdaRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.GetAccessPointPolicyForObjectLambdaResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_restXml_1.serializeAws_restXmlGetAccessPointPolicyForObjectLambdaCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restXml_1.deserializeAws_restXmlGetAccessPointPolicyForObjectLambdaCommand(output, context);
    }
}
