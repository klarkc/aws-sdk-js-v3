...
var AWS_TEMPLATE = "waf-regional.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "waf-regional.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "waf-regional.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "waf-regional.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "waf-regional.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "waf-regional" }, regionInfo));
};
