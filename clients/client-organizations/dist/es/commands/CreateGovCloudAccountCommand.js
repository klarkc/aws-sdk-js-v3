...
import { deserializeAws_json1_1CreateGovCloudAccountCommand, serializeAws_json1_1CreateGovCloudAccountCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var CreateGovCloudAccountCommand = /** @class */ (function (_super) {
    __extends(CreateGovCloudAccountCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function CreateGovCloudAccountCommand(input) {
        var _this = 
     ...
     * @internal
     */
    CreateGovCloudAccountCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "OrganizationsClient";
        var commandName = "CreateGovCloudAccountCommand";
    ...
    CreateGovCloudAccountCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1CreateGovCloudAccountCommand(input, context);
    };
    CreateGovCloudAccountCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1CreateGovCloudAccountCommand(output, context);
    };
    return CreateGovCloudAccountCommand;
}($Command));
export { CreateGovCloudAccountCommand };
