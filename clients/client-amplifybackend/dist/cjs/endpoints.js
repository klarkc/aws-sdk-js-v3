...
const AWS_TEMPLATE = "amplifybackend.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "amplifybackend.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "amplifybackend.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "amplifybackend.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "amplifybackend.{region}.amazonaws.com";
// Partition regions
