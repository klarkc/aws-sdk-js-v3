...
var AWS_TEMPLATE = "amplifybackend.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "amplifybackend.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "amplifybackend.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "amplifybackend.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "amplifybackend.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
  ...
  return Promise.resolve(__assign({ signingService: "amplifybackend" }, regionInfo));
};
