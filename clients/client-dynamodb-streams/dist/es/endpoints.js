...
var AWS_TEMPLATE = "streams.dynamodb.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "streams.dynamodb.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "streams.dynamodb.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "streams.dynamodb.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "streams.dynamodb.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "dynamodb" }, regionInfo));
};
