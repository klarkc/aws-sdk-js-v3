 ...
 *
 */
var DeleteStreamingDistributionCommand = /** @class */ (function (_super) {
  __extends(DeleteStreamingDistributionCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function DeleteStreamingDistributionCommand(input) {
    var _this =
   ...
   * @internal
   */
  DeleteStreamingDistributionCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "CloudFrontClient";
    var commandName = "DeleteStreamingDistributionCommand";
  ...
  DeleteStreamingDistributionCommand.prototype.serialize = function (input, context) {
    return serializeAws_restXmlDeleteStreamingDistributionCommand(input, context);
  };
  DeleteStreamingDistributionCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_restXmlDeleteStreamingDistributionCommand(output, context);
  };
  return DeleteStreamingDistributionCommand;
})($Command);
export { DeleteStreamingDistributionCommand };
