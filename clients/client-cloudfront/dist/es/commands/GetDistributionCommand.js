 ...
 *
 */
var GetDistributionCommand = /** @class */ (function (_super) {
  __extends(GetDistributionCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function GetDistributionCommand(input) {
    var _this =
   ...
   * @internal
   */
  GetDistributionCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "CloudFrontClient";
    var commandName = "GetDistributionCommand";
  ...
  GetDistributionCommand.prototype.serialize = function (input, context) {
    return serializeAws_restXmlGetDistributionCommand(input, context);
  };
  GetDistributionCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_restXmlGetDistributionCommand(output, context);
  };
  return GetDistributionCommand;
})($Command);
export { GetDistributionCommand };
