...
const AWS_TEMPLATE = "fms.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "fms.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "fms.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "fms.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "fms.{region}.amazonaws.com";
// Partition regions
