...
var AWS_TEMPLATE = "fms.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "fms.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "fms.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "fms.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "fms.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "fms" }, regionInfo));
};
