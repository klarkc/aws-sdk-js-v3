...
var AWS_TEMPLATE = "access-analyzer.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "access-analyzer.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "access-analyzer.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "access-analyzer.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "access-analyzer.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
  ...
  return Promise.resolve(__assign({ signingService: "access-analyzer" }, regionInfo));
};
