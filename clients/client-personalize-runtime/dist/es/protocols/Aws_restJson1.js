    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                resolvedPath = "/personalize-ranking";
        ...
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1GetPersonalizedRankingCommandError(output, context)];
                }
                contents = {
        ...
        switch (_f.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "com.amazonaws.personalizeruntime#InvalidInputException": return [3 /*break*/, 2];
                    case "ResourceNotFoundException": return [3 /*break*/, 4];
                    case "com.amazonaws.personalizeruntime#ResourceNotFoundException": return [3 /*break*/, 4];
                }
                return [3 /*break*/, 6];
            case 2:
                _c = [{}];
