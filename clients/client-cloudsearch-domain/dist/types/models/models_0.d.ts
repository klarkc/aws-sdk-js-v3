...
export declare namespace SearchException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: SearchException) => any;
}
...
export declare namespace DocumentServiceException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: DocumentServiceException) => any;
}
...
export declare namespace UploadDocumentsResponse {
    /**
     * @internal
     */
