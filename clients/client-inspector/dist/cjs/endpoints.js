...
const AWS_TEMPLATE = "inspector.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "inspector.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "inspector.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "inspector.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "inspector.{region}.amazonaws.com";
// Partition regions
