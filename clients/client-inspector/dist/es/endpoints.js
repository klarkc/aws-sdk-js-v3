...
var AWS_TEMPLATE = "inspector.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "inspector.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "inspector.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "inspector.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "inspector.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "inspector" }, regionInfo));
};
