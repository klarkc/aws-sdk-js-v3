...
var AWS_TEMPLATE = "kinesisvideo.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "kinesisvideo.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "kinesisvideo.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "kinesisvideo.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "kinesisvideo.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "kinesisvideo" }, regionInfo));
};
