...
var AWS_TEMPLATE = "workspaces.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "workspaces.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "workspaces.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "workspaces.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "workspaces.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "workspaces" }, regionInfo));
};
