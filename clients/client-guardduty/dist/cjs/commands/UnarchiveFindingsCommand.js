...
exports.UnarchiveFindingsCommand = void 0;
...
class UnarchiveFindingsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.UnarchiveFindingsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.UnarchiveFindingsResponse.filterSensitiveLog,
        };
