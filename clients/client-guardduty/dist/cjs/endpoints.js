...
const AWS_TEMPLATE = "guardduty.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "guardduty.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "guardduty.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "guardduty.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "guardduty.{region}.amazonaws.com";
// Partition regions
