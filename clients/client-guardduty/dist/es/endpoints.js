...
var AWS_TEMPLATE = "guardduty.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "guardduty.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "guardduty.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "guardduty.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "guardduty.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "guardduty" }, regionInfo));
};
