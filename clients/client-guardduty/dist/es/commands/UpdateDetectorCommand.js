 ...
 *
 */
var UpdateDetectorCommand = /** @class */ (function (_super) {
    __extends(UpdateDetectorCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function UpdateDetectorCommand(input) {
        var _this = 
     ...
     * @internal
     */
    UpdateDetectorCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "GuardDutyClient";
        var commandName = "UpdateDetectorCommand";
    ...
    UpdateDetectorCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1UpdateDetectorCommand(input, context);
    };
    UpdateDetectorCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1UpdateDetectorCommand(output, context);
    };
    return UpdateDetectorCommand;
}($Command));
export { UpdateDetectorCommand };
