...
export declare type ServiceInputTypes = DescribeDimensionKeysCommandInput | GetResourceMetricsCommandInput;
export declare type ServiceOutputTypes = DescribeDimensionKeysCommandOutput | GetResourceMetricsCommandOutput;
