 ...
 *
 */
class UpdateUserSecurityProfilesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.UpdateUserSecurityProfilesRequest.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1UpdateUserSecurityProfilesCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1UpdateUserSecurityProfilesCommand(output, context);
    }
}
exports.UpdateUserSecurityProfilesCommand = UpdateUserSecurityProfilesCommand;
