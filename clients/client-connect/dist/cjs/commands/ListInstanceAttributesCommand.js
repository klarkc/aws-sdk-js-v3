...
exports.ListInstanceAttributesCommand = void 0;
...
class ListInstanceAttributesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.ListInstanceAttributesRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.ListInstanceAttributesResponse.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1ListInstanceAttributesCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1ListInstanceAttributesCommand(output, context);
    }
}
exports.ListInstanceAttributesCommand = ListInstanceAttributesCommand;
