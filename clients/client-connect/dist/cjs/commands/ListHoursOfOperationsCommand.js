...
exports.ListHoursOfOperationsCommand = void 0;
...
class ListHoursOfOperationsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.ListHoursOfOperationsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.ListHoursOfOperationsResponse.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1ListHoursOfOperationsCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1ListHoursOfOperationsCommand(output, context);
    }
}
exports.ListHoursOfOperationsCommand = ListHoursOfOperationsCommand;
