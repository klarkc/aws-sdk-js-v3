...
exports.DeleteUserHierarchyGroupCommand = void 0;
 ...
 *
 */
class DeleteUserHierarchyGroupCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DeleteUserHierarchyGroupRequest.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1DeleteUserHierarchyGroupCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1DeleteUserHierarchyGroupCommand(output, context);
    }
}
exports.DeleteUserHierarchyGroupCommand = DeleteUserHierarchyGroupCommand;
