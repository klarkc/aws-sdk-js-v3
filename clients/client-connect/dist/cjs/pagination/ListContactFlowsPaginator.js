...
exports.paginateListContactFlows = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListContactFlowsCommand_1.ListContactFlowsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListContactFlows(config, input, ...additionalArguments) {
