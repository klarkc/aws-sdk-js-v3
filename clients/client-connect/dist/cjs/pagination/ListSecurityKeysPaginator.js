...
exports.paginateListSecurityKeys = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListSecurityKeysCommand_1.ListSecurityKeysCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListSecurityKeys(config, input, ...additionalArguments) {
