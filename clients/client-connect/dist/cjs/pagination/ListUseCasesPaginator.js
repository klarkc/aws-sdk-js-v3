...
exports.paginateListUseCases = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListUseCasesCommand_1.ListUseCasesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListUseCases(config, input, ...additionalArguments) {
