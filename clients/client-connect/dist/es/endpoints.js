...
var AWS_TEMPLATE = "connect.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "connect.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "connect.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "connect.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "connect.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "ap-southeast-1":
            regionInfo = {
                hostname: "connect.ap-southeast-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-southeast-2":
        ...
        case "eu-west-2":
            regionInfo = {
                hostname: "connect.eu-west-2.amazonaws.com",
                partition: "aws",
            };
            break;
        case "us-east-1":
