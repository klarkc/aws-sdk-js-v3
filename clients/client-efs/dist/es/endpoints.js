...
var AWS_TEMPLATE = "elasticfilesystem.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "elasticfilesystem.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "elasticfilesystem.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "elasticfilesystem.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "elasticfilesystem.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "elasticfilesystem" }, regionInfo));
};
