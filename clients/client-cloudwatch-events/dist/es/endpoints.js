...
var AWS_TEMPLATE = "events.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "events.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "events.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "events.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "events.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "ap-northeast-3":
            regionInfo = {
                hostname: "events.ap-northeast-3.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-south-1":
        ...
        case "eu-south-1":
            regionInfo = {
                hostname: "events.eu-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-west-1":
    ...
    return Promise.resolve(__assign({ signingService: "events" }, regionInfo));
};
