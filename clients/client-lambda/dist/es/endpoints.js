...
var AWS_TEMPLATE = "lambda.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "lambda.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "lambda.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "lambda.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "lambda.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "lambda" }, regionInfo));
};
