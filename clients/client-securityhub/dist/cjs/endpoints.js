...
const AWS_TEMPLATE = "securityhub.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "securityhub.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "securityhub.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "securityhub.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "securityhub.{region}.amazonaws.com";
// Partition regions
