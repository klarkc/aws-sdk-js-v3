 ...
 *
 */
var DeleteReplicationSubnetGroupCommand = /** @class */ (function (_super) {
    __extends(DeleteReplicationSubnetGroupCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DeleteReplicationSubnetGroupCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DeleteReplicationSubnetGroupCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "DatabaseMigrationServiceClient";
        var commandName = "DeleteReplicationSubnetGroupCommand";
    ...
    DeleteReplicationSubnetGroupCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DeleteReplicationSubnetGroupCommand(input, context);
    };
    DeleteReplicationSubnetGroupCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DeleteReplicationSubnetGroupCommand(output, context);
    };
    return DeleteReplicationSubnetGroupCommand;
}($Command));
export { DeleteReplicationSubnetGroupCommand };
//# sourceMappingURL=DeleteReplicationSubnetGroupCommand.js.map