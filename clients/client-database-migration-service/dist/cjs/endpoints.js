...
const AWS_TEMPLATE = "dms.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "dms.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "dms.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "dms.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "dms.{region}.amazonaws.com";
// Partition regions
