...
exports.paginateDescribeApplicableIndividualAssessments = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeApplicableIndividualAssessmentsCommand_1.DescribeApplicableIndividualAssessmentsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeApplicableIndividualAssessments(config, input, ...additionalArguments) {
...
exports.paginateDescribeApplicableIndividualAssessments = paginateDescribeApplicableIndividualAssessments;
