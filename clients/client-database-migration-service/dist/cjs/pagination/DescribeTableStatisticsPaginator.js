...
exports.paginateDescribeTableStatistics = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeTableStatisticsCommand_1.DescribeTableStatisticsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeTableStatistics(config, input, ...additionalArguments) {
