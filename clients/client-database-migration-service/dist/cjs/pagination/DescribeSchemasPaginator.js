...
exports.paginateDescribeSchemas = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeSchemasCommand_1.DescribeSchemasCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeSchemas(config, input, ...additionalArguments) {
