...
exports.paginateDescribeReplicationTaskAssessmentResults = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeReplicationTaskAssessmentResultsCommand_1.DescribeReplicationTaskAssessmentResultsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeReplicationTaskAssessmentResults(config, input, ...additionalArguments) {
...
exports.paginateDescribeReplicationTaskAssessmentResults = paginateDescribeReplicationTaskAssessmentResults;
