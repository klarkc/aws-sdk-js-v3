...
exports.paginateDescribeReplicationInstances = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new DescribeReplicationInstancesCommand_1.DescribeReplicationInstancesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateDescribeReplicationInstances(config, input, ...additionalArguments) {
...
exports.paginateDescribeReplicationInstances = paginateDescribeReplicationInstances;
