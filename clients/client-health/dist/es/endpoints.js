...
var AWS_TEMPLATE = "health.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "health.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "health.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "health.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "health.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "health" }, regionInfo));
};
