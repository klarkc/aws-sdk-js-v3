 ...
 *
 */
var ListFaqsCommand = /** @class */ (function (_super) {
    __extends(ListFaqsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListFaqsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListFaqsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "KendraClient";
        var commandName = "ListFaqsCommand";
    ...
    ListFaqsCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1ListFaqsCommand(input, context);
    };
    ListFaqsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1ListFaqsCommand(output, context);
    };
    return ListFaqsCommand;
}($Command));
export { ListFaqsCommand };
