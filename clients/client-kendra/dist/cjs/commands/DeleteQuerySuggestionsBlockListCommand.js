...
exports.DeleteQuerySuggestionsBlockListCommand = void 0;
...
class DeleteQuerySuggestionsBlockListCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DeleteQuerySuggestionsBlockListRequest.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_json1_1_1.serializeAws_json1_1DeleteQuerySuggestionsBlockListCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_json1_1_1.deserializeAws_json1_1DeleteQuerySuggestionsBlockListCommand(output, context);
    }
}
