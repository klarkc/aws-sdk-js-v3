...
exports.UpdateLaunchConfigurationCommand = void 0;
...
class UpdateLaunchConfigurationCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.UpdateLaunchConfigurationRequest.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1UpdateLaunchConfigurationCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1UpdateLaunchConfigurationCommand(output, context);
    }
}
