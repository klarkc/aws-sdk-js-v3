...
exports.ChangeServerLifeCycleStateCommand = void 0;
 ...
 *
 */
class ChangeServerLifeCycleStateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.ChangeServerLifeCycleStateRequest.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1ChangeServerLifeCycleStateCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1ChangeServerLifeCycleStateCommand(output, context);
    }
}
exports.ChangeServerLifeCycleStateCommand = ChangeServerLifeCycleStateCommand;
