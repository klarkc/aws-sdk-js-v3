...
import { deserializeAws_restJson1DescribeJournalS3ExportCommand, serializeAws_restJson1DescribeJournalS3ExportCommand, } from "../protocols/Aws_restJson1";
 ...
 *
 */
var DescribeJournalS3ExportCommand = /** @class */ (function (_super) {
    __extends(DescribeJournalS3ExportCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DescribeJournalS3ExportCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DescribeJournalS3ExportCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "QLDBClient";
        var commandName = "DescribeJournalS3ExportCommand";
    ...
    DescribeJournalS3ExportCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1DescribeJournalS3ExportCommand(input, context);
    };
    DescribeJournalS3ExportCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1DescribeJournalS3ExportCommand(output, context);
    };
    return DescribeJournalS3ExportCommand;
}($Command));
export { DescribeJournalS3ExportCommand };
