...
const AWS_TEMPLATE = "sns.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "sns.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "sns.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "sns.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "sns.{region}.amazonaws.com";
// Partition regions
