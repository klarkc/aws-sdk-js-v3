...
class DescribeInterconnectLoaCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DescribeInterconnectLoaRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.DescribeInterconnectLoaResponse.filterSensitiveLog,
        };
