...
import { deserializeAws_json1_1TagProjectCommand, serializeAws_json1_1TagProjectCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var TagProjectCommand = /** @class */ (function (_super) {
    __extends(TagProjectCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function TagProjectCommand(input) {
        var _this = 
     ...
     * @internal
     */
    TagProjectCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "CodeStarClient";
        var commandName = "TagProjectCommand";
    ...
    TagProjectCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1TagProjectCommand(input, context);
    };
    TagProjectCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1TagProjectCommand(output, context);
    };
    return TagProjectCommand;
}($Command));
export { TagProjectCommand };
