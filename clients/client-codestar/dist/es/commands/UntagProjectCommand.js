...
import { deserializeAws_json1_1UntagProjectCommand, serializeAws_json1_1UntagProjectCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var UntagProjectCommand = /** @class */ (function (_super) {
    __extends(UntagProjectCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function UntagProjectCommand(input) {
        var _this = 
     ...
     * @internal
     */
    UntagProjectCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "CodeStarClient";
        var commandName = "UntagProjectCommand";
    ...
    UntagProjectCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1UntagProjectCommand(input, context);
    };
    UntagProjectCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1UntagProjectCommand(output, context);
    };
    return UntagProjectCommand;
}($Command));
export { UntagProjectCommand };
//# sourceMappingURL=UntagProjectCommand.js.map