...
const AWS_TEMPLATE = "swf.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "swf.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "swf.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "swf.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "swf.{region}.amazonaws.com";
// Partition regions
