...
class ListClosedWorkflowExecutionsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.ListClosedWorkflowExecutionsInput.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.WorkflowExecutionInfos.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_json1_0_1.serializeAws_json1_0ListClosedWorkflowExecutionsCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_json1_0_1.deserializeAws_json1_0ListClosedWorkflowExecutionsCommand(output, context);
    }
}
