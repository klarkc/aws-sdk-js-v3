...
class DeprecateWorkflowTypeCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DeprecateWorkflowTypeInput.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_json1_0_1.serializeAws_json1_0DeprecateWorkflowTypeCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_json1_0_1.deserializeAws_json1_0DeprecateWorkflowTypeCommand(output, context);
    }
}
