 ...
 *
 */
var ResetAuthorizersCacheCommand = /** @class */ (function (_super) {
  __extends(ResetAuthorizersCacheCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function ResetAuthorizersCacheCommand(input) {
    var _this =
   ...
   * @internal
   */
  ResetAuthorizersCacheCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "ApiGatewayV2Client";
    var commandName = "ResetAuthorizersCacheCommand";
  ...
  ResetAuthorizersCacheCommand.prototype.serialize = function (input, context) {
    return serializeAws_restJson1ResetAuthorizersCacheCommand(input, context);
  };
  ResetAuthorizersCacheCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_restJson1ResetAuthorizersCacheCommand(output, context);
  };
  return ResetAuthorizersCacheCommand;
})($Command);
export { ResetAuthorizersCacheCommand };
//# sourceMappingURL=ResetAuthorizersCacheCommand.js.map
