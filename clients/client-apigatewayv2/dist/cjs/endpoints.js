...
const AWS_TEMPLATE = "apigateway.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "apigateway.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "apigateway.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "apigateway.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "apigateway.{region}.amazonaws.com";
// Partition regions
