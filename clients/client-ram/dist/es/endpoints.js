...
var AWS_TEMPLATE = "ram.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "ram.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "ram.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "ram.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "ram.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "ap-east-1":
            regionInfo = {
                hostname: "ram.ap-east-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-northeast-1":
        ...
        case "ap-northeast-3":
            regionInfo = {
                hostname: "ram.ap-northeast-3.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-south-1":
        ...
        case "cn-northwest-1":
            regionInfo = {
                hostname: "ram.cn-northwest-1.amazonaws.com.cn",
                partition: "aws-cn",
            };
            break;
        case "eu-central-1":
        ...
        case "eu-south-1":
            regionInfo = {
                hostname: "ram.eu-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-west-1":
        ...
        case "me-south-1":
            regionInfo = {
                hostname: "ram.me-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "sa-east-1":
    ...
    return Promise.resolve(__assign({ signingService: "ram" }, regionInfo));
};
