...
exports.DisassociatePhoneNumberFromUserCommand = void 0;
 ...
 *
 */
class DisassociatePhoneNumberFromUserCommand extends smithy_client_1.Command {
  ...
  resolveMiddleware(clientStack, configuration, options) {
    ...
    const handlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: models_0_1.DisassociatePhoneNumberFromUserRequest.filterSensitiveLog,
      outputFilterSensitiveLog: models_0_1.DisassociatePhoneNumberFromUserResponse.filterSensitiveLog,
    };
