...
exports.GetVoiceConnectorTerminationHealthCommand = void 0;
...
class GetVoiceConnectorTerminationHealthCommand extends smithy_client_1.Command {
  ...
  resolveMiddleware(clientStack, configuration, options) {
    ...
    const handlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: models_1_1.GetVoiceConnectorTerminationHealthRequest.filterSensitiveLog,
      outputFilterSensitiveLog: models_1_1.GetVoiceConnectorTerminationHealthResponse.filterSensitiveLog,
    };
