...
exports.DescribeChannelModeratedByAppInstanceUserCommand = void 0;
...
class DescribeChannelModeratedByAppInstanceUserCommand extends smithy_client_1.Command {
  ...
  resolveMiddleware(clientStack, configuration, options) {
    ...
    const handlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: models_0_1.DescribeChannelModeratedByAppInstanceUserRequest.filterSensitiveLog,
      outputFilterSensitiveLog: models_0_1.DescribeChannelModeratedByAppInstanceUserResponse.filterSensitiveLog,
    };
