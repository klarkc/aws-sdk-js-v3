...
exports.PutVoiceConnectorTerminationCredentialsCommand = void 0;
...
class PutVoiceConnectorTerminationCredentialsCommand extends smithy_client_1.Command {
  ...
  resolveMiddleware(clientStack, configuration, options) {
    ...
    const handlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: models_1_1.PutVoiceConnectorTerminationCredentialsRequest.filterSensitiveLog,
  ...
  serialize(input, context) {
    return Aws_restJson1_1.serializeAws_restJson1PutVoiceConnectorTerminationCredentialsCommand(input, context);
  }
  deserialize(output, context) {
    return Aws_restJson1_1.deserializeAws_restJson1PutVoiceConnectorTerminationCredentialsCommand(output, context);
  }
}
