 ...
 *
 */
var DisassociatePhoneNumbersFromVoiceConnectorCommand = /** @class */ (function (_super) {
  __extends(DisassociatePhoneNumbersFromVoiceConnectorCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function DisassociatePhoneNumbersFromVoiceConnectorCommand(input) {
    var _this =
   ...
   * @internal
   */
  DisassociatePhoneNumbersFromVoiceConnectorCommand.prototype.resolveMiddleware = function (
    clientStack,
    configuration,
    options
  ) {
    ...
    var commandName = "DisassociatePhoneNumbersFromVoiceConnectorCommand";
  ...
  DisassociatePhoneNumbersFromVoiceConnectorCommand.prototype.serialize = function (input, context) {
    return serializeAws_restJson1DisassociatePhoneNumbersFromVoiceConnectorCommand(input, context);
  };
  DisassociatePhoneNumbersFromVoiceConnectorCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_restJson1DisassociatePhoneNumbersFromVoiceConnectorCommand(output, context);
  };
  return DisassociatePhoneNumbersFromVoiceConnectorCommand;
})($Command);
export { DisassociatePhoneNumbersFromVoiceConnectorCommand };
//# sourceMappingURL=DisassociatePhoneNumbersFromVoiceConnectorCommand.js.map
