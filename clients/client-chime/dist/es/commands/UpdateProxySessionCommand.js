 ...
 *
 */
var UpdateProxySessionCommand = /** @class */ (function (_super) {
  __extends(UpdateProxySessionCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function UpdateProxySessionCommand(input) {
    var _this =
   ...
   * @internal
   */
  UpdateProxySessionCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "ChimeClient";
    var commandName = "UpdateProxySessionCommand";
  ...
  UpdateProxySessionCommand.prototype.serialize = function (input, context) {
    return serializeAws_restJson1UpdateProxySessionCommand(input, context);
  };
  UpdateProxySessionCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_restJson1UpdateProxySessionCommand(output, context);
  };
  return UpdateProxySessionCommand;
})($Command);
export { UpdateProxySessionCommand };
//# sourceMappingURL=UpdateProxySessionCommand.js.map
