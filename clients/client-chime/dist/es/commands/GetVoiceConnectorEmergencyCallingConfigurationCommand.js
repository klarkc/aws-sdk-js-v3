 ...
 *
 */
var GetVoiceConnectorEmergencyCallingConfigurationCommand = /** @class */ (function (_super) {
  __extends(GetVoiceConnectorEmergencyCallingConfigurationCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function GetVoiceConnectorEmergencyCallingConfigurationCommand(input) {
    var _this =
   ...
   * @internal
   */
  GetVoiceConnectorEmergencyCallingConfigurationCommand.prototype.resolveMiddleware = function (
    clientStack,
    configuration,
    options
  ) {
    ...
    var commandName = "GetVoiceConnectorEmergencyCallingConfigurationCommand";
  ...
  GetVoiceConnectorEmergencyCallingConfigurationCommand.prototype.serialize = function (input, context) {
    return serializeAws_restJson1GetVoiceConnectorEmergencyCallingConfigurationCommand(input, context);
  };
  GetVoiceConnectorEmergencyCallingConfigurationCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_restJson1GetVoiceConnectorEmergencyCallingConfigurationCommand(output, context);
  };
  return GetVoiceConnectorEmergencyCallingConfigurationCommand;
})($Command);
export { GetVoiceConnectorEmergencyCallingConfigurationCommand };
//# sourceMappingURL=GetVoiceConnectorEmergencyCallingConfigurationCommand.js.map
