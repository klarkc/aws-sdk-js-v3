 ...
 *
 */
var GetAttendeeCommand = /** @class */ (function (_super) {
  __extends(GetAttendeeCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function GetAttendeeCommand(input) {
    var _this =
   ...
   * @internal
   */
  GetAttendeeCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "ChimeClient";
    var commandName = "GetAttendeeCommand";
  ...
  GetAttendeeCommand.prototype.serialize = function (input, context) {
    return serializeAws_restJson1GetAttendeeCommand(input, context);
  };
  GetAttendeeCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_restJson1GetAttendeeCommand(output, context);
  };
  return GetAttendeeCommand;
})($Command);
export { GetAttendeeCommand };
