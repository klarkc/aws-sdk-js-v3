 ...
 *
 */
var DeleteChannelModeratorCommand = /** @class */ (function (_super) {
  __extends(DeleteChannelModeratorCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function DeleteChannelModeratorCommand(input) {
    var _this =
   ...
   * @internal
   */
  DeleteChannelModeratorCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "ChimeClient";
    var commandName = "DeleteChannelModeratorCommand";
  ...
  DeleteChannelModeratorCommand.prototype.serialize = function (input, context) {
    return serializeAws_restJson1DeleteChannelModeratorCommand(input, context);
  };
  DeleteChannelModeratorCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_restJson1DeleteChannelModeratorCommand(output, context);
  };
  return DeleteChannelModeratorCommand;
})($Command);
export { DeleteChannelModeratorCommand };
//# sourceMappingURL=DeleteChannelModeratorCommand.js.map
