 ...
 *
 */
var PutVoiceConnectorProxyCommand = /** @class */ (function (_super) {
  __extends(PutVoiceConnectorProxyCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function PutVoiceConnectorProxyCommand(input) {
    var _this =
   ...
   * @internal
   */
  PutVoiceConnectorProxyCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "ChimeClient";
    var commandName = "PutVoiceConnectorProxyCommand";
  ...
  PutVoiceConnectorProxyCommand.prototype.serialize = function (input, context) {
    return serializeAws_restJson1PutVoiceConnectorProxyCommand(input, context);
  };
  PutVoiceConnectorProxyCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_restJson1PutVoiceConnectorProxyCommand(output, context);
  };
  return PutVoiceConnectorProxyCommand;
})($Command);
export { PutVoiceConnectorProxyCommand };
