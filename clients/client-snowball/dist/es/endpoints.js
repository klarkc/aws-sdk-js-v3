...
var AWS_TEMPLATE = "snowball.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "snowball.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "snowball.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "snowball.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "snowball.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "snowball" }, regionInfo));
};
