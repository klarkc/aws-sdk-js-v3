...
import { deserializeAws_json1_1DeleteTagsForDomainCommand, serializeAws_json1_1DeleteTagsForDomainCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var DeleteTagsForDomainCommand = /** @class */ (function (_super) {
    __extends(DeleteTagsForDomainCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DeleteTagsForDomainCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DeleteTagsForDomainCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "Route53DomainsClient";
        var commandName = "DeleteTagsForDomainCommand";
    ...
    DeleteTagsForDomainCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DeleteTagsForDomainCommand(input, context);
    };
    DeleteTagsForDomainCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DeleteTagsForDomainCommand(output, context);
    };
    return DeleteTagsForDomainCommand;
}($Command));
export { DeleteTagsForDomainCommand };
