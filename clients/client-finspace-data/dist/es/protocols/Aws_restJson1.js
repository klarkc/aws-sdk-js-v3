    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                resolvedPath = "/datasets/{datasetId}/changesets";
...
export var serializeAws_restJson1GetProgrammaticAccessCredentialsCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                headers = {};
                resolvedPath = "/credentials/programmatic";
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                resolvedPath = "/workingLocationV1";
        ...
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1CreateChangesetCommandError(output, context)];
                }
                contents = {
        ...
        switch (_j.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "com.amazonaws.finspacedata#AccessDeniedException": return [3 /*break*/, 2];
                    case "InternalServerException": return [3 /*break*/, 4];
                    case "com.amazonaws.finspacedata#InternalServerException": return [3 /*break*/, 4];
                    case "ResourceNotFoundException": return [3 /*break*/, 6];
                    case "com.amazonaws.finspacedata#ResourceNotFoundException": return [3 /*break*/, 6];
                    case "ThrottlingException": return [3 /*break*/, 8];
                    case "com.amazonaws.finspacedata#ThrottlingException": return [3 /*break*/, 8];
                    case "ValidationException": return [3 /*break*/, 10];
                    case "com.amazonaws.finspacedata#ValidationException": return [3 /*break*/, 10];
                }
                return [3 /*break*/, 12];
            case 2:
                _c = [{}];
...
export var deserializeAws_restJson1GetProgrammaticAccessCredentialsCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1GetProgrammaticAccessCredentialsCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
        ...
        switch (_g.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "com.amazonaws.finspacedata#ThrottlingException": return [3 /*break*/, 6];
                }
                return [3 /*break*/, 8];
            case 2:
                _c = [{}];
...
export var deserializeAws_restJson1GetWorkingLocationCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1GetWorkingLocationCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    s3Bucket: undefined,
        ...
        switch (_h.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "com.amazonaws.finspacedata#ValidationException": return [3 /*break*/, 8];
                }
                return [3 /*break*/, 10];
            case 2:
                _c = [{}];
