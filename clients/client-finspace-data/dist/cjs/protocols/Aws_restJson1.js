...
const deserializeAws_restJson1ChangesetInfo = (output, context) => {
    return {
        ...
        updatedByChangesetId: output.updatedByChangesetId !== undefined && output.updatedByChangesetId !== null
            ? output.updatedByChangesetId
            : undefined,
        updatesChangesetId: output.updatesChangesetId !== undefined && output.updatesChangesetId !== null
...
const deserializeAws_restJson1ErrorInfo = (output, context) => {
    return {
        errorCategory: output.errorCategory !== undefined && output.errorCategory !== null ? output.errorCategory : undefined,
