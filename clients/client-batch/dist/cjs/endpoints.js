...
const AWS_TEMPLATE = "batch.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "batch.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "batch.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "batch.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "batch.{region}.amazonaws.com";
// Partition regions
