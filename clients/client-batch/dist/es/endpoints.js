...
var AWS_TEMPLATE = "batch.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "batch.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "batch.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "batch.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "batch.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
  ...
  switch (region) {
    ...
    case "af-south-1":
      regionInfo = {
        hostname: "batch.af-south-1.amazonaws.com",
        partition: "aws",
      };
      break;
    case "ap-east-1":
    ...
    case "ap-northeast-3":
      regionInfo = {
        hostname: "batch.ap-northeast-3.amazonaws.com",
        partition: "aws",
      };
      break;
    case "ap-south-1":
    ...
    case "eu-south-1":
      regionInfo = {
        hostname: "batch.eu-south-1.amazonaws.com",
        partition: "aws",
      };
      break;
    case "eu-west-1":
  ...
  return Promise.resolve(__assign({ signingService: "batch" }, regionInfo));
};
