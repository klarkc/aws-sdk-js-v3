...
declare type BatchClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> &
  ClientDefaults &
  RegionInputConfig &
  EndpointsInputConfig &
  RetryInputConfig &
...
declare type BatchClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> &
