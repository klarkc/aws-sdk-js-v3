 ...
 *
 */
var DeleteUserPoolDomainCommand = /** @class */ (function (_super) {
    __extends(DeleteUserPoolDomainCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DeleteUserPoolDomainCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DeleteUserPoolDomainCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        this.middlewareStack.use(getAwsAuthPlugin(configuration));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "CognitoIdentityProviderClient";
        var commandName = "DeleteUserPoolDomainCommand";
    ...
    DeleteUserPoolDomainCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DeleteUserPoolDomainCommand(input, context);
    };
    DeleteUserPoolDomainCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DeleteUserPoolDomainCommand(output, context);
    };
    return DeleteUserPoolDomainCommand;
}($Command));
export { DeleteUserPoolDomainCommand };
