 ...
 *
 */
var DeleteUserPoolCommand = /** @class */ (function (_super) {
    __extends(DeleteUserPoolCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DeleteUserPoolCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DeleteUserPoolCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        this.middlewareStack.use(getAwsAuthPlugin(configuration));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "CognitoIdentityProviderClient";
        var commandName = "DeleteUserPoolCommand";
    ...
    DeleteUserPoolCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DeleteUserPoolCommand(input, context);
    };
    DeleteUserPoolCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DeleteUserPoolCommand(output, context);
    };
    return DeleteUserPoolCommand;
}($Command));
export { DeleteUserPoolCommand };
//# sourceMappingURL=DeleteUserPoolCommand.js.map