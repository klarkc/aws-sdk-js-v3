...
var AWS_TEMPLATE = "cognito-idp.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "cognito-idp.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "cognito-idp.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "cognito-idp.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "cognito-idp.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "cognito-idp" }, regionInfo));
};
