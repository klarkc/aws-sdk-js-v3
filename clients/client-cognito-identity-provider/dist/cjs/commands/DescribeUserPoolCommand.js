...
exports.DescribeUserPoolCommand = void 0;
...
class DescribeUserPoolCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DescribeUserPoolRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.DescribeUserPoolResponse.filterSensitiveLog,
        };
