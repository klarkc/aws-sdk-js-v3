...
exports.DescribeUserPoolClientCommand = void 0;
...
class DescribeUserPoolClientCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DescribeUserPoolClientRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.DescribeUserPoolClientResponse.filterSensitiveLog,
        };
