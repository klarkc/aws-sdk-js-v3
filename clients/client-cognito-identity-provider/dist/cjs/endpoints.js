...
const AWS_TEMPLATE = "cognito-idp.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "cognito-idp.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "cognito-idp.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "cognito-idp.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "cognito-idp.{region}.amazonaws.com";
// Partition regions
