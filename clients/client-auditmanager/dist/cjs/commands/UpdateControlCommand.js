...
exports.UpdateControlCommand = void 0;
...
class UpdateControlCommand extends smithy_client_1.Command {
  ...
  resolveMiddleware(clientStack, configuration, options) {
    ...
    const handlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: models_0_1.UpdateControlRequest.filterSensitiveLog,
      outputFilterSensitiveLog: models_0_1.UpdateControlResponse.filterSensitiveLog,
    };
    const { requestHandler } = configuration;
    return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
  }
  serialize(input, context) {
    return Aws_restJson1_1.serializeAws_restJson1UpdateControlCommand(input, context);
  }
  deserialize(output, context) {
    return Aws_restJson1_1.deserializeAws_restJson1UpdateControlCommand(output, context);
  }
}
exports.UpdateControlCommand = UpdateControlCommand;
//# sourceMappingURL=UpdateControlCommand.js.map
