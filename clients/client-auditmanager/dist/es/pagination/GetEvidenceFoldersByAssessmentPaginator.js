    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            client.send.apply(client, __spreadArray([new GetEvidenceFoldersByAssessmentCommand(input)], __read(args))),
          ];
        case 1:
          // @ts-ignore
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            client.getEvidenceFoldersByAssessment.apply(client, __spreadArray([input], __read(args))),
          ];
        case 1:
          // @ts-ignore
          return [2 /*return*/, _a.sent()];
...
export function paginateGetEvidenceFoldersByAssessment(config, input) {
