...
const AWS_TEMPLATE = "storagegateway.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "storagegateway.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "storagegateway.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "storagegateway.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "storagegateway.{region}.amazonaws.com";
// Partition regions
