...
var AWS_TEMPLATE = "storagegateway.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "storagegateway.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "storagegateway.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "storagegateway.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "storagegateway.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "eu-south-1":
            regionInfo = {
                hostname: "storagegateway.eu-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-west-1":
    ...
    return Promise.resolve(__assign({ signingService: "storagegateway" }, regionInfo));
};
