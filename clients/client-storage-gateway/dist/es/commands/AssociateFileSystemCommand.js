 ...
 *
 */
var AssociateFileSystemCommand = /** @class */ (function (_super) {
    __extends(AssociateFileSystemCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function AssociateFileSystemCommand(input) {
        var _this = 
     ...
     * @internal
     */
    AssociateFileSystemCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "StorageGatewayClient";
        var commandName = "AssociateFileSystemCommand";
    ...
    AssociateFileSystemCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1AssociateFileSystemCommand(input, context);
    };
    AssociateFileSystemCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1AssociateFileSystemCommand(output, context);
    };
    return AssociateFileSystemCommand;
}($Command));
export { AssociateFileSystemCommand };
