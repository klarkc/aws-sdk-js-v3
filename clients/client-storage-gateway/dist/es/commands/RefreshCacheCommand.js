 ...
 *
 */
var RefreshCacheCommand = /** @class */ (function (_super) {
    __extends(RefreshCacheCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function RefreshCacheCommand(input) {
        var _this = 
     ...
     * @internal
     */
    RefreshCacheCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "StorageGatewayClient";
        var commandName = "RefreshCacheCommand";
    ...
    RefreshCacheCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1RefreshCacheCommand(input, context);
    };
    RefreshCacheCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1RefreshCacheCommand(output, context);
    };
    return RefreshCacheCommand;
}($Command));
export { RefreshCacheCommand };
