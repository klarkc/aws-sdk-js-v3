...
var AWS_TEMPLATE = "ec2.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "ec2.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "ec2.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "ec2.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "ec2.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "ap-northeast-3":
            regionInfo = {
                hostname: "ec2.ap-northeast-3.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-south-1":
    ...
    return Promise.resolve(__assign({ signingService: "ec2" }, regionInfo));
};
