...
exports.GetExperimentCommand = void 0;
...
class GetExperimentCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.GetExperimentRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.GetExperimentResponse.filterSensitiveLog,
        };
