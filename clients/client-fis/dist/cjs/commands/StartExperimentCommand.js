...
exports.StartExperimentCommand = void 0;
...
class StartExperimentCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.StartExperimentRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.StartExperimentResponse.filterSensitiveLog,
        };
