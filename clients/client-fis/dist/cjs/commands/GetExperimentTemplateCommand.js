...
exports.GetExperimentTemplateCommand = void 0;
...
class GetExperimentTemplateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.GetExperimentTemplateRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.GetExperimentTemplateResponse.filterSensitiveLog,
        };
