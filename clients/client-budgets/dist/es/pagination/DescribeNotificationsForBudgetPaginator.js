    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            client.send.apply(client, __spreadArray([new DescribeNotificationsForBudgetCommand(input)], __read(args))),
          ];
        case 1:
          // @ts-ignore
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            client.describeNotificationsForBudget.apply(client, __spreadArray([input], __read(args))),
          ];
        case 1:
          // @ts-ignore
          return [2 /*return*/, _a.sent()];
...
export function paginateDescribeNotificationsForBudget(config, input) {
  var additionalArguments = [];
  for (var _i = 2; _i < arguments.length; _i++) {
    additionalArguments[_i - 2] = arguments[_i];
  }
  return __asyncGenerator(this, arguments, function paginateDescribeNotificationsForBudget_1() {
