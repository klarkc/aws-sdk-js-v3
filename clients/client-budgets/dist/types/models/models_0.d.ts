...
export declare namespace CreationLimitExceededException {
  /**
   * @internal
   */
  const filterSensitiveLog: (obj: CreationLimitExceededException) => any;
}
/**
...
export declare namespace DuplicateRecordException {
  /**
   * @internal
   */
  const filterSensitiveLog: (obj: DuplicateRecordException) => any;
}
/**
...
export declare namespace ResourceLockedException {
  /**
   * @internal
   */
  const filterSensitiveLog: (obj: ResourceLockedException) => any;
}
/**
