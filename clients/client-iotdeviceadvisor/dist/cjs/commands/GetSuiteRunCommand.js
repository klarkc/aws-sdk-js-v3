...
exports.GetSuiteRunCommand = void 0;
 ...
 *
 */
class GetSuiteRunCommand extends smithy_client_1.Command {
    ...
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1GetSuiteRunCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1GetSuiteRunCommand(output, context);
    }
}
