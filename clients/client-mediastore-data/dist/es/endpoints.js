...
var AWS_TEMPLATE = "data.mediastore.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "data.mediastore.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "data.mediastore.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "data.mediastore.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "data.mediastore.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "eu-west-2":
            regionInfo = {
                hostname: "data.mediastore.eu-west-2.amazonaws.com",
                partition: "aws",
            };
            break;
        case "us-east-1":
    ...
    return Promise.resolve(__assign({ signingService: "mediastore" }, regionInfo));
};
