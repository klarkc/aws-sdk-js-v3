        ...
        switch (_g.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "com.amazonaws.mediastoredata#ContainerNotFoundException": return [3 /*break*/, 2];
                    case "InternalServerError": return [3 /*break*/, 4];
                    case "com.amazonaws.mediastoredata#InternalServerError": return [3 /*break*/, 4];
                    case "ObjectNotFoundException": return [3 /*break*/, 6];
                    case "com.amazonaws.mediastoredata#ObjectNotFoundException": return [3 /*break*/, 6];
                }
                return [3 /*break*/, 8];
            case 2:
                _c = [{}];
                return [4 /*yield*/, deserializeAws_restJson1ContainerNotFoundExceptionResponse(parsedOutput, context)];
            case 3:
            ...
            case 6:
                _e = [{}];
                return [4 /*yield*/, deserializeAws_restJson1ObjectNotFoundExceptionResponse(parsedOutput, context)];
            case 7:
...
export var deserializeAws_restJson1DescribeObjectCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1DescribeObjectCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
...
export var deserializeAws_restJson1GetObjectCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        if (output.statusCode !== 200 && output.statusCode >= 300) {
            return [2 /*return*/, deserializeAws_restJson1GetObjectCommandError(output, context)];
        }
        contents = {
            $metadata: deserializeMetadata(output),
            Body: undefined,
        ...
        switch (_h.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "ObjectNotFoundException": return [3 /*break*/, 6];
                    case "com.amazonaws.mediastoredata#ObjectNotFoundException": return [3 /*break*/, 6];
                    case "RequestedRangeNotSatisfiableException": return [3 /*break*/, 8];
                    case "com.amazonaws.mediastoredata#RequestedRangeNotSatisfiableException": return [3 /*break*/, 8];
                }
                return [3 /*break*/, 10];
            case 2:
                _c = [{}];
            ...
            case 8:
                _f = [{}];
                return [4 /*yield*/, deserializeAws_restJson1RequestedRangeNotSatisfiableExceptionResponse(parsedOutput, context)];
            case 9:
...
export var deserializeAws_restJson1ListItemsCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1ListItemsCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    Items: undefined,
...
export var deserializeAws_restJson1PutObjectCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1PutObjectCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
