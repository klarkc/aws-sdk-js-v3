...
exports.AddFlowVpcInterfacesCommand = void 0;
...
class AddFlowVpcInterfacesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.AddFlowVpcInterfacesRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.AddFlowVpcInterfacesResponse.filterSensitiveLog,
        };
