...
export declare namespace InvalidCodecPrivateDataException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: InvalidCodecPrivateDataException) => any;
}
/**
...
export declare namespace InvalidMediaFrameException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: InvalidMediaFrameException) => any;
}
/**
...
export declare namespace MissingCodecPrivateDataException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: MissingCodecPrivateDataException) => any;
}
/**
...
export declare namespace NoDataRetentionException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: NoDataRetentionException) => any;
}
/**
...
export declare namespace UnsupportedStreamMediaTypeException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: UnsupportedStreamMediaTypeException) => any;
}
