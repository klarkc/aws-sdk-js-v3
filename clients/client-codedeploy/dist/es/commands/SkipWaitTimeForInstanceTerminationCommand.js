 ...
 *
 */
var SkipWaitTimeForInstanceTerminationCommand = /** @class */ (function (_super) {
    __extends(SkipWaitTimeForInstanceTerminationCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function SkipWaitTimeForInstanceTerminationCommand(input) {
        var _this = 
     ...
     * @internal
     */
    SkipWaitTimeForInstanceTerminationCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "CodeDeployClient";
        var commandName = "SkipWaitTimeForInstanceTerminationCommand";
    ...
    SkipWaitTimeForInstanceTerminationCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1SkipWaitTimeForInstanceTerminationCommand(input, context);
    };
    SkipWaitTimeForInstanceTerminationCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1SkipWaitTimeForInstanceTerminationCommand(output, context);
    };
    return SkipWaitTimeForInstanceTerminationCommand;
}($Command));
export { SkipWaitTimeForInstanceTerminationCommand };
