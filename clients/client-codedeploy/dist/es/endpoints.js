...
var AWS_TEMPLATE = "codedeploy.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "codedeploy.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "codedeploy.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "codedeploy.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "codedeploy.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "codedeploy" }, regionInfo));
};
