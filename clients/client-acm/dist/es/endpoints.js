...
var AWS_TEMPLATE = "acm.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "acm.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "acm.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "acm.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "acm.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
  ...
  return Promise.resolve(__assign({ signingService: "acm" }, regionInfo));
};
