...
var AWS_TEMPLATE = "serverlessrepo.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "serverlessrepo.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "serverlessrepo.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "serverlessrepo.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "serverlessrepo.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "cn-northwest-1":
            regionInfo = {
                hostname: "serverlessrepo.cn-northwest-1.amazonaws.com.cn",
                partition: "aws-cn",
            };
            break;
        case "eu-central-1":
    ...
    return Promise.resolve(__assign({ signingService: "serverlessrepo" }, regionInfo));
};
