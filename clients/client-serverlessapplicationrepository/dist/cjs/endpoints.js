...
const AWS_TEMPLATE = "serverlessrepo.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "serverlessrepo.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "serverlessrepo.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "serverlessrepo.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "serverlessrepo.{region}.amazonaws.com";
// Partition regions
