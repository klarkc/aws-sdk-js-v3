...
import { deserializeAws_json1_1AllocateStaticIpCommand, serializeAws_json1_1AllocateStaticIpCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var AllocateStaticIpCommand = /** @class */ (function (_super) {
    __extends(AllocateStaticIpCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function AllocateStaticIpCommand(input) {
        var _this = 
     ...
     * @internal
     */
    AllocateStaticIpCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "LightsailClient";
        var commandName = "AllocateStaticIpCommand";
    ...
    AllocateStaticIpCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1AllocateStaticIpCommand(input, context);
    };
    AllocateStaticIpCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1AllocateStaticIpCommand(output, context);
    };
    return AllocateStaticIpCommand;
}($Command));
export { AllocateStaticIpCommand };
//# sourceMappingURL=AllocateStaticIpCommand.js.map