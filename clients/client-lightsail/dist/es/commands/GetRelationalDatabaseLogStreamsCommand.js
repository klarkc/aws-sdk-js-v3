...
import { deserializeAws_json1_1GetRelationalDatabaseLogStreamsCommand, serializeAws_json1_1GetRelationalDatabaseLogStreamsCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var GetRelationalDatabaseLogStreamsCommand = /** @class */ (function (_super) {
    __extends(GetRelationalDatabaseLogStreamsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function GetRelationalDatabaseLogStreamsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    GetRelationalDatabaseLogStreamsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "LightsailClient";
        var commandName = "GetRelationalDatabaseLogStreamsCommand";
    ...
    GetRelationalDatabaseLogStreamsCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1GetRelationalDatabaseLogStreamsCommand(input, context);
    };
    GetRelationalDatabaseLogStreamsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1GetRelationalDatabaseLogStreamsCommand(output, context);
    };
    return GetRelationalDatabaseLogStreamsCommand;
}($Command));
export { GetRelationalDatabaseLogStreamsCommand };
