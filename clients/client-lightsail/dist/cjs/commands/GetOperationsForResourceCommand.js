...
exports.GetOperationsForResourceCommand = void 0;
...
class GetOperationsForResourceCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.GetOperationsForResourceRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_1_1.GetOperationsForResourceResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_json1_1_1.serializeAws_json1_1GetOperationsForResourceCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_json1_1_1.deserializeAws_json1_1GetOperationsForResourceCommand(output, context);
    }
}
exports.GetOperationsForResourceCommand = GetOperationsForResourceCommand;
