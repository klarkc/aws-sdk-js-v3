...
exports.UpdateDomainEntryCommand = void 0;
 ...
 *
 */
class UpdateDomainEntryCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.UpdateDomainEntryRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_1_1.UpdateDomainEntryResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_json1_1_1.serializeAws_json1_1UpdateDomainEntryCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_json1_1_1.deserializeAws_json1_1UpdateDomainEntryCommand(output, context);
    }
}
exports.UpdateDomainEntryCommand = UpdateDomainEntryCommand;
