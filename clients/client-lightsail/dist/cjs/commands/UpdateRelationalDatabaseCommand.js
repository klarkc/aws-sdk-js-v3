...
exports.UpdateRelationalDatabaseCommand = void 0;
 ...
 *
 */
class UpdateRelationalDatabaseCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.UpdateRelationalDatabaseRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_1_1.UpdateRelationalDatabaseResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_json1_1_1.serializeAws_json1_1UpdateRelationalDatabaseCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_json1_1_1.deserializeAws_json1_1UpdateRelationalDatabaseCommand(output, context);
    }
}
exports.UpdateRelationalDatabaseCommand = UpdateRelationalDatabaseCommand;
