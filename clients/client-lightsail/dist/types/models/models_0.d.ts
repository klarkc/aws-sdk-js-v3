...
export declare namespace AccountSetupInProgressException {
     ...
     * @internal
     */
    const filterSensitiveLog: (obj: AccountSetupInProgressException) => any;
}
/**
...
export declare namespace OperationFailureException {
     ...
     * @internal
     */
    const filterSensitiveLog: (obj: OperationFailureException) => any;
}
/**
...
export declare namespace UnauthenticatedException {
     ...
     * @internal
     */
    const filterSensitiveLog: (obj: UnauthenticatedException) => any;
}
