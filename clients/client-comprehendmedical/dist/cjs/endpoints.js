...
const AWS_TEMPLATE = "comprehendmedical.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "comprehendmedical.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "comprehendmedical.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "comprehendmedical.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "comprehendmedical.{region}.amazonaws.com";
// Partition regions
