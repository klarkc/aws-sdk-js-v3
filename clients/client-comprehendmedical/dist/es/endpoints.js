...
var AWS_TEMPLATE = "comprehendmedical.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "comprehendmedical.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "comprehendmedical.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "comprehendmedical.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "comprehendmedical.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "comprehendmedical" }, regionInfo));
};
