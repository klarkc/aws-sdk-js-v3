...
export var serializeAws_restJson1DeleteHumanLoopCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                headers = {};
                resolvedPath = "/human-loops/{HumanLoopName}";
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                })), (input.FlowDefinitionArn !== undefined && { FlowDefinitionArn: input.FlowDefinitionArn })), (input.SortOrder !== undefined && { SortOrder: input.SortOrder })), (input.NextToken !== undefined && { NextToken: input.NextToken })), (input.MaxResults !== undefined && { MaxResults: input.MaxResults.toString() }));
                return [4 /*yield*/, context.endpoint()];
            case 1:
                _a = _c.sent(), hostname = _a.hostname, _b = _a.protocol, protocol = _b === void 0 ? "https" : _b, port = _a.port;
                return [2 /*return*/, new __HttpRequest({
        ...
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1DeleteHumanLoopCommandError(output, context)];
                }
                contents = {
        ...
        switch (_h.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "com.amazonaws.sagemakera2iruntime#InternalServerException": return [3 /*break*/, 2];
                    case "ResourceNotFoundException": return [3 /*break*/, 4];
                    case "com.amazonaws.sagemakera2iruntime#ResourceNotFoundException": return [3 /*break*/, 4];
                    case "ThrottlingException": return [3 /*break*/, 6];
                    case "com.amazonaws.sagemakera2iruntime#ThrottlingException": return [3 /*break*/, 6];
                    case "ValidationException": return [3 /*break*/, 8];
                    case "com.amazonaws.sagemakera2iruntime#ValidationException": return [3 /*break*/, 8];
                }
                return [3 /*break*/, 10];
            case 2:
                _c = [{}];
...
export var deserializeAws_restJson1DescribeHumanLoopCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1DescribeHumanLoopCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
...
export var deserializeAws_restJson1ListHumanLoopsCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1ListHumanLoopsCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
...
export var deserializeAws_restJson1StartHumanLoopCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1StartHumanLoopCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    HumanLoopArn: undefined,
        ...
        switch (_j.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "com.amazonaws.sagemakera2iruntime#ConflictException": return [3 /*break*/, 2];
                    case "InternalServerException": return [3 /*break*/, 4];
                    case "com.amazonaws.sagemakera2iruntime#InternalServerException": return [3 /*break*/, 4];
                    case "ServiceQuotaExceededException": return [3 /*break*/, 6];
                    case "com.amazonaws.sagemakera2iruntime#ServiceQuotaExceededException": return [3 /*break*/, 6];
                    case "ThrottlingException": return [3 /*break*/, 8];
                    case "com.amazonaws.sagemakera2iruntime#ThrottlingException": return [3 /*break*/, 8];
                    case "ValidationException": return [3 /*break*/, 10];
                    case "com.amazonaws.sagemakera2iruntime#ValidationException": return [3 /*break*/, 10];
                }
                return [3 /*break*/, 12];
            case 2:
                _c = [{}];
...
export var deserializeAws_restJson1StopHumanLoopCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1StopHumanLoopCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                };
