...
var AWS_TEMPLATE = "kms.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "kms.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "kms.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "kms.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "kms.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "kms" }, regionInfo));
};
