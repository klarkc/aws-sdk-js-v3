...
import { deserializeAws_json1_1DeleteCustomKeyStoreCommand, serializeAws_json1_1DeleteCustomKeyStoreCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var DeleteCustomKeyStoreCommand = /** @class */ (function (_super) {
    __extends(DeleteCustomKeyStoreCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DeleteCustomKeyStoreCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DeleteCustomKeyStoreCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "KMSClient";
        var commandName = "DeleteCustomKeyStoreCommand";
    ...
    DeleteCustomKeyStoreCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DeleteCustomKeyStoreCommand(input, context);
    };
    DeleteCustomKeyStoreCommand.prototype.deserialize = function (output, context) {
