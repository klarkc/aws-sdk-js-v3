...
exports.paginateGetConnectors = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new GetConnectorsCommand_1.GetConnectorsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateGetConnectors(config, input, ...additionalArguments) {
...
exports.paginateGetConnectors = paginateGetConnectors;
