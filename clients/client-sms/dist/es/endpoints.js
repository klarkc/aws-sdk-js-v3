...
var AWS_TEMPLATE = "sms.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "sms.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "sms.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "sms.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "sms.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "sms" }, regionInfo));
};
