...
import { deserializeAws_json1_1GetAppValidationOutputCommand, serializeAws_json1_1GetAppValidationOutputCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var GetAppValidationOutputCommand = /** @class */ (function (_super) {
    __extends(GetAppValidationOutputCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function GetAppValidationOutputCommand(input) {
        var _this = 
     ...
     * @internal
     */
    GetAppValidationOutputCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SMSClient";
        var commandName = "GetAppValidationOutputCommand";
    ...
    GetAppValidationOutputCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1GetAppValidationOutputCommand(input, context);
    };
    GetAppValidationOutputCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1GetAppValidationOutputCommand(output, context);
    };
    return GetAppValidationOutputCommand;
}($Command));
export { GetAppValidationOutputCommand };
