...
import { deserializeAws_json1_1StartOnDemandAppReplicationCommand, serializeAws_json1_1StartOnDemandAppReplicationCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var StartOnDemandAppReplicationCommand = /** @class */ (function (_super) {
    __extends(StartOnDemandAppReplicationCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function StartOnDemandAppReplicationCommand(input) {
        var _this = 
     ...
     * @internal
     */
    StartOnDemandAppReplicationCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SMSClient";
        var commandName = "StartOnDemandAppReplicationCommand";
    ...
    StartOnDemandAppReplicationCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1StartOnDemandAppReplicationCommand(input, context);
    };
    StartOnDemandAppReplicationCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1StartOnDemandAppReplicationCommand(output, context);
    };
    return StartOnDemandAppReplicationCommand;
}($Command));
export { StartOnDemandAppReplicationCommand };
//# sourceMappingURL=StartOnDemandAppReplicationCommand.js.map