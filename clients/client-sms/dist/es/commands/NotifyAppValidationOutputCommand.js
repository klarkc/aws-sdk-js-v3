...
import { deserializeAws_json1_1NotifyAppValidationOutputCommand, serializeAws_json1_1NotifyAppValidationOutputCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var NotifyAppValidationOutputCommand = /** @class */ (function (_super) {
    __extends(NotifyAppValidationOutputCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function NotifyAppValidationOutputCommand(input) {
        var _this = 
     ...
     * @internal
     */
    NotifyAppValidationOutputCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SMSClient";
        var commandName = "NotifyAppValidationOutputCommand";
    ...
    NotifyAppValidationOutputCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1NotifyAppValidationOutputCommand(input, context);
    };
    NotifyAppValidationOutputCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1NotifyAppValidationOutputCommand(output, context);
    };
    return NotifyAppValidationOutputCommand;
}($Command));
export { NotifyAppValidationOutputCommand };
