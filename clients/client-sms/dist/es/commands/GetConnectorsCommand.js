...
import { deserializeAws_json1_1GetConnectorsCommand, serializeAws_json1_1GetConnectorsCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var GetConnectorsCommand = /** @class */ (function (_super) {
    __extends(GetConnectorsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function GetConnectorsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    GetConnectorsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SMSClient";
        var commandName = "GetConnectorsCommand";
    ...
    GetConnectorsCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1GetConnectorsCommand(input, context);
    };
    GetConnectorsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1GetConnectorsCommand(output, context);
    };
    return GetConnectorsCommand;
}($Command));
export { GetConnectorsCommand };
