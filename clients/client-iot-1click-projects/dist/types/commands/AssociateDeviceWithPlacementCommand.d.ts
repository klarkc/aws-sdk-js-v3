...
export interface AssociateDeviceWithPlacementCommandOutput extends AssociateDeviceWithPlacementResponse, __MetadataBearer {
}
/**
 ...
 *
 */
export declare class AssociateDeviceWithPlacementCommand extends $Command<AssociateDeviceWithPlacementCommandInput, AssociateDeviceWithPlacementCommandOutput, IoT1ClickProjectsClientResolvedConfig> {
    readonly input: AssociateDeviceWithPlacementCommandInput;
    constructor(input: AssociateDeviceWithPlacementCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: IoT1ClickProjectsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<AssociateDeviceWithPlacementCommandInput, AssociateDeviceWithPlacementCommandOutput>;
    private serialize;
    private deserialize;
}
