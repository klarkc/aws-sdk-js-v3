...
export declare type ServiceInputTypes = AssociateDeviceWithPlacementCommandInput | CreatePlacementCommandInput | CreateProjectCommandInput | DeletePlacementCommandInput | DeleteProjectCommandInput | DescribePlacementCommandInput | DescribeProjectCommandInput | DisassociateDeviceFromPlacementCommandInput | GetDevicesInPlacementCommandInput | ListPlacementsCommandInput | ListProjectsCommandInput | ListTagsForResourceCommandInput | TagResourceCommandInput | UntagResourceCommandInput | UpdatePlacementCommandInput | UpdateProjectCommandInput;
export declare type ServiceOutputTypes = AssociateDeviceWithPlacementCommandOutput | CreatePlacementCommandOutput | CreateProjectCommandOutput | DeletePlacementCommandOutput | DeleteProjectCommandOutput | DescribePlacementCommandOutput | DescribeProjectCommandOutput | DisassociateDeviceFromPlacementCommandOutput | GetDevicesInPlacementCommandOutput | ListPlacementsCommandOutput | ListProjectsCommandOutput | ListTagsForResourceCommandOutput | TagResourceCommandOutput | UntagResourceCommandOutput | UpdatePlacementCommandOutput | UpdateProjectCommandOutput;
...
declare type IoT1ClickProjectsClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & RetryInputConfig & HostHeaderInputConfig & AwsAuthInputConfig & UserAgentInputConfig;
/**
...
declare type IoT1ClickProjectsClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & RetryResolvedConfig & HostHeaderResolvedConfig & AwsAuthResolvedConfig & UserAgentResolvedConfig;
/**
 ...
 */
export declare class IoT1ClickProjectsClient extends __Client<__HttpHandlerOptions, ServiceInputTypes, ServiceOutputTypes, IoT1ClickProjectsClientResolvedConfig> {
    /**
