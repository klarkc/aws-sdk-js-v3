...
var AWS_TEMPLATE = "projects.iot1click.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "projects.iot1click.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "projects.iot1click.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "projects.iot1click.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "projects.iot1click.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "iot1click" }, regionInfo));
};
