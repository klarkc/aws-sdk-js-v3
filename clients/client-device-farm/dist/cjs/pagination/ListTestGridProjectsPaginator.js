...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListTestGridProjectsCommand_1.ListTestGridProjectsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListTestGridProjects(config, input, ...additionalArguments) {
...
exports.paginateListTestGridProjects = paginateListTestGridProjects;
