 ...
 *
 */
var UpdateTestGridProjectCommand = /** @class */ (function (_super) {
    __extends(UpdateTestGridProjectCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function UpdateTestGridProjectCommand(input) {
        var _this = 
     ...
     * @internal
     */
    UpdateTestGridProjectCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "DeviceFarmClient";
        var commandName = "UpdateTestGridProjectCommand";
    ...
    UpdateTestGridProjectCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1UpdateTestGridProjectCommand(input, context);
    };
    UpdateTestGridProjectCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1UpdateTestGridProjectCommand(output, context);
    };
    return UpdateTestGridProjectCommand;
}($Command));
export { UpdateTestGridProjectCommand };
