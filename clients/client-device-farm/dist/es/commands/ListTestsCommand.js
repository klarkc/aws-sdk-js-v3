 ...
 *
 */
var ListTestsCommand = /** @class */ (function (_super) {
    __extends(ListTestsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListTestsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListTestsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "DeviceFarmClient";
        var commandName = "ListTestsCommand";
    ...
    ListTestsCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1ListTestsCommand(input, context);
    };
    ListTestsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1ListTestsCommand(output, context);
    };
    return ListTestsCommand;
}($Command));
export { ListTestsCommand };
