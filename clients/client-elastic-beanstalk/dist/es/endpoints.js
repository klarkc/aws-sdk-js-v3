...
var AWS_TEMPLATE = "elasticbeanstalk.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "elasticbeanstalk.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "elasticbeanstalk.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "elasticbeanstalk.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "elasticbeanstalk.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "ap-northeast-3":
            regionInfo = {
                hostname: "elasticbeanstalk.ap-northeast-3.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-south-1":
        ...
        case "eu-south-1":
            regionInfo = {
                hostname: "elasticbeanstalk.eu-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-west-1":
    ...
    return Promise.resolve(__assign({ signingService: "elasticbeanstalk" }, regionInfo));
};
