...
const AWS_TEMPLATE = "elasticbeanstalk.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "elasticbeanstalk.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "elasticbeanstalk.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "elasticbeanstalk.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "elasticbeanstalk.{region}.amazonaws.com";
// Partition regions
