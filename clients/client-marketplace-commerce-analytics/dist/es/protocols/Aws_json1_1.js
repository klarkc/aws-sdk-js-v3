        ...
        switch (_a.label) {
            case 0:
                if (output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_json1_1GenerateDataSetCommandError(output, context)];
                }
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 1:
                ...
                _b = errorCode;
                switch (_b) {
                    case "MarketplaceCommerceAnalyticsException": return [3 /*break*/, 2];
                    case "com.amazonaws.marketplacecommerceanalytics#MarketplaceCommerceAnalyticsException": return [3 /*break*/, 2];
                }
                return [3 /*break*/, 4];
            case 2:
                _c = [{}];
                return [4 /*yield*/, deserializeAws_json1_1MarketplaceCommerceAnalyticsExceptionResponse(parsedOutput, context)];
            case 3:
...
export var deserializeAws_json1_1StartSupportDataExportCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_json1_1StartSupportDataExportCommandError(output, context)];
                }
                return [4 /*yield*/, parseBody(output.body, context)];
            case 1:
                data = _a.sent();
...
var deserializeAws_json1_1MarketplaceCommerceAnalyticsExceptionResponse = function (parsedOutput, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        contents = __assign({ name: "MarketplaceCommerceAnalyticsException", $fault: "server", $metadata: deserializeMetadata(parsedOutput) }, deserialized);
