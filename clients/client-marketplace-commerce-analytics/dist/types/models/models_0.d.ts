...
export declare namespace GenerateDataSetRequest {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: GenerateDataSetRequest) => any;
}
/**
...
export declare namespace GenerateDataSetResult {
    /**
     * @internal
     */
...
export declare namespace MarketplaceCommerceAnalyticsException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: MarketplaceCommerceAnalyticsException) => any;
}
...
export declare namespace StartSupportDataExportRequest {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: StartSupportDataExportRequest) => any;
}
/**
...
export declare namespace StartSupportDataExportResult {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: StartSupportDataExportResult) => any;
}
