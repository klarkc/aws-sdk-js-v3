...
(function (GenerateDataSetRequest) {
     ...
     * @internal
     */
    GenerateDataSetRequest.filterSensitiveLog = (obj) => ({
        ...obj,
    });
...
(function (GenerateDataSetResult) {
     ...
     * @internal
     */
    GenerateDataSetResult.filterSensitiveLog = (obj) => ({
        ...obj,
    });
...
(function (MarketplaceCommerceAnalyticsException) {
     ...
     * @internal
     */
    MarketplaceCommerceAnalyticsException.filterSensitiveLog = (obj) => ({
        ...obj,
    });
...
(function (StartSupportDataExportResult) {
     ...
     * @internal
     */
    StartSupportDataExportResult.filterSensitiveLog = (obj) => ({
        ...obj,
    });
