...
export declare namespace CloudHsmAccessDeniedException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: CloudHsmAccessDeniedException) => any;
}
/**
...
export declare namespace CloudHsmInternalFailureException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: CloudHsmInternalFailureException) => any;
}
/**
...
export declare namespace CloudHsmInvalidRequestException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: CloudHsmInvalidRequestException) => any;
}
/**
...
export declare namespace CloudHsmResourceNotFoundException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: CloudHsmResourceNotFoundException) => any;
}
/**
...
export declare namespace CloudHsmTagException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: CloudHsmTagException) => any;
}
