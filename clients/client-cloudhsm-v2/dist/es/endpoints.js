...
var AWS_TEMPLATE = "cloudhsmv2.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "cloudhsmv2.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "cloudhsmv2.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "cloudhsmv2.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "cloudhsmv2.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
  ...
  switch (region) {
    ...
    case "eu-south-1":
      regionInfo = {
        hostname: "cloudhsmv2.eu-south-1.amazonaws.com",
        partition: "aws",
        signingService: "cloudhsm",
      };
      break;
  ...
  return Promise.resolve(__assign({ signingService: "cloudhsm" }, regionInfo));
};
