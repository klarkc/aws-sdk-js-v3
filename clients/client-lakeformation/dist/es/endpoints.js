...
var AWS_TEMPLATE = "lakeformation.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "lakeformation.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "lakeformation.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "lakeformation.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "lakeformation.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "eu-north-1":
            regionInfo = {
                hostname: "lakeformation.eu-north-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-south-1":
            regionInfo = {
                hostname: "lakeformation.eu-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-west-1":
        ...
        case "eu-west-3":
            regionInfo = {
                hostname: "lakeformation.eu-west-3.amazonaws.com",
                partition: "aws",
            };
            break;
        case "fips-us-east-1":
        ...
        case "sa-east-1":
            regionInfo = {
                hostname: "lakeformation.sa-east-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "us-east-1":
    ...
    return Promise.resolve(__assign({ signingService: "lakeformation" }, regionInfo));
};
