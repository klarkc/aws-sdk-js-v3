...
const AWS_TEMPLATE = "lakeformation.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "lakeformation.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "lakeformation.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "lakeformation.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "lakeformation.{region}.amazonaws.com";
// Partition regions
