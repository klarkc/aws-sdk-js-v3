...
var AWS_TEMPLATE = "mediaconvert.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "mediaconvert.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "mediaconvert.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "mediaconvert.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "mediaconvert.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "mediaconvert" }, regionInfo));
};
