...
exports.ListApplicationStatesCommand = void 0;
 ...
 *
 */
class ListApplicationStatesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.ListApplicationStatesRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.ListApplicationStatesResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_json1_1_1.serializeAws_json1_1ListApplicationStatesCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_json1_1_1.deserializeAws_json1_1ListApplicationStatesCommand(output, context);
    }
}
