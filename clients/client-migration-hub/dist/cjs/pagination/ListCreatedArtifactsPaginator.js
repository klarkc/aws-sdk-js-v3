...
exports.paginateListCreatedArtifacts = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListCreatedArtifactsCommand_1.ListCreatedArtifactsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListCreatedArtifacts(config, input, ...additionalArguments) {
