...
import { deserializeAws_json1_1DisassociateDiscoveredResourceCommand, serializeAws_json1_1DisassociateDiscoveredResourceCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var DisassociateDiscoveredResourceCommand = /** @class */ (function (_super) {
    __extends(DisassociateDiscoveredResourceCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DisassociateDiscoveredResourceCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DisassociateDiscoveredResourceCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "MigrationHubClient";
        var commandName = "DisassociateDiscoveredResourceCommand";
    ...
    DisassociateDiscoveredResourceCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DisassociateDiscoveredResourceCommand(input, context);
    };
    DisassociateDiscoveredResourceCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DisassociateDiscoveredResourceCommand(output, context);
    };
    return DisassociateDiscoveredResourceCommand;
}($Command));
export { DisassociateDiscoveredResourceCommand };
//# sourceMappingURL=DisassociateDiscoveredResourceCommand.js.map