...
import { deserializeAws_json1_1DescribeMigrationTaskCommand, serializeAws_json1_1DescribeMigrationTaskCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var DescribeMigrationTaskCommand = /** @class */ (function (_super) {
    __extends(DescribeMigrationTaskCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DescribeMigrationTaskCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DescribeMigrationTaskCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "MigrationHubClient";
        var commandName = "DescribeMigrationTaskCommand";
    ...
    DescribeMigrationTaskCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DescribeMigrationTaskCommand(input, context);
    };
    DescribeMigrationTaskCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DescribeMigrationTaskCommand(output, context);
    };
    return DescribeMigrationTaskCommand;
}($Command));
export { DescribeMigrationTaskCommand };
