 ...
 */
var MigrationHubClient = /** @class */ (function (_super) {
    __extends(MigrationHubClient, _super);
    function MigrationHubClient(configuration) {
        var _this = this;
     ...
     */
    MigrationHubClient.prototype.destroy = function () {
        _super.prototype.destroy.call(this);
    };
    return MigrationHubClient;
}(__Client));
export { MigrationHubClient };
