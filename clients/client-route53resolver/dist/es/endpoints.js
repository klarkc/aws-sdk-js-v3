...
var AWS_TEMPLATE = "route53resolver.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "route53resolver.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "route53resolver.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "route53resolver.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "route53resolver.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "ap-northeast-3":
            regionInfo = {
                hostname: "route53resolver.ap-northeast-3.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-south-1":
    ...
    return Promise.resolve(__assign({ signingService: "route53resolver" }, regionInfo));
};
