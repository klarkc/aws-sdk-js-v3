 ...
 *
 */
var UpdateResolverEndpointCommand = /** @class */ (function (_super) {
    __extends(UpdateResolverEndpointCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function UpdateResolverEndpointCommand(input) {
        var _this = 
     ...
     * @internal
     */
    UpdateResolverEndpointCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "Route53ResolverClient";
        var commandName = "UpdateResolverEndpointCommand";
    ...
    UpdateResolverEndpointCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1UpdateResolverEndpointCommand(output, context);
    };
    return UpdateResolverEndpointCommand;
}($Command));
