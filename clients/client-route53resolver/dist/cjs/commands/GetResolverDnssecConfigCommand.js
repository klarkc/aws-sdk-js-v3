...
exports.GetResolverDnssecConfigCommand = void 0;
...
class GetResolverDnssecConfigCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.GetResolverDnssecConfigRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.GetResolverDnssecConfigResponse.filterSensitiveLog,
        };
