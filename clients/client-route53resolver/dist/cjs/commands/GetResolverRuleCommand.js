...
exports.GetResolverRuleCommand = void 0;
...
class GetResolverRuleCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.GetResolverRuleRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.GetResolverRuleResponse.filterSensitiveLog,
        };
