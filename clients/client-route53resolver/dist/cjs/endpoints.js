...
const AWS_TEMPLATE = "route53resolver.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "route53resolver.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "route53resolver.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "route53resolver.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "route53resolver.{region}.amazonaws.com";
// Partition regions
