...
var AWS_TEMPLATE = "datasync.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "datasync.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "datasync.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "datasync.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "datasync.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "datasync" }, regionInfo));
};
