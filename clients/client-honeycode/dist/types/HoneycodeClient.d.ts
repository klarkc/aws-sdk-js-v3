...
export declare type ServiceInputTypes = BatchCreateTableRowsCommandInput | BatchDeleteTableRowsCommandInput | BatchUpdateTableRowsCommandInput | BatchUpsertTableRowsCommandInput | DescribeTableDataImportJobCommandInput | GetScreenDataCommandInput | InvokeScreenAutomationCommandInput | ListTableColumnsCommandInput | ListTableRowsCommandInput | ListTablesCommandInput | QueryTableRowsCommandInput | StartTableDataImportJobCommandInput;
export declare type ServiceOutputTypes = BatchCreateTableRowsCommandOutput | BatchDeleteTableRowsCommandOutput | BatchUpdateTableRowsCommandOutput | BatchUpsertTableRowsCommandOutput | DescribeTableDataImportJobCommandOutput | GetScreenDataCommandOutput | InvokeScreenAutomationCommandOutput | ListTableColumnsCommandOutput | ListTableRowsCommandOutput | ListTablesCommandOutput | QueryTableRowsCommandOutput | StartTableDataImportJobCommandOutput;
...
declare type HoneycodeClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & RetryInputConfig & HostHeaderInputConfig & AwsAuthInputConfig & UserAgentInputConfig;
/**
...
declare type HoneycodeClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & RetryResolvedConfig & HostHeaderResolvedConfig & AwsAuthResolvedConfig & UserAgentResolvedConfig;
/**
 ...
 *     </p>
 */
export declare class HoneycodeClient extends __Client<__HttpHandlerOptions, ServiceInputTypes, ServiceOutputTypes, HoneycodeClientResolvedConfig> {
    /**
