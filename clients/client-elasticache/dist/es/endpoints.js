...
var AWS_TEMPLATE = "elasticache.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "elasticache.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "elasticache.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "elasticache.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "elasticache.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "ap-northeast-3":
            regionInfo = {
                hostname: "elasticache.ap-northeast-3.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-south-1":
    ...
    return Promise.resolve(__assign({ signingService: "elasticache" }, regionInfo));
};
