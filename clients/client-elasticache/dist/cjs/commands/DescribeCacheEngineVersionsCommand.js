...
exports.DescribeCacheEngineVersionsCommand = void 0;
...
class DescribeCacheEngineVersionsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DescribeCacheEngineVersionsMessage.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.CacheEngineVersionMessage.filterSensitiveLog,
        };
