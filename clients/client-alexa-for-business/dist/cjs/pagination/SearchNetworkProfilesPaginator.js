...
exports.paginateSearchNetworkProfiles = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
  // @ts-ignore
  return await client.send(new SearchNetworkProfilesCommand_1.SearchNetworkProfilesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateSearchNetworkProfiles(config, input, ...additionalArguments) {
...
exports.paginateSearchNetworkProfiles = paginateSearchNetworkProfiles;
