...
exports.paginateListDeviceEvents = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
  // @ts-ignore
  return await client.send(new ListDeviceEventsCommand_1.ListDeviceEventsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListDeviceEvents(config, input, ...additionalArguments) {
...
exports.paginateListDeviceEvents = paginateListDeviceEvents;
