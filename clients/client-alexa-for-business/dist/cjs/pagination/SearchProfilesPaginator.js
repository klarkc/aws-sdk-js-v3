...
exports.paginateSearchProfiles = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
  // @ts-ignore
  return await client.send(new SearchProfilesCommand_1.SearchProfilesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateSearchProfiles(config, input, ...additionalArguments) {
...
exports.paginateSearchProfiles = paginateSearchProfiles;
