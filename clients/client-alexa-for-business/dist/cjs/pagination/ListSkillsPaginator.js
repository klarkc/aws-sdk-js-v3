...
exports.paginateListSkills = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
  // @ts-ignore
  return await client.send(new ListSkillsCommand_1.ListSkillsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListSkills(config, input, ...additionalArguments) {
...
exports.paginateListSkills = paginateListSkills;
