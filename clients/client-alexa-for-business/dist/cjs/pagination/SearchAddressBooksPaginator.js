...
exports.paginateSearchAddressBooks = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
  // @ts-ignore
  return await client.send(new SearchAddressBooksCommand_1.SearchAddressBooksCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateSearchAddressBooks(config, input, ...additionalArguments) {
...
exports.paginateSearchAddressBooks = paginateSearchAddressBooks;
