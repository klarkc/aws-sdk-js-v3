 ...
 *
 */
var GetConferenceProviderCommand = /** @class */ (function (_super) {
  __extends(GetConferenceProviderCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function GetConferenceProviderCommand(input) {
    var _this =
   ...
   * @internal
   */
  GetConferenceProviderCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "AlexaForBusinessClient";
    var commandName = "GetConferenceProviderCommand";
  ...
  GetConferenceProviderCommand.prototype.serialize = function (input, context) {
    return serializeAws_json1_1GetConferenceProviderCommand(input, context);
  };
  GetConferenceProviderCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_json1_1GetConferenceProviderCommand(output, context);
  };
  return GetConferenceProviderCommand;
})($Command);
export { GetConferenceProviderCommand };
