 ...
 *
 */
var ListSmartHomeAppliancesCommand = /** @class */ (function (_super) {
  __extends(ListSmartHomeAppliancesCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function ListSmartHomeAppliancesCommand(input) {
    var _this =
   ...
   * @internal
   */
  ListSmartHomeAppliancesCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "AlexaForBusinessClient";
    var commandName = "ListSmartHomeAppliancesCommand";
  ...
  ListSmartHomeAppliancesCommand.prototype.serialize = function (input, context) {
    return serializeAws_json1_1ListSmartHomeAppliancesCommand(input, context);
  };
  ListSmartHomeAppliancesCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_json1_1ListSmartHomeAppliancesCommand(output, context);
  };
  return ListSmartHomeAppliancesCommand;
})($Command);
export { ListSmartHomeAppliancesCommand };
