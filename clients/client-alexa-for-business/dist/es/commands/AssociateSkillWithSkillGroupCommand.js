 ...
 *
 */
var AssociateSkillWithSkillGroupCommand = /** @class */ (function (_super) {
  __extends(AssociateSkillWithSkillGroupCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function AssociateSkillWithSkillGroupCommand(input) {
    var _this =
   ...
   * @internal
   */
  AssociateSkillWithSkillGroupCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "AlexaForBusinessClient";
    var commandName = "AssociateSkillWithSkillGroupCommand";
  ...
  AssociateSkillWithSkillGroupCommand.prototype.serialize = function (input, context) {
    return serializeAws_json1_1AssociateSkillWithSkillGroupCommand(input, context);
  };
  AssociateSkillWithSkillGroupCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_json1_1AssociateSkillWithSkillGroupCommand(output, context);
  };
  return AssociateSkillWithSkillGroupCommand;
})($Command);
export { AssociateSkillWithSkillGroupCommand };
