 ...
 *
 */
var DeleteRoomSkillParameterCommand = /** @class */ (function (_super) {
  __extends(DeleteRoomSkillParameterCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function DeleteRoomSkillParameterCommand(input) {
    var _this =
   ...
   * @internal
   */
  DeleteRoomSkillParameterCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "AlexaForBusinessClient";
    var commandName = "DeleteRoomSkillParameterCommand";
  ...
  DeleteRoomSkillParameterCommand.prototype.serialize = function (input, context) {
    return serializeAws_json1_1DeleteRoomSkillParameterCommand(input, context);
  };
  DeleteRoomSkillParameterCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_json1_1DeleteRoomSkillParameterCommand(output, context);
  };
  return DeleteRoomSkillParameterCommand;
})($Command);
export { DeleteRoomSkillParameterCommand };
