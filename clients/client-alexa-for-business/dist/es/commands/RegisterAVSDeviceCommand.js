 ...
 *
 */
var RegisterAVSDeviceCommand = /** @class */ (function (_super) {
  __extends(RegisterAVSDeviceCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function RegisterAVSDeviceCommand(input) {
    var _this =
   ...
   * @internal
   */
  RegisterAVSDeviceCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "AlexaForBusinessClient";
    var commandName = "RegisterAVSDeviceCommand";
  ...
  RegisterAVSDeviceCommand.prototype.serialize = function (input, context) {
    return serializeAws_json1_1RegisterAVSDeviceCommand(input, context);
  };
  RegisterAVSDeviceCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_json1_1RegisterAVSDeviceCommand(output, context);
  };
  return RegisterAVSDeviceCommand;
})($Command);
export { RegisterAVSDeviceCommand };
