 ...
 *
 */
var GetAddressBookCommand = /** @class */ (function (_super) {
  __extends(GetAddressBookCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function GetAddressBookCommand(input) {
    var _this =
   ...
   * @internal
   */
  GetAddressBookCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "AlexaForBusinessClient";
    var commandName = "GetAddressBookCommand";
  ...
  GetAddressBookCommand.prototype.serialize = function (input, context) {
    return serializeAws_json1_1GetAddressBookCommand(input, context);
  };
  GetAddressBookCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_json1_1GetAddressBookCommand(output, context);
  };
  return GetAddressBookCommand;
})($Command);
export { GetAddressBookCommand };
