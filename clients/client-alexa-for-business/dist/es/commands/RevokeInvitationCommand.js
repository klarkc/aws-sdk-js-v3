 ...
 *
 */
var RevokeInvitationCommand = /** @class */ (function (_super) {
  __extends(RevokeInvitationCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function RevokeInvitationCommand(input) {
    var _this =
   ...
   * @internal
   */
  RevokeInvitationCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "AlexaForBusinessClient";
    var commandName = "RevokeInvitationCommand";
  ...
  RevokeInvitationCommand.prototype.serialize = function (input, context) {
    return serializeAws_json1_1RevokeInvitationCommand(input, context);
  };
  RevokeInvitationCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_json1_1RevokeInvitationCommand(output, context);
  };
  return RevokeInvitationCommand;
})($Command);
export { RevokeInvitationCommand };
