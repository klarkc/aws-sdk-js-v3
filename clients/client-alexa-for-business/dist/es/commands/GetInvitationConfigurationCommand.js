 ...
 *
 */
var GetInvitationConfigurationCommand = /** @class */ (function (_super) {
  __extends(GetInvitationConfigurationCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function GetInvitationConfigurationCommand(input) {
    var _this =
   ...
   * @internal
   */
  GetInvitationConfigurationCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "AlexaForBusinessClient";
    var commandName = "GetInvitationConfigurationCommand";
    var handlerExecutionContext = {
      logger: logger,
      clientName: clientName,
      commandName: commandName,
      inputFilterSensitiveLog: GetInvitationConfigurationRequest.filterSensitiveLog,
      outputFilterSensitiveLog: GetInvitationConfigurationResponse.filterSensitiveLog,
    };
  ...
  GetInvitationConfigurationCommand.prototype.serialize = function (input, context) {
    return serializeAws_json1_1GetInvitationConfigurationCommand(input, context);
  };
  GetInvitationConfigurationCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_json1_1GetInvitationConfigurationCommand(output, context);
  };
  return GetInvitationConfigurationCommand;
})($Command);
export { GetInvitationConfigurationCommand };
