 ...
 *
 */
var ListSkillsStoreSkillsByCategoryCommand = /** @class */ (function (_super) {
  __extends(ListSkillsStoreSkillsByCategoryCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function ListSkillsStoreSkillsByCategoryCommand(input) {
    var _this =
   ...
   * @internal
   */
  ListSkillsStoreSkillsByCategoryCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "AlexaForBusinessClient";
    var commandName = "ListSkillsStoreSkillsByCategoryCommand";
  ...
  ListSkillsStoreSkillsByCategoryCommand.prototype.serialize = function (input, context) {
    return serializeAws_json1_1ListSkillsStoreSkillsByCategoryCommand(input, context);
  };
  ListSkillsStoreSkillsByCategoryCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_json1_1ListSkillsStoreSkillsByCategoryCommand(output, context);
  };
  return ListSkillsStoreSkillsByCategoryCommand;
})($Command);
export { ListSkillsStoreSkillsByCategoryCommand };
//# sourceMappingURL=ListSkillsStoreSkillsByCategoryCommand.js.map
