 ...
 *
 */
var SearchNetworkProfilesCommand = /** @class */ (function (_super) {
  __extends(SearchNetworkProfilesCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function SearchNetworkProfilesCommand(input) {
    var _this =
   ...
   * @internal
   */
  SearchNetworkProfilesCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "AlexaForBusinessClient";
    var commandName = "SearchNetworkProfilesCommand";
  ...
  SearchNetworkProfilesCommand.prototype.serialize = function (input, context) {
    return serializeAws_json1_1SearchNetworkProfilesCommand(input, context);
  };
  SearchNetworkProfilesCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_json1_1SearchNetworkProfilesCommand(output, context);
  };
  return SearchNetworkProfilesCommand;
})($Command);
export { SearchNetworkProfilesCommand };
