    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            client.send.apply(client, __spreadArray([new ListSkillsStoreSkillsByCategoryCommand(input)], __read(args))),
          ];
        case 1:
          // @ts-ignore
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            client.listSkillsStoreSkillsByCategory.apply(client, __spreadArray([input], __read(args))),
          ];
        case 1:
          // @ts-ignore
          return [2 /*return*/, _a.sent()];
...
export function paginateListSkillsStoreSkillsByCategory(config, input) {
  var additionalArguments = [];
  for (var _i = 2; _i < arguments.length; _i++) {
    additionalArguments[_i - 2] = arguments[_i];
  }
  return __asyncGenerator(this, arguments, function paginateListSkillsStoreSkillsByCategory_1() {
