...
class GetJobBookmarkCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.GetJobBookmarkRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_1_1.GetJobBookmarkResponse.filterSensitiveLog,
        };
