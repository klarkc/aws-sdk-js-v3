...
class GetSecurityConfigurationCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.GetSecurityConfigurationRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_1_1.GetSecurityConfigurationResponse.filterSensitiveLog,
        };
