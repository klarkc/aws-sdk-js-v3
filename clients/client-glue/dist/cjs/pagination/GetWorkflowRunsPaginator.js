...
exports.paginateGetWorkflowRuns = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new GetWorkflowRunsCommand_1.GetWorkflowRunsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateGetWorkflowRuns(config, input, ...additionalArguments) {
