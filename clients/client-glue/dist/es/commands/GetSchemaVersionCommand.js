 ...
 *
 */
var GetSchemaVersionCommand = /** @class */ (function (_super) {
    __extends(GetSchemaVersionCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function GetSchemaVersionCommand(input) {
        var _this = 
     ...
     * @internal
     */
    GetSchemaVersionCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "GlueClient";
        var commandName = "GetSchemaVersionCommand";
    ...
    GetSchemaVersionCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1GetSchemaVersionCommand(input, context);
    };
    GetSchemaVersionCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1GetSchemaVersionCommand(output, context);
    };
    return GetSchemaVersionCommand;
}($Command));
export { GetSchemaVersionCommand };
