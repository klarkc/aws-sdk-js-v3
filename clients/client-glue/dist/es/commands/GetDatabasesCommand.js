 ...
 *
 */
var GetDatabasesCommand = /** @class */ (function (_super) {
    __extends(GetDatabasesCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function GetDatabasesCommand(input) {
        var _this = 
     ...
     * @internal
     */
    GetDatabasesCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "GlueClient";
        var commandName = "GetDatabasesCommand";
    ...
    GetDatabasesCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1GetDatabasesCommand(input, context);
    };
    GetDatabasesCommand.prototype.deserialize = function (output, context) {
