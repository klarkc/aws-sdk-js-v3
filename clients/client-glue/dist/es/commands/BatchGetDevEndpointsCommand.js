 ...
 *
 */
var BatchGetDevEndpointsCommand = /** @class */ (function (_super) {
    __extends(BatchGetDevEndpointsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function BatchGetDevEndpointsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    BatchGetDevEndpointsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "GlueClient";
        var commandName = "BatchGetDevEndpointsCommand";
    ...
    BatchGetDevEndpointsCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1BatchGetDevEndpointsCommand(input, context);
    };
    BatchGetDevEndpointsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1BatchGetDevEndpointsCommand(output, context);
    };
    return BatchGetDevEndpointsCommand;
}($Command));
export { BatchGetDevEndpointsCommand };
