 ...
 *
 */
var StartImportLabelsTaskRunCommand = /** @class */ (function (_super) {
    __extends(StartImportLabelsTaskRunCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function StartImportLabelsTaskRunCommand(input) {
        var _this = 
     ...
     * @internal
     */
    StartImportLabelsTaskRunCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "GlueClient";
        var commandName = "StartImportLabelsTaskRunCommand";
    ...
    StartImportLabelsTaskRunCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1StartImportLabelsTaskRunCommand(input, context);
    };
    StartImportLabelsTaskRunCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1StartImportLabelsTaskRunCommand(output, context);
    };
    return StartImportLabelsTaskRunCommand;
}($Command));
export { StartImportLabelsTaskRunCommand };
//# sourceMappingURL=StartImportLabelsTaskRunCommand.js.map