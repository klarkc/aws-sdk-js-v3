 ...
 *
 */
var BatchDeleteTableCommand = /** @class */ (function (_super) {
    __extends(BatchDeleteTableCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function BatchDeleteTableCommand(input) {
        var _this = 
     ...
     * @internal
     */
    BatchDeleteTableCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "GlueClient";
        var commandName = "BatchDeleteTableCommand";
    ...
    BatchDeleteTableCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1BatchDeleteTableCommand(input, context);
    };
    BatchDeleteTableCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1BatchDeleteTableCommand(output, context);
    };
    return BatchDeleteTableCommand;
}($Command));
export { BatchDeleteTableCommand };
