 ...
 *
 */
var BatchCreatePartitionCommand = /** @class */ (function (_super) {
    __extends(BatchCreatePartitionCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function BatchCreatePartitionCommand(input) {
        var _this = 
     ...
     * @internal
     */
    BatchCreatePartitionCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "GlueClient";
        var commandName = "BatchCreatePartitionCommand";
    ...
    BatchCreatePartitionCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1BatchCreatePartitionCommand(input, context);
    };
    BatchCreatePartitionCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1BatchCreatePartitionCommand(output, context);
    };
    return BatchCreatePartitionCommand;
}($Command));
export { BatchCreatePartitionCommand };
