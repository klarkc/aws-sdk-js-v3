...
exports.UpdateEvaluationCommand = void 0;
...
class UpdateEvaluationCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.UpdateEvaluationInput.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.UpdateEvaluationOutput.filterSensitiveLog,
        };
