...
exports.waitUntilEvaluationAvailable = exports.waitForEvaluationAvailable = void 0;
const DescribeEvaluationsCommand_1 = require("../commands/DescribeEvaluationsCommand");
const util_waiter_1 = require("@aws-sdk/util-waiter");
const checkState = async (client, input) => {
    let reason;
    try {
        let result = await client.send(new DescribeEvaluationsCommand_1.DescribeEvaluationsCommand(input));
        reason = result;
        try {
