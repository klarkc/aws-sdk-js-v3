...
exports.DescribeBotVersionCommand = void 0;
...
class DescribeBotVersionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DescribeBotVersionRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.DescribeBotVersionResponse.filterSensitiveLog,
        };
