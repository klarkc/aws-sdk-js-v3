...
var AWS_TEMPLATE = "session.qldb.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "session.qldb.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "session.qldb.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "session.qldb.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "session.qldb.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "qldb" }, regionInfo));
};
