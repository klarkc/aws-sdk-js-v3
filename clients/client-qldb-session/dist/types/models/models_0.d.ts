...
export declare namespace TimingInformation {
    /**
     * @internal
     */
...
export declare namespace CapacityExceededException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: CapacityExceededException) => any;
}
/**
...
export declare namespace IOUsage {
    /**
     * @internal
     */
...
export declare namespace InvalidSessionException {
     ...
     * @internal
     */
    const filterSensitiveLog: (obj: InvalidSessionException) => any;
}
/**
...
export declare namespace OccConflictException {
     ...
     * @internal
     */
    const filterSensitiveLog: (obj: OccConflictException) => any;
}
/**
...
export declare namespace RateExceededException {
     ...
     * @internal
     */
    const filterSensitiveLog: (obj: RateExceededException) => any;
}
/**
