...
var AWS_TEMPLATE = "elastictranscoder.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "elastictranscoder.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "elastictranscoder.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "elastictranscoder.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "elastictranscoder.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "elastictranscoder" }, regionInfo));
};
