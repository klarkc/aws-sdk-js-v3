...
export declare type ServiceInputTypes = CancelJobCommandInput | CreateJobCommandInput | CreatePipelineCommandInput | CreatePresetCommandInput | DeletePipelineCommandInput | DeletePresetCommandInput | ListJobsByPipelineCommandInput | ListJobsByStatusCommandInput | ListPipelinesCommandInput | ListPresetsCommandInput | ReadJobCommandInput | ReadPipelineCommandInput | ReadPresetCommandInput | TestRoleCommandInput | UpdatePipelineCommandInput | UpdatePipelineNotificationsCommandInput | UpdatePipelineStatusCommandInput;
export declare type ServiceOutputTypes = CancelJobCommandOutput | CreateJobCommandOutput | CreatePipelineCommandOutput | CreatePresetCommandOutput | DeletePipelineCommandOutput | DeletePresetCommandOutput | ListJobsByPipelineCommandOutput | ListJobsByStatusCommandOutput | ListPipelinesCommandOutput | ListPresetsCommandOutput | ReadJobCommandOutput | ReadPipelineCommandOutput | ReadPresetCommandOutput | TestRoleCommandOutput | UpdatePipelineCommandOutput | UpdatePipelineNotificationsCommandOutput | UpdatePipelineStatusCommandOutput;
...
declare type ElasticTranscoderClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & RetryInputConfig & HostHeaderInputConfig & AwsAuthInputConfig & UserAgentInputConfig;
/**
...
declare type ElasticTranscoderClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & RetryResolvedConfig & HostHeaderResolvedConfig & AwsAuthResolvedConfig & UserAgentResolvedConfig;
/**
 ...
 */
export declare class ElasticTranscoderClient extends __Client<__HttpHandlerOptions, ServiceInputTypes, ServiceOutputTypes, ElasticTranscoderClientResolvedConfig> {
    /**
