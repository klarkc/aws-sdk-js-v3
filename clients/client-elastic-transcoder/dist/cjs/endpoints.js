...
const AWS_TEMPLATE = "elastictranscoder.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "elastictranscoder.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "elastictranscoder.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "elastictranscoder.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "elastictranscoder.{region}.amazonaws.com";
// Partition regions
