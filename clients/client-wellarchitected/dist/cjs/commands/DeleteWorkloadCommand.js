...
exports.DeleteWorkloadCommand = void 0;
 ...
 *
 */
class DeleteWorkloadCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DeleteWorkloadInput.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1DeleteWorkloadCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1DeleteWorkloadCommand(output, context);
    }
}
exports.DeleteWorkloadCommand = DeleteWorkloadCommand;
//# sourceMappingURL=DeleteWorkloadCommand.js.map