...
exports.AssociateLensesCommand = void 0;
...
class AssociateLensesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.AssociateLensesInput.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1AssociateLensesCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1AssociateLensesCommand(output, context);
    }
}
