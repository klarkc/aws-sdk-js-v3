...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListLensReviewImprovementsCommand_1.ListLensReviewImprovementsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListLensReviewImprovements(config, input, ...additionalArguments) {
...
exports.paginateListLensReviewImprovements = paginateListLensReviewImprovements;
