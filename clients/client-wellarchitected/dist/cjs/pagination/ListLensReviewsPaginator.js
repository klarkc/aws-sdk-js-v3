...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListLensReviewsCommand_1.ListLensReviewsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListLensReviews(config, input, ...additionalArguments) {
...
exports.paginateListLensReviews = paginateListLensReviews;
