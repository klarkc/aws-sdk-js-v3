 ...
 *
 */
var ListWorkloadsCommand = /** @class */ (function (_super) {
    __extends(ListWorkloadsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListWorkloadsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListWorkloadsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "WellArchitectedClient";
        var commandName = "ListWorkloadsCommand";
    ...
    ListWorkloadsCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1ListWorkloadsCommand(input, context);
    };
    ListWorkloadsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1ListWorkloadsCommand(output, context);
    };
    return ListWorkloadsCommand;
}($Command));
export { ListWorkloadsCommand };
//# sourceMappingURL=ListWorkloadsCommand.js.map