...
const AWS_TEMPLATE = "codecommit.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "codecommit.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "codecommit.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "codecommit.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "codecommit.{region}.amazonaws.com";
// Partition regions
