...
exports.CreatePullRequestCommand = void 0;
...
class CreatePullRequestCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.CreatePullRequestInput.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.CreatePullRequestOutput.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_json1_1_1.serializeAws_json1_1CreatePullRequestCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_json1_1_1.deserializeAws_json1_1CreatePullRequestCommand(output, context);
    }
}
exports.CreatePullRequestCommand = CreatePullRequestCommand;
//# sourceMappingURL=CreatePullRequestCommand.js.map