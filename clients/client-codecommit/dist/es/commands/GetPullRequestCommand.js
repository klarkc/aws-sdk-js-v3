...
var GetPullRequestCommand = /** @class */ (function (_super) {
    ...
    GetPullRequestCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        ...
        var commandName = "GetPullRequestCommand";
    ...
    GetPullRequestCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1GetPullRequestCommand(input, context);
    };
    GetPullRequestCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1GetPullRequestCommand(output, context);
    };
    return GetPullRequestCommand;
}($Command));
export { GetPullRequestCommand };
