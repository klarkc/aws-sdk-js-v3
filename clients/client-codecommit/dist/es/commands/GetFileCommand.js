 ...
 *
 */
var GetFileCommand = /** @class */ (function (_super) {
    __extends(GetFileCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function GetFileCommand(input) {
        var _this = 
     ...
     * @internal
     */
    GetFileCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "CodeCommitClient";
        var commandName = "GetFileCommand";
    ...
    GetFileCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1GetFileCommand(input, context);
    };
    GetFileCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1GetFileCommand(output, context);
    };
    return GetFileCommand;
}($Command));
export { GetFileCommand };
//# sourceMappingURL=GetFileCommand.js.map