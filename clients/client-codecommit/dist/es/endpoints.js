...
var AWS_TEMPLATE = "codecommit.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "codecommit.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "codecommit.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "codecommit.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "codecommit.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "ap-east-1":
            regionInfo = {
                hostname: "codecommit.ap-east-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-northeast-1":
        ...
        case "ap-northeast-3":
            regionInfo = {
                hostname: "codecommit.ap-northeast-3.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-south-1":
        ...
        case "cn-northwest-1":
            regionInfo = {
                hostname: "codecommit.cn-northwest-1.amazonaws.com.cn",
                partition: "aws-cn",
            };
            break;
        case "eu-central-1":
        ...
        case "eu-south-1":
            regionInfo = {
                hostname: "codecommit.eu-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-west-1":
    ...
    return Promise.resolve(__assign({ signingService: "codecommit" }, regionInfo));
};
