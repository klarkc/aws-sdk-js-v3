...
const AWS_TEMPLATE = "cognito-sync.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "cognito-sync.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "cognito-sync.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "cognito-sync.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "cognito-sync.{region}.amazonaws.com";
// Partition regions
