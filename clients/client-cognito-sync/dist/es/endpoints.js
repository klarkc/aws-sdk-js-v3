...
var AWS_TEMPLATE = "cognito-sync.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "cognito-sync.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "cognito-sync.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "cognito-sync.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "cognito-sync.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "cognito-sync" }, regionInfo));
};
