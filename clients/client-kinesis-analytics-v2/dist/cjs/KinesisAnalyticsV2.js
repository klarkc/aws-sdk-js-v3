...
const CreateApplicationPresignedUrlCommand_1 = require("./commands/CreateApplicationPresignedUrlCommand");
...
const DescribeApplicationVersionCommand_1 = require("./commands/DescribeApplicationVersionCommand");
...
const RollbackApplicationCommand_1 = require("./commands/RollbackApplicationCommand");
...
class KinesisAnalyticsV2 extends KinesisAnalyticsV2Client_1.KinesisAnalyticsV2Client {
    ...
    createApplicationPresignedUrl(args, optionsOrCb, cb) {
        const command = new CreateApplicationPresignedUrlCommand_1.CreateApplicationPresignedUrlCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
    ...
    describeApplicationVersion(args, optionsOrCb, cb) {
        const command = new DescribeApplicationVersionCommand_1.DescribeApplicationVersionCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
    ...
    rollbackApplication(args, optionsOrCb, cb) {
        const command = new RollbackApplicationCommand_1.RollbackApplicationCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
    ...
    updateApplicationMaintenanceConfiguration(args, optionsOrCb, cb) {
        const command = new UpdateApplicationMaintenanceConfigurationCommand_1.UpdateApplicationMaintenanceConfigurationCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
