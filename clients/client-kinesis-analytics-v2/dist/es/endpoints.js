...
var AWS_TEMPLATE = "kinesisanalytics.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "kinesisanalytics.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "kinesisanalytics.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "kinesisanalytics.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "kinesisanalytics.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "kinesisanalytics" }, regionInfo));
};
