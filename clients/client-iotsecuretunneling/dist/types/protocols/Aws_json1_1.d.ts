...
export declare const serializeAws_json1_1DescribeTunnelCommand: (input: DescribeTunnelCommandInput, context: __SerdeContext) => Promise<__HttpRequest>;
...
export declare const deserializeAws_json1_1DescribeTunnelCommand: (output: __HttpResponse, context: __SerdeContext) => Promise<DescribeTunnelCommandOutput>;
