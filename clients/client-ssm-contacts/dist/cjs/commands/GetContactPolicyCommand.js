...
exports.GetContactPolicyCommand = void 0;
...
class GetContactPolicyCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.GetContactPolicyRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.GetContactPolicyResult.filterSensitiveLog,
        };
