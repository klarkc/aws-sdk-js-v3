...
var AWS_TEMPLATE = "appmesh.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "appmesh.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "appmesh.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "appmesh.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "appmesh.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
  ...
  return Promise.resolve(__assign({ signingService: "appmesh" }, regionInfo));
};
