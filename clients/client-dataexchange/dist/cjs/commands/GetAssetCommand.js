...
exports.GetAssetCommand = void 0;
...
class GetAssetCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.GetAssetRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.GetAssetResponse.filterSensitiveLog,
        };
