...
const AWS_TEMPLATE = "dataexchange.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "dataexchange.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "dataexchange.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "dataexchange.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "dataexchange.{region}.amazonaws.com";
// Partition regions
