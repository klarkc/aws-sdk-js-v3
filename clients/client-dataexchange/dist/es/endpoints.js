...
var AWS_TEMPLATE = "dataexchange.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "dataexchange.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "dataexchange.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "dataexchange.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "dataexchange.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "dataexchange" }, regionInfo));
};
