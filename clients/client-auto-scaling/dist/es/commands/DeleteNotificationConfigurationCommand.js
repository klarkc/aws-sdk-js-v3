 ...
 *
 */
var DeleteNotificationConfigurationCommand = /** @class */ (function (_super) {
  __extends(DeleteNotificationConfigurationCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function DeleteNotificationConfigurationCommand(input) {
    var _this =
   ...
   * @internal
   */
  DeleteNotificationConfigurationCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "AutoScalingClient";
    var commandName = "DeleteNotificationConfigurationCommand";
  ...
  DeleteNotificationConfigurationCommand.prototype.serialize = function (input, context) {
    return serializeAws_queryDeleteNotificationConfigurationCommand(input, context);
  };
  DeleteNotificationConfigurationCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_queryDeleteNotificationConfigurationCommand(output, context);
  };
  return DeleteNotificationConfigurationCommand;
})($Command);
export { DeleteNotificationConfigurationCommand };
//# sourceMappingURL=DeleteNotificationConfigurationCommand.js.map
