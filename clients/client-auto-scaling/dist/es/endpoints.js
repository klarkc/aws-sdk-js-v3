...
var AWS_TEMPLATE = "autoscaling.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "autoscaling.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "autoscaling.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "autoscaling.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "autoscaling.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
  ...
  switch (region) {
    ...
    case "ap-northeast-3":
      regionInfo = {
        hostname: "autoscaling.ap-northeast-3.amazonaws.com",
        partition: "aws",
      };
      break;
    case "ap-south-1":
    ...
    case "eu-south-1":
      regionInfo = {
        hostname: "autoscaling.eu-south-1.amazonaws.com",
        partition: "aws",
      };
      break;
    case "eu-west-1":
  ...
  return Promise.resolve(__assign({ signingService: "autoscaling" }, regionInfo));
};
