...
exports.DisableMetricsCollectionCommand = void 0;
...
class DisableMetricsCollectionCommand extends smithy_client_1.Command {
  ...
  resolveMiddleware(clientStack, configuration, options) {
    ...
    const handlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: models_0_1.DisableMetricsCollectionQuery.filterSensitiveLog,
  ...
  serialize(input, context) {
    return Aws_query_1.serializeAws_queryDisableMetricsCollectionCommand(input, context);
  }
  deserialize(output, context) {
    return Aws_query_1.deserializeAws_queryDisableMetricsCollectionCommand(output, context);
  }
}
