...
var AWS_TEMPLATE = "greengrass.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "greengrass.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "greengrass.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "greengrass.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "greengrass.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "greengrass" }, regionInfo));
};
