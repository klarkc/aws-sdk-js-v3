...
exports.DescribeReservedNodesCommand = void 0;
...
class DescribeReservedNodesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DescribeReservedNodesMessage.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.ReservedNodesMessage.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_query_1.serializeAws_queryDescribeReservedNodesCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_query_1.deserializeAws_queryDescribeReservedNodesCommand(output, context);
    }
}
exports.DescribeReservedNodesCommand = DescribeReservedNodesCommand;
//# sourceMappingURL=DescribeReservedNodesCommand.js.map