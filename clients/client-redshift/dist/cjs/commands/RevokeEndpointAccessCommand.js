...
exports.RevokeEndpointAccessCommand = void 0;
 ...
 *
 */
class RevokeEndpointAccessCommand extends smithy_client_1.Command {
    ...
    serialize(input, context) {
        return Aws_query_1.serializeAws_queryRevokeEndpointAccessCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_query_1.deserializeAws_queryRevokeEndpointAccessCommand(output, context);
    }
}
exports.RevokeEndpointAccessCommand = RevokeEndpointAccessCommand;
