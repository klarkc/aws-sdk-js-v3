...
var AWS_TEMPLATE = "redshift.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "redshift.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "redshift.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "redshift.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "redshift.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "redshift" }, regionInfo));
};
