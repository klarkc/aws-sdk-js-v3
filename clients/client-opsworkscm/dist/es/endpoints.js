...
var AWS_TEMPLATE = "opsworks-cm.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "opsworks-cm.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "opsworks-cm.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "opsworks-cm.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "opsworks-cm.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "opsworks-cm" }, regionInfo));
};
