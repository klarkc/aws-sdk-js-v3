...
var serializeAws_json1_1MetricTransformation = function (input, context) {
    return __assign(__assign(__assign(__assign(__assign(__assign({}, (input.defaultValue !== undefined && input.defaultValue !== null && { defaultValue: input.defaultValue })), (input.dimensions !== undefined &&
        input.dimensions !== null && { dimensions: serializeAws_json1_1Dimensions(input.dimensions, context) })), (input.metricName !== undefined && input.metricName !== null && { metricName: input.metricName })), (input.metricNamespace !== undefined &&
        input.metricNamespace !== null && { metricNamespace: input.metricNamespace })), (input.metricValue !== undefined && input.metricValue !== null && { metricValue: input.metricValue })), (input.unit !== undefined && input.unit !== null && { unit: input.unit }));
};
