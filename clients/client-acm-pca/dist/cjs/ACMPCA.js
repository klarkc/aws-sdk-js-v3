...
class ACMPCA extends ACMPCAClient_1.ACMPCAClient {
  ...
  createCertificateAuthorityAuditReport(args, optionsOrCb, cb) {
    const command = new CreateCertificateAuthorityAuditReportCommand_1.CreateCertificateAuthorityAuditReportCommand(
      args
    );
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb);
  ...
  describeCertificateAuthorityAuditReport(args, optionsOrCb, cb) {
    const command = new DescribeCertificateAuthorityAuditReportCommand_1.DescribeCertificateAuthorityAuditReportCommand(
      args
    );
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb);
  ...
  importCertificateAuthorityCertificate(args, optionsOrCb, cb) {
    const command = new ImportCertificateAuthorityCertificateCommand_1.ImportCertificateAuthorityCertificateCommand(
      args
    );
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb);
