  ...
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 2, , 3]);
          return [4 /*yield*/, client.send(new GetCertificateCommand(input))];
        case 1:
          result = _a.sent();
          reason = result;
 ...
 */
export var waitForCertificateIssued = function (params, input) {
  return __awaiter(void 0, void 0, void 0, function () {
    var serviceDefaults;
    return __generator(this, function (_a) {
 ...
 */
export var waitUntilCertificateIssued = function (params, input) {
  return __awaiter(void 0, void 0, void 0, function () {
