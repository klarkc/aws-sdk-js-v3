...
var AWS_TEMPLATE = "acm-pca.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "acm-pca.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "acm-pca.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "acm-pca.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "acm-pca.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
  ...
  return Promise.resolve(__assign({ signingService: "acm-pca" }, regionInfo));
};
