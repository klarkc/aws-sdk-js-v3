...
import { deserializeAws_restJson1ListWorldTemplatesCommand, serializeAws_restJson1ListWorldTemplatesCommand, } from "../protocols/Aws_restJson1";
 ...
 *
 */
var ListWorldTemplatesCommand = /** @class */ (function (_super) {
    __extends(ListWorldTemplatesCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListWorldTemplatesCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListWorldTemplatesCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "RoboMakerClient";
        var commandName = "ListWorldTemplatesCommand";
    ...
    ListWorldTemplatesCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1ListWorldTemplatesCommand(input, context);
    };
    ListWorldTemplatesCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1ListWorldTemplatesCommand(output, context);
    };
    return ListWorldTemplatesCommand;
}($Command));
export { ListWorldTemplatesCommand };
