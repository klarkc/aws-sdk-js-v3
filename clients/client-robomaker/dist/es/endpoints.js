...
var AWS_TEMPLATE = "robomaker.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "robomaker.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "robomaker.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "robomaker.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "robomaker.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "robomaker" }, regionInfo));
};
