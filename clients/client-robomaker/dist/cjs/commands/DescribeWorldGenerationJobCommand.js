...
exports.DescribeWorldGenerationJobCommand = void 0;
 ...
 *
 */
class DescribeWorldGenerationJobCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DescribeWorldGenerationJobRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.DescribeWorldGenerationJobResponse.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1DescribeWorldGenerationJobCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1DescribeWorldGenerationJobCommand(output, context);
    }
}
exports.DescribeWorldGenerationJobCommand = DescribeWorldGenerationJobCommand;
