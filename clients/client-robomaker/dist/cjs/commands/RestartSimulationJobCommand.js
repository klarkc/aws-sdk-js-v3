...
exports.RestartSimulationJobCommand = void 0;
 ...
 *
 */
class RestartSimulationJobCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.RestartSimulationJobRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.RestartSimulationJobResponse.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1RestartSimulationJobCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1RestartSimulationJobCommand(output, context);
    }
}
exports.RestartSimulationJobCommand = RestartSimulationJobCommand;
