...
exports.DescribeSimulationJobCommand = void 0;
 ...
 *
 */
class DescribeSimulationJobCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DescribeSimulationJobRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.DescribeSimulationJobResponse.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1DescribeSimulationJobCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1DescribeSimulationJobCommand(output, context);
    }
}
exports.DescribeSimulationJobCommand = DescribeSimulationJobCommand;
