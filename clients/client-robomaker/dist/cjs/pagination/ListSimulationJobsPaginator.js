...
exports.paginateListSimulationJobs = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListSimulationJobsCommand_1.ListSimulationJobsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListSimulationJobs(config, input, ...additionalArguments) {
...
exports.paginateListSimulationJobs = paginateListSimulationJobs;
