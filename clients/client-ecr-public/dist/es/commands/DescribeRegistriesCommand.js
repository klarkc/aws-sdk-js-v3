...
var DescribeRegistriesCommand = /** @class */ (function (_super) {
    ...
    DescribeRegistriesCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        ...
        var commandName = "DescribeRegistriesCommand";
    ...
    DescribeRegistriesCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DescribeRegistriesCommand(input, context);
    };
    DescribeRegistriesCommand.prototype.deserialize = function (output, context) {
