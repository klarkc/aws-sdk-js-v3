 ...
 */
var ECRPUBLICClient = /** @class */ (function (_super) {
    __extends(ECRPUBLICClient, _super);
    function ECRPUBLICClient(configuration) {
        var _this = this;
     ...
     */
    ECRPUBLICClient.prototype.destroy = function () {
