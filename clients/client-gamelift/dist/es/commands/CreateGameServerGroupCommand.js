 ...
 *
 */
var CreateGameServerGroupCommand = /** @class */ (function (_super) {
    __extends(CreateGameServerGroupCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function CreateGameServerGroupCommand(input) {
        var _this = 
     ...
     * @internal
     */
    CreateGameServerGroupCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "GameLiftClient";
        var commandName = "CreateGameServerGroupCommand";
    ...
    CreateGameServerGroupCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1CreateGameServerGroupCommand(input, context);
    };
    CreateGameServerGroupCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1CreateGameServerGroupCommand(output, context);
    };
    return CreateGameServerGroupCommand;
}($Command));
export { CreateGameServerGroupCommand };
