 ...
 *
 */
var AcceptMatchCommand = /** @class */ (function (_super) {
    __extends(AcceptMatchCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function AcceptMatchCommand(input) {
        var _this = 
     ...
     * @internal
     */
    AcceptMatchCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "GameLiftClient";
        var commandName = "AcceptMatchCommand";
    ...
    AcceptMatchCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1AcceptMatchCommand(input, context);
    };
    AcceptMatchCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1AcceptMatchCommand(output, context);
    };
    return AcceptMatchCommand;
}($Command));
export { AcceptMatchCommand };
