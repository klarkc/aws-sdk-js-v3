...
var AWS_TEMPLATE = "gamelift.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "gamelift.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "gamelift.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "gamelift.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "gamelift.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "ap-east-1":
            regionInfo = {
                hostname: "gamelift.ap-east-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-northeast-1":
        ...
        case "eu-north-1":
            regionInfo = {
                hostname: "gamelift.eu-north-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-south-1":
            regionInfo = {
                hostname: "gamelift.eu-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-west-1":
        ...
        case "eu-west-3":
            regionInfo = {
                hostname: "gamelift.eu-west-3.amazonaws.com",
                partition: "aws",
            };
            break;
        case "me-south-1":
            regionInfo = {
                hostname: "gamelift.me-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "sa-east-1":
    ...
    return Promise.resolve(__assign({ signingService: "gamelift" }, regionInfo));
};
