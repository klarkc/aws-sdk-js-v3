 ...
 *
 */
export declare class ActivateAnomalyDetectorCommand extends $Command<ActivateAnomalyDetectorCommandInput, ActivateAnomalyDetectorCommandOutput, LookoutMetricsClientResolvedConfig> {
