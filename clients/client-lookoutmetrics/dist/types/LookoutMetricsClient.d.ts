...
export declare type ServiceInputTypes = ActivateAnomalyDetectorCommandInput | BackTestAnomalyDetectorCommandInput | CreateAlertCommandInput | CreateAnomalyDetectorCommandInput | CreateMetricSetCommandInput | DeleteAlertCommandInput | DeleteAnomalyDetectorCommandInput | DescribeAlertCommandInput | DescribeAnomalyDetectionExecutionsCommandInput | DescribeAnomalyDetectorCommandInput | DescribeMetricSetCommandInput | GetAnomalyGroupCommandInput | GetFeedbackCommandInput | GetSampleDataCommandInput | ListAlertsCommandInput | ListAnomalyDetectorsCommandInput | ListAnomalyGroupSummariesCommandInput | ListAnomalyGroupTimeSeriesCommandInput | ListMetricSetsCommandInput | ListTagsForResourceCommandInput | PutFeedbackCommandInput | TagResourceCommandInput | UntagResourceCommandInput | UpdateAnomalyDetectorCommandInput | UpdateMetricSetCommandInput;
export declare type ServiceOutputTypes = ActivateAnomalyDetectorCommandOutput | BackTestAnomalyDetectorCommandOutput | CreateAlertCommandOutput | CreateAnomalyDetectorCommandOutput | CreateMetricSetCommandOutput | DeleteAlertCommandOutput | DeleteAnomalyDetectorCommandOutput | DescribeAlertCommandOutput | DescribeAnomalyDetectionExecutionsCommandOutput | DescribeAnomalyDetectorCommandOutput | DescribeMetricSetCommandOutput | GetAnomalyGroupCommandOutput | GetFeedbackCommandOutput | GetSampleDataCommandOutput | ListAlertsCommandOutput | ListAnomalyDetectorsCommandOutput | ListAnomalyGroupSummariesCommandOutput | ListAnomalyGroupTimeSeriesCommandOutput | ListMetricSetsCommandOutput | ListTagsForResourceCommandOutput | PutFeedbackCommandOutput | TagResourceCommandOutput | UntagResourceCommandOutput | UpdateAnomalyDetectorCommandOutput | UpdateMetricSetCommandOutput;
...
declare type LookoutMetricsClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointsInputConfig & RetryInputConfig & HostHeaderInputConfig & AwsAuthInputConfig & UserAgentInputConfig;
/**
...
declare type LookoutMetricsClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RegionResolvedConfig & EndpointsResolvedConfig & RetryResolvedConfig & HostHeaderResolvedConfig & AwsAuthResolvedConfig & UserAgentResolvedConfig;
/**
 ...
 */
export declare class LookoutMetricsClient extends __Client<__HttpHandlerOptions, ServiceInputTypes, ServiceOutputTypes, LookoutMetricsClientResolvedConfig> {
    /**
