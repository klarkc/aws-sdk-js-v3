...
exports.DescribeMetricSetCommand = void 0;
 ...
 *
 */
class DescribeMetricSetCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DescribeMetricSetRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.DescribeMetricSetResponse.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1DescribeMetricSetCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1DescribeMetricSetCommand(output, context);
    }
}
exports.DescribeMetricSetCommand = DescribeMetricSetCommand;
