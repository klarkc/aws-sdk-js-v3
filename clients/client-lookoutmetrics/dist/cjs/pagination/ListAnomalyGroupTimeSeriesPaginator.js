...
exports.paginateListAnomalyGroupTimeSeries = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListAnomalyGroupTimeSeriesCommand_1.ListAnomalyGroupTimeSeriesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListAnomalyGroupTimeSeries(config, input, ...additionalArguments) {
...
exports.paginateListAnomalyGroupTimeSeries = paginateListAnomalyGroupTimeSeries;
