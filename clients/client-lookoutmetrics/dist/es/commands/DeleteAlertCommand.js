...
import { deserializeAws_restJson1DeleteAlertCommand, serializeAws_restJson1DeleteAlertCommand, } from "../protocols/Aws_restJson1";
 ...
 *
 */
var DeleteAlertCommand = /** @class */ (function (_super) {
    __extends(DeleteAlertCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DeleteAlertCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DeleteAlertCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "LookoutMetricsClient";
        var commandName = "DeleteAlertCommand";
    ...
    DeleteAlertCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1DeleteAlertCommand(input, context);
    };
    DeleteAlertCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1DeleteAlertCommand(output, context);
    };
    return DeleteAlertCommand;
}($Command));
export { DeleteAlertCommand };
