...
import { deserializeAws_restJson1ListAnomalyDetectorsCommand, serializeAws_restJson1ListAnomalyDetectorsCommand, } from "../protocols/Aws_restJson1";
 ...
 *
 */
var ListAnomalyDetectorsCommand = /** @class */ (function (_super) {
    __extends(ListAnomalyDetectorsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListAnomalyDetectorsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListAnomalyDetectorsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "LookoutMetricsClient";
        var commandName = "ListAnomalyDetectorsCommand";
    ...
    ListAnomalyDetectorsCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1ListAnomalyDetectorsCommand(input, context);
    };
    ListAnomalyDetectorsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1ListAnomalyDetectorsCommand(output, context);
    };
    return ListAnomalyDetectorsCommand;
}($Command));
export { ListAnomalyDetectorsCommand };
