...
import { deserializeAws_restJson1DescribeAnomalyDetectorCommand, serializeAws_restJson1DescribeAnomalyDetectorCommand, } from "../protocols/Aws_restJson1";
 ...
 *
 */
var DescribeAnomalyDetectorCommand = /** @class */ (function (_super) {
    __extends(DescribeAnomalyDetectorCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DescribeAnomalyDetectorCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DescribeAnomalyDetectorCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "LookoutMetricsClient";
        var commandName = "DescribeAnomalyDetectorCommand";
    ...
    DescribeAnomalyDetectorCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1DescribeAnomalyDetectorCommand(input, context);
    };
    DescribeAnomalyDetectorCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1DescribeAnomalyDetectorCommand(output, context);
    };
    return DescribeAnomalyDetectorCommand;
}($Command));
export { DescribeAnomalyDetectorCommand };
