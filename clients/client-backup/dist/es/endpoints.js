...
var AWS_TEMPLATE = "backup.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "backup.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "backup.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "backup.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "backup.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
  ...
  return Promise.resolve(__assign({ signingService: "backup" }, regionInfo));
};
