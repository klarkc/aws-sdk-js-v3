 ...
 *
 */
var StartBackupJobCommand = /** @class */ (function (_super) {
  __extends(StartBackupJobCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function StartBackupJobCommand(input) {
    var _this =
   ...
   * @internal
   */
  StartBackupJobCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "BackupClient";
    var commandName = "StartBackupJobCommand";
  ...
  StartBackupJobCommand.prototype.serialize = function (input, context) {
    return serializeAws_restJson1StartBackupJobCommand(input, context);
  };
  StartBackupJobCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_restJson1StartBackupJobCommand(output, context);
  };
  return StartBackupJobCommand;
})($Command);
export { StartBackupJobCommand };
