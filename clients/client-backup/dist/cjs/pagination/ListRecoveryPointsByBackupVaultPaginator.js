...
const makePagedClientRequest = async (client, input, ...args) => {
  ...
  return await client.send(
    new ListRecoveryPointsByBackupVaultCommand_1.ListRecoveryPointsByBackupVaultCommand(input),
    ...args
  );
};
/**
...
exports.paginateListRecoveryPointsByBackupVault = paginateListRecoveryPointsByBackupVault;
