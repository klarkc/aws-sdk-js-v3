...
const makePagedClientRequest = async (client, input, ...args) => {
  ...
  return await client.send(
    new ListRecoveryPointsByResourceCommand_1.ListRecoveryPointsByResourceCommand(input),
    ...args
  );
};
/**
...
exports.paginateListRecoveryPointsByResource = paginateListRecoveryPointsByResource;
