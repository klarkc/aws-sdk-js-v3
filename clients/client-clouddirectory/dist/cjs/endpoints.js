...
const AWS_TEMPLATE = "clouddirectory.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "clouddirectory.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "clouddirectory.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "clouddirectory.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "clouddirectory.{region}.amazonaws.com";
// Partition regions
