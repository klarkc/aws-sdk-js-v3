...
var AWS_TEMPLATE = "clouddirectory.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "clouddirectory.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "clouddirectory.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "clouddirectory.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "clouddirectory.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
  ...
  return Promise.resolve(__assign({ signingService: "clouddirectory" }, regionInfo));
};
