 ...
 *
 */
var CreateFacetCommand = /** @class */ (function (_super) {
  __extends(CreateFacetCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function CreateFacetCommand(input) {
    var _this =
   ...
   * @internal
   */
  CreateFacetCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "CloudDirectoryClient";
    var commandName = "CreateFacetCommand";
  ...
  CreateFacetCommand.prototype.serialize = function (input, context) {
    return serializeAws_restJson1CreateFacetCommand(input, context);
  };
  CreateFacetCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_restJson1CreateFacetCommand(output, context);
  };
  return CreateFacetCommand;
})($Command);
export { CreateFacetCommand };
//# sourceMappingURL=CreateFacetCommand.js.map
