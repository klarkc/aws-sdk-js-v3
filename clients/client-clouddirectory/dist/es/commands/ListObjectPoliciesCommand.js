 ...
 *
 */
var ListObjectPoliciesCommand = /** @class */ (function (_super) {
  __extends(ListObjectPoliciesCommand, _super);
  // Start section: command_properties
  // End section: command_properties
  function ListObjectPoliciesCommand(input) {
    var _this =
   ...
   * @internal
   */
  ListObjectPoliciesCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
    this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
    var stack = clientStack.concat(this.middlewareStack);
    var logger = configuration.logger;
    var clientName = "CloudDirectoryClient";
    var commandName = "ListObjectPoliciesCommand";
  ...
  ListObjectPoliciesCommand.prototype.serialize = function (input, context) {
    return serializeAws_restJson1ListObjectPoliciesCommand(input, context);
  };
  ListObjectPoliciesCommand.prototype.deserialize = function (output, context) {
    return deserializeAws_restJson1ListObjectPoliciesCommand(output, context);
  };
  return ListObjectPoliciesCommand;
})($Command);
export { ListObjectPoliciesCommand };
