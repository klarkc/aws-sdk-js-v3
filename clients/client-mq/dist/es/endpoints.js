...
var AWS_TEMPLATE = "mq.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "mq.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "mq.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "mq.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "mq.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "mq" }, regionInfo));
};
