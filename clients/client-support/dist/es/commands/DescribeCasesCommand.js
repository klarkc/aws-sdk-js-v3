 ...
 *
 */
var DescribeCasesCommand = /** @class */ (function (_super) {
    __extends(DescribeCasesCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DescribeCasesCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DescribeCasesCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SupportClient";
        var commandName = "DescribeCasesCommand";
    ...
    DescribeCasesCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DescribeCasesCommand(input, context);
    };
    DescribeCasesCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DescribeCasesCommand(output, context);
    };
    return DescribeCasesCommand;
}($Command));
export { DescribeCasesCommand };
