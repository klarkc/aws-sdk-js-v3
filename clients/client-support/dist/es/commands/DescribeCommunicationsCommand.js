 ...
 *
 */
var DescribeCommunicationsCommand = /** @class */ (function (_super) {
    __extends(DescribeCommunicationsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DescribeCommunicationsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DescribeCommunicationsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SupportClient";
        var commandName = "DescribeCommunicationsCommand";
    ...
    DescribeCommunicationsCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DescribeCommunicationsCommand(input, context);
    };
    DescribeCommunicationsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DescribeCommunicationsCommand(output, context);
    };
    return DescribeCommunicationsCommand;
}($Command));
export { DescribeCommunicationsCommand };
