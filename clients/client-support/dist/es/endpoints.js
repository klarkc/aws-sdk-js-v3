...
var AWS_TEMPLATE = "support.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "support.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "support.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "support.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "support.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "support" }, regionInfo));
};
