...
const AWS_TEMPLATE = "support.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "support.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "support.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "support.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "support.{region}.amazonaws.com";
// Partition regions
