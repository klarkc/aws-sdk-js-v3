 ...
 *
 */
var UpdateAnomalySubscriptionCommand = /** @class */ (function (_super) {
    __extends(UpdateAnomalySubscriptionCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function UpdateAnomalySubscriptionCommand(input) {
        var _this = 
     ...
     * @internal
     */
    UpdateAnomalySubscriptionCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "CostExplorerClient";
        var commandName = "UpdateAnomalySubscriptionCommand";
    ...
    UpdateAnomalySubscriptionCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1UpdateAnomalySubscriptionCommand(input, context);
    };
    UpdateAnomalySubscriptionCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1UpdateAnomalySubscriptionCommand(output, context);
    };
    return UpdateAnomalySubscriptionCommand;
}($Command));
export { UpdateAnomalySubscriptionCommand };
