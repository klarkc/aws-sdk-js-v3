...
var ListUpdatesCommand = /** @class */ (function (_super) {
    ...
    ListUpdatesCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        ...
        var commandName = "ListUpdatesCommand";
    ...
    ListUpdatesCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1ListUpdatesCommand(input, context);
    };
    ListUpdatesCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1ListUpdatesCommand(output, context);
    };
    return ListUpdatesCommand;
}($Command));
export { ListUpdatesCommand };
//# sourceMappingURL=ListUpdatesCommand.js.map