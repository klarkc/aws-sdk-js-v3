...
var AWS_TEMPLATE = "xray.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "xray.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "xray.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "xray.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "xray.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "ap-northeast-3":
            regionInfo = {
                hostname: "xray.ap-northeast-3.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-south-1":
        ...
        case "cn-northwest-1":
            regionInfo = {
                hostname: "xray.cn-northwest-1.amazonaws.com.cn",
                partition: "aws-cn",
            };
            break;
        case "eu-central-1":
        ...
        case "eu-south-1":
            regionInfo = {
                hostname: "xray.eu-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-west-1":
    ...
    return Promise.resolve(__assign({ signingService: "xray" }, regionInfo));
};
