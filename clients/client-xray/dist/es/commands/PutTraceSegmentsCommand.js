 ...
 *
 */
var PutTraceSegmentsCommand = /** @class */ (function (_super) {
    __extends(PutTraceSegmentsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function PutTraceSegmentsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    PutTraceSegmentsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "XRayClient";
        var commandName = "PutTraceSegmentsCommand";
    ...
    PutTraceSegmentsCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1PutTraceSegmentsCommand(input, context);
    };
    PutTraceSegmentsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1PutTraceSegmentsCommand(output, context);
    };
    return PutTraceSegmentsCommand;
}($Command));
export { PutTraceSegmentsCommand };
