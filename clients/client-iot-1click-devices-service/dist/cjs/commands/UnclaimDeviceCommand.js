...
exports.UnclaimDeviceCommand = void 0;
 ...
 *
 */
class UnclaimDeviceCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.UnclaimDeviceRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.UnclaimDeviceResponse.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1UnclaimDeviceCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1UnclaimDeviceCommand(output, context);
    }
}
exports.UnclaimDeviceCommand = UnclaimDeviceCommand;
