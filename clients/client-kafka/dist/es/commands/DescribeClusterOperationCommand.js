 ...
 *
 */
var DescribeClusterOperationCommand = /** @class */ (function (_super) {
     ...
     * @internal
     */
    DescribeClusterOperationCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "KafkaClient";
        var commandName = "DescribeClusterOperationCommand";
    ...
    DescribeClusterOperationCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1DescribeClusterOperationCommand(input, context);
    };
    DescribeClusterOperationCommand.prototype.deserialize = function (output, context) {
