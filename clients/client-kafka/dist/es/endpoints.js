...
var AWS_TEMPLATE = "kafka.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "kafka.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "kafka.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "kafka.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "kafka.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "cn-northwest-1":
            regionInfo = {
                hostname: "kafka.cn-northwest-1.amazonaws.com.cn",
                partition: "aws-cn",
            };
            break;
        case "eu-central-1":
        ...
        case "eu-south-1":
            regionInfo = {
                hostname: "kafka.eu-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-west-1":
        ...
        case "me-south-1":
            regionInfo = {
                hostname: "kafka.me-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "sa-east-1":
    ...
    return Promise.resolve(__assign({ signingService: "kafka" }, regionInfo));
};
