...
exports.StartAttachmentUploadCommand = void 0;
...
class StartAttachmentUploadCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.StartAttachmentUploadRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.StartAttachmentUploadResponse.filterSensitiveLog,
        };
