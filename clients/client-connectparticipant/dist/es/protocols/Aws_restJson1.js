    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                resolvedPath = "/participant/complete-attachment-upload";
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                resolvedPath = "/participant/connection";
                body = JSON.stringify(__assign({}, (input.Type !== undefined &&
...
export var serializeAws_restJson1DisconnectParticipantCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                headers = __assign({ "content-type": "application/json" }, (isSerializableHeaderValue(input.ConnectionToken) && { "x-amz-bearer": input.ConnectionToken }));
                resolvedPath = "/participant/disconnect";
                body = JSON.stringify({
                    ClientToken: (_c = input.ClientToken) !== null && _c !== void 0 ? _c : generateIdempotencyToken(),
                });
                return [4 /*yield*/, context.endpoint()];
...
export var serializeAws_restJson1GetAttachmentCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                headers = __assign({ "content-type": "application/json" }, (isSerializableHeaderValue(input.ConnectionToken) && { "x-amz-bearer": input.ConnectionToken }));
                resolvedPath = "/participant/attachment";
...
export var serializeAws_restJson1GetTranscriptCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                headers = __assign({ "content-type": "application/json" }, (isSerializableHeaderValue(input.ConnectionToken) && { "x-amz-bearer": input.ConnectionToken }));
                resolvedPath = "/participant/transcript";
...
export var serializeAws_restJson1SendEventCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                headers = __assign({ "content-type": "application/json" }, (isSerializableHeaderValue(input.ConnectionToken) && { "x-amz-bearer": input.ConnectionToken }));
                resolvedPath = "/participant/event";
...
export var serializeAws_restJson1SendMessageCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                headers = __assign({ "content-type": "application/json" }, (isSerializableHeaderValue(input.ConnectionToken) && { "x-amz-bearer": input.ConnectionToken }));
                resolvedPath = "/participant/message";
                body = JSON.stringify(__assign(__assign({ ClientToken: (_c = input.ClientToken) !== null && _c !== void 0 ? _c : generateIdempotencyToken() }, (input.Content !== undefined && input.Content !== null && { Content: input.Content })), (input.ContentType !== undefined && input.ContentType !== null && { ContentType: input.ContentType })));
                return [4 /*yield*/, context.endpoint()];
            case 1:
                _a = _d.sent(), hostname = _a.hostname, _b = _a.protocol, protocol = _b === void 0 ? "https" : _b, port = _a.port;
...
export var serializeAws_restJson1StartAttachmentUploadCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                headers = __assign({ "content-type": "application/json" }, (isSerializableHeaderValue(input.ConnectionToken) && { "x-amz-bearer": input.ConnectionToken }));
                resolvedPath = "/participant/start-attachment-upload";
        ...
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1CompleteAttachmentUploadCommandError(output, context)];
                }
                contents = {
        ...
        switch (_k.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "com.amazonaws.connectparticipant#AccessDeniedException": return [3 /*break*/, 2];
                    case "ConflictException": return [3 /*break*/, 4];
                    case "com.amazonaws.connectparticipant#ConflictException": return [3 /*break*/, 4];
                    case "InternalServerException": return [3 /*break*/, 6];
                    case "com.amazonaws.connectparticipant#InternalServerException": return [3 /*break*/, 6];
                    case "ServiceQuotaExceededException": return [3 /*break*/, 8];
                    case "com.amazonaws.connectparticipant#ServiceQuotaExceededException": return [3 /*break*/, 8];
                    case "ThrottlingException": return [3 /*break*/, 10];
                    case "com.amazonaws.connectparticipant#ThrottlingException": return [3 /*break*/, 10];
                    case "ValidationException": return [3 /*break*/, 12];
                    case "com.amazonaws.connectparticipant#ValidationException": return [3 /*break*/, 12];
                }
                return [3 /*break*/, 14];
            case 2:
                _c = [{}];
...
export var deserializeAws_restJson1CreateParticipantConnectionCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1CreateParticipantConnectionCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
        ...
        switch (_h.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "com.amazonaws.connectparticipant#InternalServerException": return [3 /*break*/, 4];
                    case "ThrottlingException": return [3 /*break*/, 6];
                    case "com.amazonaws.connectparticipant#ThrottlingException": return [3 /*break*/, 6];
                    case "ValidationException": return [3 /*break*/, 8];
                    case "com.amazonaws.connectparticipant#ValidationException": return [3 /*break*/, 8];
                }
                return [3 /*break*/, 10];
            case 2:
                _c = [{}];
...
export var deserializeAws_restJson1DisconnectParticipantCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1DisconnectParticipantCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                };
...
export var deserializeAws_restJson1GetAttachmentCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1GetAttachmentCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    Url: undefined,
...
export var deserializeAws_restJson1GetTranscriptCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1GetTranscriptCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
...
export var deserializeAws_restJson1SendEventCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1SendEventCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
...
export var deserializeAws_restJson1SendMessageCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1SendMessageCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    AbsoluteTime: undefined,
...
export var deserializeAws_restJson1StartAttachmentUploadCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1StartAttachmentUploadCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
        ...
        switch (_j.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "com.amazonaws.connectparticipant#ServiceQuotaExceededException": return [3 /*break*/, 6];
                    case "ThrottlingException": return [3 /*break*/, 8];
                    case "com.amazonaws.connectparticipant#ThrottlingException": return [3 /*break*/, 8];
                    case "ValidationException": return [3 /*break*/, 10];
                    case "com.amazonaws.connectparticipant#ValidationException": return [3 /*break*/, 10];
                }
                return [3 /*break*/, 12];
            case 2:
                _c = [{}];
