 ...
 */
var PersonalizeClient = /** @class */ (function (_super) {
    __extends(PersonalizeClient, _super);
    function PersonalizeClient(configuration) {
        var _this = this;
     ...
     */
    PersonalizeClient.prototype.destroy = function () {
        _super.prototype.destroy.call(this);
    };
    return PersonalizeClient;
}(__Client));
export { PersonalizeClient };
