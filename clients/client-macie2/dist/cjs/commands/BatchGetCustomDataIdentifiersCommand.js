...
exports.BatchGetCustomDataIdentifiersCommand = void 0;
...
class BatchGetCustomDataIdentifiersCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.BatchGetCustomDataIdentifiersRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.BatchGetCustomDataIdentifiersResponse.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1BatchGetCustomDataIdentifiersCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1BatchGetCustomDataIdentifiersCommand(output, context);
    }
}
