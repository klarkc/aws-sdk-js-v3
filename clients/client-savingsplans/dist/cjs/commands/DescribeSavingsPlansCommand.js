...
exports.DescribeSavingsPlansCommand = void 0;
...
class DescribeSavingsPlansCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DescribeSavingsPlansRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.DescribeSavingsPlansResponse.filterSensitiveLog,
        };
