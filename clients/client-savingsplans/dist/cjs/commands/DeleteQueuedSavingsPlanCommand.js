...
exports.DeleteQueuedSavingsPlanCommand = void 0;
...
class DeleteQueuedSavingsPlanCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DeleteQueuedSavingsPlanRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.DeleteQueuedSavingsPlanResponse.filterSensitiveLog,
        };
