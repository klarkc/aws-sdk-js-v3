    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                body = JSON.stringify(__assign(__assign(__assign(__assign(__assign({}, (input.applicationDescription !== undefined &&
                    input.applicationDescription !== null && { applicationDescription: input.applicationDescription })), (input.applicationName !== undefined &&
                    input.applicationName !== null && { applicationName: input.applicationName })), { clientToken: (_c = input.clientToken) !== null && _c !== void 0 ? _c : generateIdempotencyToken() }), (input.roleArn !== undefined && input.roleArn !== null && { roleArn: input.roleArn })), (input.tags !== undefined && input.tags !== null && { tags: serializeAws_restJson1TagMap(input.tags, context) })));
...
export var serializeAws_restJson1DescribeApplicationCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                body = JSON.stringify(__assign(__assign(__assign({}, (input.applicationDescription !== undefined &&
                    input.applicationDescription !== null && { applicationDescription: input.applicationDescription })), (input.applicationName !== undefined &&
                    input.applicationName !== null && { applicationName: input.applicationName })), { clientToken: (_c = input.clientToken) !== null && _c !== void 0 ? _c : generateIdempotencyToken() }));
                return [4 /*yield*/, context.endpoint()];
            case 1:
                _a = _d.sent(), hostname = _a.hostname, _b = _a.protocol, protocol = _b === void 0 ? "https" : _b, port = _a.port;
                return [2 /*return*/, new __HttpRequest({
        ...
        switch (_h.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "com.amazonaws.iotfleethub#InternalFailureException": return [3 /*break*/, 2];
                    case "InvalidRequestException": return [3 /*break*/, 4];
                    case "com.amazonaws.iotfleethub#InvalidRequestException": return [3 /*break*/, 4];
                    case "LimitExceededException": return [3 /*break*/, 6];
                    case "com.amazonaws.iotfleethub#LimitExceededException": return [3 /*break*/, 6];
                    case "ThrottlingException": return [3 /*break*/, 8];
                    case "com.amazonaws.iotfleethub#ThrottlingException": return [3 /*break*/, 8];
                }
                return [3 /*break*/, 10];
            case 2:
                _c = [{}];
        ...
        switch (_h.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "com.amazonaws.iotfleethub#ResourceNotFoundException": return [3 /*break*/, 6];
                    case "ThrottlingException": return [3 /*break*/, 8];
                    case "com.amazonaws.iotfleethub#ThrottlingException": return [3 /*break*/, 8];
                }
                return [3 /*break*/, 10];
...
export var deserializeAws_restJson1DescribeApplicationCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1DescribeApplicationCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    applicationArn: undefined,
...
var deserializeAws_restJson1DescribeApplicationCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, _c, _d, _e, _f, parsedBody, message;
    var _g;
    return __generator(this, function (_h) {
        switch (_h.label) {
        ...
        switch (_g.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "com.amazonaws.iotfleethub#ThrottlingException": return [3 /*break*/, 6];
                }
                return [3 /*break*/, 8];
            case 2:
                _c = [{}];
        ...
        switch (_j.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "com.amazonaws.iotfleethub#ConflictException": return [3 /*break*/, 2];
                    case "InternalFailureException": return [3 /*break*/, 4];
                    case "com.amazonaws.iotfleethub#InternalFailureException": return [3 /*break*/, 4];
                    case "InvalidRequestException": return [3 /*break*/, 6];
                    case "com.amazonaws.iotfleethub#InvalidRequestException": return [3 /*break*/, 6];
                    case "ResourceNotFoundException": return [3 /*break*/, 8];
                    case "com.amazonaws.iotfleethub#ResourceNotFoundException": return [3 /*break*/, 8];
                    case "ThrottlingException": return [3 /*break*/, 10];
                    case "com.amazonaws.iotfleethub#ThrottlingException": return [3 /*break*/, 10];
                }
                return [3 /*break*/, 12];
            case 2:
                _c = [{}];
...
var deserializeAws_restJson1ApplicationSummary = function (output, context) {
    return {
        applicationCreationDate: output.applicationCreationDate !== undefined && output.applicationCreationDate !== null
        ...
        applicationLastUpdateDate: output.applicationLastUpdateDate !== undefined && output.applicationLastUpdateDate !== null
        ...
        applicationState: output.applicationState !== undefined && output.applicationState !== null ? output.applicationState : undefined,
        applicationUrl: output.applicationUrl !== undefined && output.applicationUrl !== null ? output.applicationUrl : undefined,
    };
};
