...
var AWS_TEMPLATE = "monitoring.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "monitoring.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "monitoring.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "monitoring.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "monitoring.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "ap-northeast-3":
            regionInfo = {
                hostname: "monitoring.ap-northeast-3.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-south-1":
        ...
        case "eu-south-1":
            regionInfo = {
                hostname: "monitoring.eu-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-west-1":
    ...
    return Promise.resolve(__assign({ signingService: "monitoring" }, regionInfo));
};
