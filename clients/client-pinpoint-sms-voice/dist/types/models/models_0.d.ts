...
export declare namespace CallInstructionsMessageType {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: CallInstructionsMessageType) => any;
}
/**
...
export declare namespace PlainTextMessageType {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: PlainTextMessageType) => any;
}
/**
...
export declare namespace SSMLMessageType {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: SSMLMessageType) => any;
}
/**
...
export declare namespace VoiceMessageContent {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: VoiceMessageContent) => any;
}
/**
...
export declare namespace SendVoiceMessageResponse {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: SendVoiceMessageResponse) => any;
}
/**
