 ...
 *
 */
var UpdateLicenseSpecificationsForResourceCommand = /** @class */ (function (_super) {
    __extends(UpdateLicenseSpecificationsForResourceCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function UpdateLicenseSpecificationsForResourceCommand(input) {
        var _this = 
     ...
     * @internal
     */
    UpdateLicenseSpecificationsForResourceCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "LicenseManagerClient";
        var commandName = "UpdateLicenseSpecificationsForResourceCommand";
    ...
    UpdateLicenseSpecificationsForResourceCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1UpdateLicenseSpecificationsForResourceCommand(input, context);
    };
    UpdateLicenseSpecificationsForResourceCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1UpdateLicenseSpecificationsForResourceCommand(output, context);
    };
    return UpdateLicenseSpecificationsForResourceCommand;
}($Command));
export { UpdateLicenseSpecificationsForResourceCommand };
