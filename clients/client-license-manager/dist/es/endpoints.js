...
var AWS_TEMPLATE = "license-manager.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "license-manager.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "license-manager.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "license-manager.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "license-manager.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "license-manager" }, regionInfo));
};
