...
var AWS_TEMPLATE = "appstream2.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "appstream2.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "appstream2.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "appstream2.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "appstream2.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
  ...
  return Promise.resolve(__assign({ signingService: "appstream" }, regionInfo));
};
