...
class UpdateInferenceSchedulerCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.UpdateInferenceSchedulerRequest.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_json1_0_1.serializeAws_json1_0UpdateInferenceSchedulerCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_json1_0_1.deserializeAws_json1_0UpdateInferenceSchedulerCommand(output, context);
    }
}
