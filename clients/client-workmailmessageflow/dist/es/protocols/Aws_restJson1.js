...
export var serializeAws_restJson1GetRawMessageContentCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                headers = {};
                resolvedPath = "/messages/{messageId}";
...
export var deserializeAws_restJson1GetRawMessageContentCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data;
    return __generator(this, function (_a) {
        if (output.statusCode !== 200 && output.statusCode >= 300) {
            return [2 /*return*/, deserializeAws_restJson1GetRawMessageContentCommandError(output, context)];
        }
        contents = {
        ...
        switch (_e.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "com.amazonaws.workmailmessageflow#ResourceNotFoundException": return [3 /*break*/, 2];
                }
                return [3 /*break*/, 4];
            case 2:
                _c = [{}];
...
export var deserializeAws_restJson1PutRawMessageContentCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_restJson1PutRawMessageContentCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                };
    ...
    return __generator(this, function (_h) {
        switch (_h.label) {
            ...
            case 1:
                ...
                _b = errorCode;
                switch (_b) {
                    case "InvalidContentLocation": return [3 /*break*/, 2];
                    case "com.amazonaws.workmailmessageflow#InvalidContentLocation": return [3 /*break*/, 2];
                    case "MessageFrozen": return [3 /*break*/, 4];
                    case "com.amazonaws.workmailmessageflow#MessageFrozen": return [3 /*break*/, 4];
                    case "MessageRejected": return [3 /*break*/, 6];
                    case "com.amazonaws.workmailmessageflow#MessageRejected": return [3 /*break*/, 6];
                    case "ResourceNotFoundException": return [3 /*break*/, 8];
                    case "com.amazonaws.workmailmessageflow#ResourceNotFoundException": return [3 /*break*/, 8];
                }
                return [3 /*break*/, 10];
            case 2:
                _c = [{}];
                return [4 /*yield*/, deserializeAws_restJson1InvalidContentLocationResponse(parsedOutput, context)];
            case 3:
                response = __assign.apply(void 0, [__assign.apply(void 0, _c.concat([(_h.sent())])), { name: errorCode, $metadata: deserializeMetadata(output) }]);
                return [3 /*break*/, 11];
            case 4:
                _d = [{}];
                return [4 /*yield*/, deserializeAws_restJson1MessageFrozenResponse(parsedOutput, context)];
            case 5:
