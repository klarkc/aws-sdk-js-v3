...
var AWS_TEMPLATE = "iotevents.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "iotevents.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "iotevents.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "iotevents.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "iotevents.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "iotevents" }, regionInfo));
};
