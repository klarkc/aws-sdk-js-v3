...
const AWS_TEMPLATE = "iotevents.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "iotevents.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "iotevents.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "iotevents.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "iotevents.{region}.amazonaws.com";
// Partition regions
