 ...
 */
var DataBrewClient = /** @class */ (function (_super) {
    __extends(DataBrewClient, _super);
    function DataBrewClient(configuration) {
        var _this = this;
    ...
    return DataBrewClient;
}(__Client));
export { DataBrewClient };
//# sourceMappingURL=DataBrewClient.js.map