...
exports.paginateListScheduledAudits = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListScheduledAuditsCommand_1.ListScheduledAuditsCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListScheduledAudits(config, input, ...additionalArguments) {
