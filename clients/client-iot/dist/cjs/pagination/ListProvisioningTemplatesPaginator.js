...
exports.paginateListProvisioningTemplates = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    // @ts-ignore
    return await client.send(new ListProvisioningTemplatesCommand_1.ListProvisioningTemplatesCommand(input), ...args);
};
/**
 * @private
 */
...
async function* paginateListProvisioningTemplates(config, input, ...additionalArguments) {
