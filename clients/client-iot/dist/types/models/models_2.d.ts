import { AbortConfig, AlertTarget, AttributePayload, AuditCheckConfiguration, AuditFrequency, AuditMitigationActionsTaskTarget, AuditNotificationTarget, AuthInfo, AuthResult, AuthorizerConfig, AuthorizerStatus, AutoRegistrationStatus, Behavior, BillingGroupProperties, CustomMetricType, DayOfWeek, DimensionType, JobExecutionsRolloutConfig, LogLevel, MetricToRetain, MitigationActionParams, PresignedUrlConfig, ProvisioningHook, ResourceIdentifier, StreamFile, Tag, ThingGroupProperties, TimeoutConfig, TopicRuleDestinationStatus, TopicRulePayload } from "./models_0";
import { CACertificateStatus, CertificateStatus, Configuration, DetectMitigationActionsTaskTarget, DomainConfigurationStatus, LogTarget, RegistrationConfig, ThingGroupIndexingConfiguration, ThingIndexingConfiguration, ViolationEventOccurrenceRange } from "./models_1";
...
export declare namespace RegistrationCodeValidationException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: RegistrationCodeValidationException) => any;
}
/**
...
export declare namespace CertificateConflictException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: CertificateConflictException) => any;
}
/**
...
export declare namespace ResourceRegistrationFailureException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: ResourceRegistrationFailureException) => any;
}
/**
...
export declare namespace TaskAlreadyExistsException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: TaskAlreadyExistsException) => any;
}
...
export declare namespace InvalidResponseException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: InvalidResponseException) => any;
}
/**
...
export declare namespace TransferConflictException {
    /**
     * @internal
     */
    const filterSensitiveLog: (obj: TransferConflictException) => any;
}
