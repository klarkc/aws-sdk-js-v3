...
import { deserializeAws_restJson1ListDomainConfigurationsCommand, serializeAws_restJson1ListDomainConfigurationsCommand, } from "../protocols/Aws_restJson1";
 ...
 *
 */
var ListDomainConfigurationsCommand = /** @class */ (function (_super) {
    __extends(ListDomainConfigurationsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListDomainConfigurationsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListDomainConfigurationsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "IoTClient";
        var commandName = "ListDomainConfigurationsCommand";
    ...
    ListDomainConfigurationsCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1ListDomainConfigurationsCommand(input, context);
    };
    ListDomainConfigurationsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1ListDomainConfigurationsCommand(output, context);
    };
    return ListDomainConfigurationsCommand;
}($Command));
export { ListDomainConfigurationsCommand };
