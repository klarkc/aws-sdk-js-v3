...
import { deserializeAws_restJson1AcceptCertificateTransferCommand, serializeAws_restJson1AcceptCertificateTransferCommand, } from "../protocols/Aws_restJson1";
 ...
 *
 */
var AcceptCertificateTransferCommand = /** @class */ (function (_super) {
    __extends(AcceptCertificateTransferCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function AcceptCertificateTransferCommand(input) {
        var _this = 
     ...
     * @internal
     */
    AcceptCertificateTransferCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "IoTClient";
        var commandName = "AcceptCertificateTransferCommand";
    ...
    AcceptCertificateTransferCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1AcceptCertificateTransferCommand(input, context);
    };
    AcceptCertificateTransferCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1AcceptCertificateTransferCommand(output, context);
    };
    return AcceptCertificateTransferCommand;
}($Command));
export { AcceptCertificateTransferCommand };
//# sourceMappingURL=AcceptCertificateTransferCommand.js.map