 ...
 *
 */
var ListOTAUpdatesCommand = /** @class */ (function (_super) {
    __extends(ListOTAUpdatesCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListOTAUpdatesCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListOTAUpdatesCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "IoTClient";
        var commandName = "ListOTAUpdatesCommand";
    ...
    ListOTAUpdatesCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1ListOTAUpdatesCommand(input, context);
    };
    ListOTAUpdatesCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1ListOTAUpdatesCommand(output, context);
    };
    return ListOTAUpdatesCommand;
}($Command));
export { ListOTAUpdatesCommand };
