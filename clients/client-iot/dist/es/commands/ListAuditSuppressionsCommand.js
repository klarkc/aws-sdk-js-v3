 ...
 *
 */
var ListAuditSuppressionsCommand = /** @class */ (function (_super) {
    __extends(ListAuditSuppressionsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListAuditSuppressionsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListAuditSuppressionsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "IoTClient";
        var commandName = "ListAuditSuppressionsCommand";
    ...
    ListAuditSuppressionsCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1ListAuditSuppressionsCommand(input, context);
    };
    ListAuditSuppressionsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1ListAuditSuppressionsCommand(output, context);
    };
    return ListAuditSuppressionsCommand;
}($Command));
export { ListAuditSuppressionsCommand };
//# sourceMappingURL=ListAuditSuppressionsCommand.js.map