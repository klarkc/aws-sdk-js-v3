 ...
 *
 */
var DescribeJobTemplateCommand = /** @class */ (function (_super) {
    __extends(DescribeJobTemplateCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DescribeJobTemplateCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DescribeJobTemplateCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "IoTClient";
        var commandName = "DescribeJobTemplateCommand";
    ...
    DescribeJobTemplateCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1DescribeJobTemplateCommand(input, context);
    };
    DescribeJobTemplateCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1DescribeJobTemplateCommand(output, context);
    };
    return DescribeJobTemplateCommand;
}($Command));
export { DescribeJobTemplateCommand };
