...
import { deserializeAws_restJson1GetCardinalityCommand, serializeAws_restJson1GetCardinalityCommand, } from "../protocols/Aws_restJson1";
 ...
 *
 */
var GetCardinalityCommand = /** @class */ (function (_super) {
    __extends(GetCardinalityCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function GetCardinalityCommand(input) {
        var _this = 
     ...
     * @internal
     */
    GetCardinalityCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "IoTClient";
        var commandName = "GetCardinalityCommand";
    ...
    GetCardinalityCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1GetCardinalityCommand(input, context);
    };
    GetCardinalityCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1GetCardinalityCommand(output, context);
    };
    return GetCardinalityCommand;
}($Command));
export { GetCardinalityCommand };
