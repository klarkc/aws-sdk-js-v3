...
const AWS_TEMPLATE = "transfer.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "transfer.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "transfer.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "transfer.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "transfer.{region}.amazonaws.com";
// Partition regions
