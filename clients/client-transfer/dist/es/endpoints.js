...
var AWS_TEMPLATE = "transfer.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "transfer.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "transfer.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "transfer.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "transfer.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "ap-east-1":
            regionInfo = {
                hostname: "transfer.ap-east-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-northeast-1":
        ...
        case "eu-south-1":
            regionInfo = {
                hostname: "transfer.eu-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-west-1":
        ...
        case "me-south-1":
            regionInfo = {
                hostname: "transfer.me-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "sa-east-1":
    ...
    return Promise.resolve(__assign({ signingService: "transfer" }, regionInfo));
};
