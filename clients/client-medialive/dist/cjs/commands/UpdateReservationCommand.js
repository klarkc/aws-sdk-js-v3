...
class UpdateReservationCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.UpdateReservationRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_1_1.UpdateReservationResponse.filterSensitiveLog,
        };
