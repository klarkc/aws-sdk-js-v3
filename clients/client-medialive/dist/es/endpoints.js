...
var AWS_TEMPLATE = "medialive.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "medialive.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "medialive.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "medialive.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "medialive.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "medialive" }, regionInfo));
};
