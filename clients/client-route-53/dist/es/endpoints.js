...
var AWS_TEMPLATE = "route53.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "route53.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "route53.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "route53.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "route53.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "route53" }, regionInfo));
};
