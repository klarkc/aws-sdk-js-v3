...
var AWS_TEMPLATE = "rds.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "rds.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "rds.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "rds.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "rds.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "ap-northeast-3":
            regionInfo = {
                hostname: "rds.ap-northeast-3.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-south-1":
        ...
        case "eu-south-1":
            regionInfo = {
                hostname: "rds.eu-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-west-1":
    ...
    return Promise.resolve(__assign({ signingService: "rds" }, regionInfo));
};
