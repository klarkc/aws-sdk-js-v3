 ...
 *
 */
var AssociateServiceQuotaTemplateCommand = /** @class */ (function (_super) {
    __extends(AssociateServiceQuotaTemplateCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function AssociateServiceQuotaTemplateCommand(input) {
        var _this = 
     ...
     * @internal
     */
    AssociateServiceQuotaTemplateCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "ServiceQuotasClient";
        var commandName = "AssociateServiceQuotaTemplateCommand";
    ...
    AssociateServiceQuotaTemplateCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1AssociateServiceQuotaTemplateCommand(input, context);
    };
    AssociateServiceQuotaTemplateCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1AssociateServiceQuotaTemplateCommand(output, context);
    };
    return AssociateServiceQuotaTemplateCommand;
}($Command));
export { AssociateServiceQuotaTemplateCommand };
