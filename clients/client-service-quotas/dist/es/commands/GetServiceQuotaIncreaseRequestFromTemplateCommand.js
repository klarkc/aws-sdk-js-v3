 ...
 *
 */
var GetServiceQuotaIncreaseRequestFromTemplateCommand = /** @class */ (function (_super) {
    __extends(GetServiceQuotaIncreaseRequestFromTemplateCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function GetServiceQuotaIncreaseRequestFromTemplateCommand(input) {
        var _this = 
     ...
     * @internal
     */
    GetServiceQuotaIncreaseRequestFromTemplateCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "ServiceQuotasClient";
        var commandName = "GetServiceQuotaIncreaseRequestFromTemplateCommand";
    ...
    GetServiceQuotaIncreaseRequestFromTemplateCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1GetServiceQuotaIncreaseRequestFromTemplateCommand(input, context);
    };
    GetServiceQuotaIncreaseRequestFromTemplateCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1GetServiceQuotaIncreaseRequestFromTemplateCommand(output, context);
    };
    return GetServiceQuotaIncreaseRequestFromTemplateCommand;
}($Command));
export { GetServiceQuotaIncreaseRequestFromTemplateCommand };
