 ...
 *
 */
var GetRequestedServiceQuotaChangeCommand = /** @class */ (function (_super) {
    __extends(GetRequestedServiceQuotaChangeCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function GetRequestedServiceQuotaChangeCommand(input) {
        var _this = 
     ...
     * @internal
     */
    GetRequestedServiceQuotaChangeCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "ServiceQuotasClient";
        var commandName = "GetRequestedServiceQuotaChangeCommand";
    ...
    GetRequestedServiceQuotaChangeCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1GetRequestedServiceQuotaChangeCommand(input, context);
    };
    GetRequestedServiceQuotaChangeCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1GetRequestedServiceQuotaChangeCommand(output, context);
    };
    return GetRequestedServiceQuotaChangeCommand;
}($Command));
export { GetRequestedServiceQuotaChangeCommand };
