...
const AWS_TEMPLATE = "servicequotas.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "servicequotas.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "servicequotas.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "servicequotas.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "servicequotas.{region}.amazonaws.com";
// Partition regions
