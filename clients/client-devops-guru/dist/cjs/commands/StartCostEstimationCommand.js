...
exports.StartCostEstimationCommand = void 0;
...
class StartCostEstimationCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.StartCostEstimationRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.StartCostEstimationResponse.filterSensitiveLog,
        };
