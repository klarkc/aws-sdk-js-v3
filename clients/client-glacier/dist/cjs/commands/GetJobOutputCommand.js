...
exports.GetJobOutputCommand = void 0;
...
class GetJobOutputCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.GetJobOutputInput.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.GetJobOutputOutput.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_restJson1_1.serializeAws_restJson1GetJobOutputCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_restJson1_1.deserializeAws_restJson1GetJobOutputCommand(output, context);
    }
}
exports.GetJobOutputCommand = GetJobOutputCommand;
//# sourceMappingURL=GetJobOutputCommand.js.map