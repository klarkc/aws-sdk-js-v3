...
var AWS_TEMPLATE = "glacier.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "glacier.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "glacier.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "glacier.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "glacier.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "ap-northeast-3":
            regionInfo = {
                hostname: "glacier.ap-northeast-3.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-south-1":
        ...
        case "eu-south-1":
            regionInfo = {
                hostname: "glacier.eu-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-west-1":
    ...
    return Promise.resolve(__assign({ signingService: "glacier" }, regionInfo));
};
