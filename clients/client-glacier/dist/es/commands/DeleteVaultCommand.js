 ...
 *
 */
var DeleteVaultCommand = /** @class */ (function (_super) {
    __extends(DeleteVaultCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DeleteVaultCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DeleteVaultCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "GlacierClient";
        var commandName = "DeleteVaultCommand";
    ...
    DeleteVaultCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1DeleteVaultCommand(input, context);
    };
    DeleteVaultCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1DeleteVaultCommand(output, context);
    };
    return DeleteVaultCommand;
}($Command));
export { DeleteVaultCommand };
//# sourceMappingURL=DeleteVaultCommand.js.map