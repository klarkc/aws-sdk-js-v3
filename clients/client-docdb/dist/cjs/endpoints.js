...
const AWS_TEMPLATE = "rds.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "rds.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "rds.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "rds.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "rds.{region}.amazonaws.com";
// Partition regions
