 ...
 *
 */
var DeleteInlinePolicyFromPermissionSetCommand = /** @class */ (function (_super) {
    __extends(DeleteInlinePolicyFromPermissionSetCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DeleteInlinePolicyFromPermissionSetCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DeleteInlinePolicyFromPermissionSetCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "SSOAdminClient";
        var commandName = "DeleteInlinePolicyFromPermissionSetCommand";
    ...
    DeleteInlinePolicyFromPermissionSetCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DeleteInlinePolicyFromPermissionSetCommand(input, context);
    };
    DeleteInlinePolicyFromPermissionSetCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DeleteInlinePolicyFromPermissionSetCommand(output, context);
    };
    return DeleteInlinePolicyFromPermissionSetCommand;
}($Command));
export { DeleteInlinePolicyFromPermissionSetCommand };
