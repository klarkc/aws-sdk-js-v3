 ...
 *
 */
var ListSubscriptionDefinitionsCommand = /** @class */ (function (_super) {
    __extends(ListSubscriptionDefinitionsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListSubscriptionDefinitionsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListSubscriptionDefinitionsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "GreengrassClient";
        var commandName = "ListSubscriptionDefinitionsCommand";
    ...
    ListSubscriptionDefinitionsCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1ListSubscriptionDefinitionsCommand(input, context);
    };
    ListSubscriptionDefinitionsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1ListSubscriptionDefinitionsCommand(output, context);
    };
    return ListSubscriptionDefinitionsCommand;
}($Command));
export { ListSubscriptionDefinitionsCommand };
