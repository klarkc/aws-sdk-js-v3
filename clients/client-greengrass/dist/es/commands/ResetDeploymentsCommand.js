 ...
 *
 */
var ResetDeploymentsCommand = /** @class */ (function (_super) {
    __extends(ResetDeploymentsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ResetDeploymentsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ResetDeploymentsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "GreengrassClient";
        var commandName = "ResetDeploymentsCommand";
    ...
    ResetDeploymentsCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1ResetDeploymentsCommand(input, context);
    };
    ResetDeploymentsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1ResetDeploymentsCommand(output, context);
    };
    return ResetDeploymentsCommand;
}($Command));
export { ResetDeploymentsCommand };
//# sourceMappingURL=ResetDeploymentsCommand.js.map