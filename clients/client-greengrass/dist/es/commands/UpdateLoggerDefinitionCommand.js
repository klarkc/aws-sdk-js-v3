 ...
 *
 */
var UpdateLoggerDefinitionCommand = /** @class */ (function (_super) {
    __extends(UpdateLoggerDefinitionCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function UpdateLoggerDefinitionCommand(input) {
        var _this = 
     ...
     * @internal
     */
    UpdateLoggerDefinitionCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "GreengrassClient";
        var commandName = "UpdateLoggerDefinitionCommand";
    ...
    UpdateLoggerDefinitionCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1UpdateLoggerDefinitionCommand(input, context);
    };
    UpdateLoggerDefinitionCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1UpdateLoggerDefinitionCommand(output, context);
    };
    return UpdateLoggerDefinitionCommand;
}($Command));
export { UpdateLoggerDefinitionCommand };
