 ...
 *
 */
var ListCoreDefinitionsCommand = /** @class */ (function (_super) {
    __extends(ListCoreDefinitionsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListCoreDefinitionsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListCoreDefinitionsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "GreengrassClient";
        var commandName = "ListCoreDefinitionsCommand";
    ...
    ListCoreDefinitionsCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1ListCoreDefinitionsCommand(input, context);
    };
    ListCoreDefinitionsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1ListCoreDefinitionsCommand(output, context);
    };
    return ListCoreDefinitionsCommand;
}($Command));
export { ListCoreDefinitionsCommand };
//# sourceMappingURL=ListCoreDefinitionsCommand.js.map