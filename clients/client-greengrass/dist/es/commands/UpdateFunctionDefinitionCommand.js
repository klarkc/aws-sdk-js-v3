 ...
 *
 */
var UpdateFunctionDefinitionCommand = /** @class */ (function (_super) {
    __extends(UpdateFunctionDefinitionCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function UpdateFunctionDefinitionCommand(input) {
        var _this = 
     ...
     * @internal
     */
    UpdateFunctionDefinitionCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "GreengrassClient";
        var commandName = "UpdateFunctionDefinitionCommand";
    ...
    UpdateFunctionDefinitionCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1UpdateFunctionDefinitionCommand(input, context);
    };
    UpdateFunctionDefinitionCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1UpdateFunctionDefinitionCommand(output, context);
    };
    return UpdateFunctionDefinitionCommand;
}($Command));
export { UpdateFunctionDefinitionCommand };
