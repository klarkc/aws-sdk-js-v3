...
import { deserializeAws_restJson1CreateResourceDefinitionCommand, serializeAws_restJson1CreateResourceDefinitionCommand, } from "../protocols/Aws_restJson1";
 ...
 *
 */
var CreateResourceDefinitionCommand = /** @class */ (function (_super) {
    __extends(CreateResourceDefinitionCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function CreateResourceDefinitionCommand(input) {
        var _this = 
     ...
     * @internal
     */
    CreateResourceDefinitionCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "GreengrassClient";
        var commandName = "CreateResourceDefinitionCommand";
    ...
    CreateResourceDefinitionCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1CreateResourceDefinitionCommand(input, context);
    };
    CreateResourceDefinitionCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1CreateResourceDefinitionCommand(output, context);
    };
    return CreateResourceDefinitionCommand;
}($Command));
export { CreateResourceDefinitionCommand };
//# sourceMappingURL=CreateResourceDefinitionCommand.js.map