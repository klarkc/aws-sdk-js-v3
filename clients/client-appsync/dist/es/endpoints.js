...
var AWS_TEMPLATE = "appsync.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "appsync.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "appsync.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "appsync.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "appsync.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
  ...
  return Promise.resolve(__assign({ signingService: "appsync" }, regionInfo));
};
