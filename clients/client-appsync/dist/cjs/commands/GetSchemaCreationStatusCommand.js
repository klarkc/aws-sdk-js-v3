...
exports.GetSchemaCreationStatusCommand = void 0;
...
class GetSchemaCreationStatusCommand extends smithy_client_1.Command {
  ...
  resolveMiddleware(clientStack, configuration, options) {
    ...
    const handlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: models_0_1.GetSchemaCreationStatusRequest.filterSensitiveLog,
      outputFilterSensitiveLog: models_0_1.GetSchemaCreationStatusResponse.filterSensitiveLog,
    };
