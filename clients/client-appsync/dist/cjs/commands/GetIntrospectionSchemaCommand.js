...
exports.GetIntrospectionSchemaCommand = void 0;
...
class GetIntrospectionSchemaCommand extends smithy_client_1.Command {
  ...
  resolveMiddleware(clientStack, configuration, options) {
    ...
    const handlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: models_0_1.GetIntrospectionSchemaRequest.filterSensitiveLog,
      outputFilterSensitiveLog: models_0_1.GetIntrospectionSchemaResponse.filterSensitiveLog,
    };
