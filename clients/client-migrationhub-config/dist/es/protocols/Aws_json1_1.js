        ...
        switch (_a.label) {
            case 0:
                if (output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_json1_1CreateHomeRegionControlCommandError(output, context)];
                }
        ...
        switch (_k.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "com.amazonaws.migrationhubconfig#AccessDeniedException": return [3 /*break*/, 2];
                    case "DryRunOperation": return [3 /*break*/, 4];
                    case "com.amazonaws.migrationhubconfig#DryRunOperation": return [3 /*break*/, 4];
                    case "InternalServerError": return [3 /*break*/, 6];
                    case "com.amazonaws.migrationhubconfig#InternalServerError": return [3 /*break*/, 6];
                    case "InvalidInputException": return [3 /*break*/, 8];
                    case "com.amazonaws.migrationhubconfig#InvalidInputException": return [3 /*break*/, 8];
                    case "ServiceUnavailableException": return [3 /*break*/, 10];
                    case "com.amazonaws.migrationhubconfig#ServiceUnavailableException": return [3 /*break*/, 10];
                    case "ThrottlingException": return [3 /*break*/, 12];
                    case "com.amazonaws.migrationhubconfig#ThrottlingException": return [3 /*break*/, 12];
                }
                return [3 /*break*/, 14];
            case 2:
                _c = [{}];
...
export var deserializeAws_json1_1DescribeHomeRegionControlsCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_json1_1DescribeHomeRegionControlsCommandError(output, context)];
                }
                return [4 /*yield*/, parseBody(output.body, context)];
            case 1:
                data = _a.sent();
        ...
        switch (_j.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "com.amazonaws.migrationhubconfig#InternalServerError": return [3 /*break*/, 4];
                    case "InvalidInputException": return [3 /*break*/, 6];
                    case "com.amazonaws.migrationhubconfig#InvalidInputException": return [3 /*break*/, 6];
                    case "ServiceUnavailableException": return [3 /*break*/, 8];
                    case "com.amazonaws.migrationhubconfig#ServiceUnavailableException": return [3 /*break*/, 8];
                    case "ThrottlingException": return [3 /*break*/, 10];
                    case "com.amazonaws.migrationhubconfig#ThrottlingException": return [3 /*break*/, 10];
                }
                return [3 /*break*/, 12];
            case 2:
                _c = [{}];
...
export var deserializeAws_json1_1GetHomeRegionCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode >= 300) {
                    return [2 /*return*/, deserializeAws_json1_1GetHomeRegionCommandError(output, context)];
                }
                return [4 /*yield*/, parseBody(output.body, context)];
            case 1:
                data = _a.sent();
