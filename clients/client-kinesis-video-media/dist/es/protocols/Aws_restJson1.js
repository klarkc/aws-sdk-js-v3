    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                resolvedPath = "/getMedia";
                body = JSON.stringify(__assign(__assign(__assign({}, (input.StartSelector !== undefined &&
...
export var deserializeAws_restJson1GetMediaCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        if (output.statusCode !== 200 && output.statusCode >= 300) {
            return [2 /*return*/, deserializeAws_restJson1GetMediaCommandError(output, context)];
        }
        contents = {
        ...
        switch (_k.label) {
            ...
            case 1:
                ...
                switch (_b) {
                    ...
                    case "com.amazonaws.kinesisvideomedia#ClientLimitExceededException": return [3 /*break*/, 2];
                    case "ConnectionLimitExceededException": return [3 /*break*/, 4];
                    case "com.amazonaws.kinesisvideomedia#ConnectionLimitExceededException": return [3 /*break*/, 4];
                    case "InvalidArgumentException": return [3 /*break*/, 6];
                    case "com.amazonaws.kinesisvideomedia#InvalidArgumentException": return [3 /*break*/, 6];
                    case "InvalidEndpointException": return [3 /*break*/, 8];
                    case "com.amazonaws.kinesisvideomedia#InvalidEndpointException": return [3 /*break*/, 8];
                    case "NotAuthorizedException": return [3 /*break*/, 10];
                    case "com.amazonaws.kinesisvideomedia#NotAuthorizedException": return [3 /*break*/, 10];
                    case "ResourceNotFoundException": return [3 /*break*/, 12];
                    case "com.amazonaws.kinesisvideomedia#ResourceNotFoundException": return [3 /*break*/, 12];
                }
                return [3 /*break*/, 14];
            case 2:
                _c = [{}];
            ...
            case 4:
                _d = [{}];
                return [4 /*yield*/, deserializeAws_restJson1ConnectionLimitExceededExceptionResponse(parsedOutput, context)];
            case 5:
            ...
            case 8:
                _f = [{}];
                return [4 /*yield*/, deserializeAws_restJson1InvalidEndpointExceptionResponse(parsedOutput, context)];
            case 9:
...
var serializeAws_restJson1StartSelector = function (input, context) {
    return __assign(__assign(__assign(__assign({}, (input.AfterFragmentNumber !== undefined &&
        input.AfterFragmentNumber !== null && { AfterFragmentNumber: input.AfterFragmentNumber })), (input.ContinuationToken !== undefined &&
        input.ContinuationToken !== null && { ContinuationToken: input.ContinuationToken })), (input.StartSelectorType !== undefined &&
        input.StartSelectorType !== null && { StartSelectorType: input.StartSelectorType })), (input.StartTimestamp !== undefined &&
