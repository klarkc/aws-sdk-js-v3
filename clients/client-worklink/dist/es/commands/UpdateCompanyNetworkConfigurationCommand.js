...
import { deserializeAws_restJson1UpdateCompanyNetworkConfigurationCommand, serializeAws_restJson1UpdateCompanyNetworkConfigurationCommand, } from "../protocols/Aws_restJson1";
 ...
 *
 */
var UpdateCompanyNetworkConfigurationCommand = /** @class */ (function (_super) {
    __extends(UpdateCompanyNetworkConfigurationCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function UpdateCompanyNetworkConfigurationCommand(input) {
        var _this = 
     ...
     * @internal
     */
    UpdateCompanyNetworkConfigurationCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "WorkLinkClient";
        var commandName = "UpdateCompanyNetworkConfigurationCommand";
    ...
    UpdateCompanyNetworkConfigurationCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1UpdateCompanyNetworkConfigurationCommand(input, context);
    };
    UpdateCompanyNetworkConfigurationCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1UpdateCompanyNetworkConfigurationCommand(output, context);
    };
    return UpdateCompanyNetworkConfigurationCommand;
}($Command));
export { UpdateCompanyNetworkConfigurationCommand };
