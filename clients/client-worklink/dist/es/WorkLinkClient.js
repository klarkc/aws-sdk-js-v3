 ...
 *             mobile devices.</p>
 */
var WorkLinkClient = /** @class */ (function (_super) {
    __extends(WorkLinkClient, _super);
    function WorkLinkClient(configuration) {
        var _this = this;
     ...
     */
    WorkLinkClient.prototype.destroy = function () {
        _super.prototype.destroy.call(this);
    };
    return WorkLinkClient;
}(__Client));
export { WorkLinkClient };
