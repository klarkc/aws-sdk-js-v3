...
export declare namespace ConcurrentUpdateException {
  /**
   * @internal
   */
  const filterSensitiveLog: (obj: ConcurrentUpdateException) => any;
}
...
export declare namespace FailedResourceAccessException {
  /**
   * @internal
   */
  const filterSensitiveLog: (obj: FailedResourceAccessException) => any;
}
