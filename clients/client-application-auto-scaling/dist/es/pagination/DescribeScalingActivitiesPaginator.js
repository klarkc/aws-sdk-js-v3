    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            client.send.apply(client, __spreadArray([new DescribeScalingActivitiesCommand(input)], __read(args))),
          ];
        case 1:
          // @ts-ignore
...
var makePagedRequest = function (client, input) {
  ...
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, client.describeScalingActivities.apply(client, __spreadArray([input], __read(args)))];
        case 1:
          // @ts-ignore
          return [2 /*return*/, _a.sent()];
      }
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          if (!(config.client instanceof ApplicationAutoScaling)) return [3 /*break*/, 3];
          return [
            4 /*yield*/,
        ...
        case 2:
          ...
          return [3 /*break*/, 6];
        case 3:
          if (!(config.client instanceof ApplicationAutoScalingClient)) return [3 /*break*/, 5];
          return [
            4 /*yield*/,
            __await(
