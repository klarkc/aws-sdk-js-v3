...
var AWS_TEMPLATE = "application-autoscaling.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "application-autoscaling.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "application-autoscaling.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "application-autoscaling.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "application-autoscaling.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
  ...
  return Promise.resolve(__assign({ signingService: "application-autoscaling" }, regionInfo));
};
