...
const AWS_TEMPLATE = "mediapackage.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "mediapackage.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "mediapackage.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "mediapackage.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "mediapackage.{region}.amazonaws.com";
// Partition regions
