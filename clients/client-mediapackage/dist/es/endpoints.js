...
var AWS_TEMPLATE = "mediapackage.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "mediapackage.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "mediapackage.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "mediapackage.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "mediapackage.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "eu-north-1":
            regionInfo = {
                hostname: "mediapackage.eu-north-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-west-1":
    ...
    return Promise.resolve(__assign({ signingService: "mediapackage" }, regionInfo));
};
