...
var AWS_TEMPLATE = "states.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "states.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "states.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "states.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "states.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    switch (region) {
        ...
        case "ap-northeast-3":
            regionInfo = {
                hostname: "states.ap-northeast-3.amazonaws.com",
                partition: "aws",
            };
            break;
        case "ap-south-1":
        ...
        case "eu-south-1":
            regionInfo = {
                hostname: "states.eu-south-1.amazonaws.com",
                partition: "aws",
            };
            break;
        case "eu-west-1":
    ...
    return Promise.resolve(__assign({ signingService: "states" }, regionInfo));
};
