...
const AWS_TEMPLATE = "states.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "states.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "states.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "states.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "states.{region}.amazonaws.com";
// Partition regions
