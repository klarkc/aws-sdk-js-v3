    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            client.send.apply(client, __spreadArray([new DescribeImportTasksCommand(input)], __read(args))),
          ];
        case 1:
          // @ts-ignore
...
var makePagedRequest = function (client, input) {
  ...
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, client.describeImportTasks.apply(client, __spreadArray([input], __read(args)))];
        case 1:
          // @ts-ignore
          return [2 /*return*/, _a.sent()];
      }
...
export function paginateDescribeImportTasks(config, input) {
  var additionalArguments = [];
  for (var _i = 2; _i < arguments.length; _i++) {
    additionalArguments[_i - 2] = arguments[_i];
  }
  return __asyncGenerator(this, arguments, function paginateDescribeImportTasks_1() {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          if (!(config.client instanceof ApplicationDiscoveryService)) return [3 /*break*/, 3];
          return [
            4 /*yield*/,
        ...
        case 2:
          ...
          return [3 /*break*/, 6];
        case 3:
          if (!(config.client instanceof ApplicationDiscoveryServiceClient)) return [3 /*break*/, 5];
          return [
            4 /*yield*/,
            __await(
