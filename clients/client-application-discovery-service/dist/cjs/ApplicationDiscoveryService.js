...
class ApplicationDiscoveryService extends ApplicationDiscoveryServiceClient_1.ApplicationDiscoveryServiceClient {
  associateConfigurationItemsToApplication(args, optionsOrCb, cb) {
    const command =
      new AssociateConfigurationItemsToApplicationCommand_1.AssociateConfigurationItemsToApplicationCommand(args);
  ...
  disassociateConfigurationItemsFromApplication(args, optionsOrCb, cb) {
    const command =
      new DisassociateConfigurationItemsFromApplicationCommand_1.DisassociateConfigurationItemsFromApplicationCommand(
        args
      );
    if (typeof optionsOrCb === "function") {
      this.send(command, optionsOrCb);
