 ...
 */
var OutpostsClient = /** @class */ (function (_super) {
    __extends(OutpostsClient, _super);
    function OutpostsClient(configuration) {
        var _this = this;
     ...
     */
    OutpostsClient.prototype.destroy = function () {
        _super.prototype.destroy.call(this);
    };
    return OutpostsClient;
}(__Client));
export { OutpostsClient };
