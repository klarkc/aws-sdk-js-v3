...
var AWS_TEMPLATE = "schemas.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "schemas.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "schemas.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "schemas.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "schemas.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "schemas" }, regionInfo));
};
