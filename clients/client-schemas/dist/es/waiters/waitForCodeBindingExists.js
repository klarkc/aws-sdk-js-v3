...
import { DescribeCodeBindingCommand } from "../commands/DescribeCodeBindingCommand";
...
var checkState = function (client, input) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, client.send(new DescribeCodeBindingCommand(input))];
            case 1:
                result_1 = _a.sent();
                reason = result_1;
                try {
            ...
            case 2:
                exception_1 = _a.sent();
                reason = exception_1;
                if (exception_1.name && exception_1.name == "NotFoundException") {
                    return [2 /*return*/, { state: WaiterState.FAILURE, reason: reason }];
                }
                return [3 /*break*/, 3];
 ...
 */
export var waitForCodeBindingExists = function (params, input) { return __awaiter(void 0, void 0, void 0, function () {
    var serviceDefaults;
    return __generator(this, function (_a) {
 ...
 */
export var waitUntilCodeBindingExists = function (params, input) { return __awaiter(void 0, void 0, void 0, function () {
