...
var CreateDiscovererCommand = /** @class */ (function (_super) {
    ...
    CreateDiscovererCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        ...
        var commandName = "CreateDiscovererCommand";
    ...
    CreateDiscovererCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1CreateDiscovererCommand(input, context);
    };
    CreateDiscovererCommand.prototype.deserialize = function (output, context) {
