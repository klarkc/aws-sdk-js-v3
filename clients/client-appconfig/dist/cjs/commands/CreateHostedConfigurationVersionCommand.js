...
exports.CreateHostedConfigurationVersionCommand = void 0;
...
class CreateHostedConfigurationVersionCommand extends smithy_client_1.Command {
  ...
  resolveMiddleware(clientStack, configuration, options) {
    ...
    const handlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: models_0_1.CreateHostedConfigurationVersionRequest.filterSensitiveLog,
  ...
  serialize(input, context) {
    return Aws_restJson1_1.serializeAws_restJson1CreateHostedConfigurationVersionCommand(input, context);
  }
  deserialize(output, context) {
    return Aws_restJson1_1.deserializeAws_restJson1CreateHostedConfigurationVersionCommand(output, context);
  }
}
