...
exports.GetConfigurationProfileCommand = void 0;
...
class GetConfigurationProfileCommand extends smithy_client_1.Command {
  ...
  resolveMiddleware(clientStack, configuration, options) {
    ...
    const handlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: models_0_1.GetConfigurationProfileRequest.filterSensitiveLog,
  ...
  serialize(input, context) {
    return Aws_restJson1_1.serializeAws_restJson1GetConfigurationProfileCommand(input, context);
  }
  deserialize(output, context) {
    return Aws_restJson1_1.deserializeAws_restJson1GetConfigurationProfileCommand(output, context);
  }
}
