...
exports.DeleteHostedConfigurationVersionCommand = void 0;
...
class DeleteHostedConfigurationVersionCommand extends smithy_client_1.Command {
  ...
  resolveMiddleware(clientStack, configuration, options) {
    ...
    const handlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: models_0_1.DeleteHostedConfigurationVersionRequest.filterSensitiveLog,
  ...
  serialize(input, context) {
    return Aws_restJson1_1.serializeAws_restJson1DeleteHostedConfigurationVersionCommand(input, context);
  }
  deserialize(output, context) {
    return Aws_restJson1_1.deserializeAws_restJson1DeleteHostedConfigurationVersionCommand(output, context);
  }
}
