...
import { deserializeAws_json1_1DescribeElasticIpsCommand, serializeAws_json1_1DescribeElasticIpsCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var DescribeElasticIpsCommand = /** @class */ (function (_super) {
    __extends(DescribeElasticIpsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DescribeElasticIpsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DescribeElasticIpsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "OpsWorksClient";
        var commandName = "DescribeElasticIpsCommand";
    ...
    DescribeElasticIpsCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DescribeElasticIpsCommand(input, context);
    };
    DescribeElasticIpsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DescribeElasticIpsCommand(output, context);
    };
    return DescribeElasticIpsCommand;
}($Command));
export { DescribeElasticIpsCommand };
