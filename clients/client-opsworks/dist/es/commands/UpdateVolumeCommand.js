 ...
 *
 */
var UpdateVolumeCommand = /** @class */ (function (_super) {
    __extends(UpdateVolumeCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function UpdateVolumeCommand(input) {
        var _this = 
     ...
     * @internal
     */
    UpdateVolumeCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "OpsWorksClient";
        var commandName = "UpdateVolumeCommand";
    ...
    UpdateVolumeCommand.prototype.deserialize = function (output, context) {
