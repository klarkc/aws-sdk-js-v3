...
import { deserializeAws_json1_1DetachElasticLoadBalancerCommand, serializeAws_json1_1DetachElasticLoadBalancerCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var DetachElasticLoadBalancerCommand = /** @class */ (function (_super) {
    __extends(DetachElasticLoadBalancerCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DetachElasticLoadBalancerCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DetachElasticLoadBalancerCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "OpsWorksClient";
        var commandName = "DetachElasticLoadBalancerCommand";
    ...
    DetachElasticLoadBalancerCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DetachElasticLoadBalancerCommand(input, context);
    };
    DetachElasticLoadBalancerCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DetachElasticLoadBalancerCommand(output, context);
    };
    return DetachElasticLoadBalancerCommand;
}($Command));
export { DetachElasticLoadBalancerCommand };
