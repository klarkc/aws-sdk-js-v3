 ...
 *
 */
var StopStackCommand = /** @class */ (function (_super) {
    __extends(StopStackCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function StopStackCommand(input) {
        var _this = 
     ...
     * @internal
     */
    StopStackCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "OpsWorksClient";
        var commandName = "StopStackCommand";
    ...
    StopStackCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1StopStackCommand(input, context);
    };
    StopStackCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1StopStackCommand(output, context);
    };
    return StopStackCommand;
}($Command));
export { StopStackCommand };
//# sourceMappingURL=StopStackCommand.js.map