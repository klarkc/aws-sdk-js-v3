...
import { deserializeAws_json1_1DeregisterRdsDbInstanceCommand, serializeAws_json1_1DeregisterRdsDbInstanceCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var DeregisterRdsDbInstanceCommand = /** @class */ (function (_super) {
    __extends(DeregisterRdsDbInstanceCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DeregisterRdsDbInstanceCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DeregisterRdsDbInstanceCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "OpsWorksClient";
        var commandName = "DeregisterRdsDbInstanceCommand";
    ...
    DeregisterRdsDbInstanceCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DeregisterRdsDbInstanceCommand(input, context);
    };
    DeregisterRdsDbInstanceCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DeregisterRdsDbInstanceCommand(output, context);
    };
    return DeregisterRdsDbInstanceCommand;
}($Command));
export { DeregisterRdsDbInstanceCommand };
//# sourceMappingURL=DeregisterRdsDbInstanceCommand.js.map