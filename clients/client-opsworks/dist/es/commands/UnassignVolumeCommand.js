...
import { deserializeAws_json1_1UnassignVolumeCommand, serializeAws_json1_1UnassignVolumeCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var UnassignVolumeCommand = /** @class */ (function (_super) {
    __extends(UnassignVolumeCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function UnassignVolumeCommand(input) {
        var _this = 
     ...
     * @internal
     */
    UnassignVolumeCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "OpsWorksClient";
        var commandName = "UnassignVolumeCommand";
    ...
    UnassignVolumeCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1UnassignVolumeCommand(input, context);
    };
    UnassignVolumeCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1UnassignVolumeCommand(output, context);
    };
    return UnassignVolumeCommand;
}($Command));
export { UnassignVolumeCommand };
