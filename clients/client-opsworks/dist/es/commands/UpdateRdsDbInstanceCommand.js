...
import { deserializeAws_json1_1UpdateRdsDbInstanceCommand, serializeAws_json1_1UpdateRdsDbInstanceCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var UpdateRdsDbInstanceCommand = /** @class */ (function (_super) {
    __extends(UpdateRdsDbInstanceCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function UpdateRdsDbInstanceCommand(input) {
        var _this = 
     ...
     * @internal
     */
    UpdateRdsDbInstanceCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "OpsWorksClient";
        var commandName = "UpdateRdsDbInstanceCommand";
    ...
    UpdateRdsDbInstanceCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1UpdateRdsDbInstanceCommand(input, context);
    };
    UpdateRdsDbInstanceCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1UpdateRdsDbInstanceCommand(output, context);
    };
    return UpdateRdsDbInstanceCommand;
}($Command));
export { UpdateRdsDbInstanceCommand };
//# sourceMappingURL=UpdateRdsDbInstanceCommand.js.map