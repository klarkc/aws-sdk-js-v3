...
import { deserializeAws_json1_1UpdateLayerCommand, serializeAws_json1_1UpdateLayerCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var UpdateLayerCommand = /** @class */ (function (_super) {
    __extends(UpdateLayerCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function UpdateLayerCommand(input) {
        var _this = 
     ...
     * @internal
     */
    UpdateLayerCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "OpsWorksClient";
        var commandName = "UpdateLayerCommand";
    ...
    UpdateLayerCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1UpdateLayerCommand(input, context);
    };
    UpdateLayerCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1UpdateLayerCommand(output, context);
    };
    return UpdateLayerCommand;
}($Command));
export { UpdateLayerCommand };
//# sourceMappingURL=UpdateLayerCommand.js.map