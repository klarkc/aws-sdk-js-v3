...
import { deserializeAws_json1_1DescribePermissionsCommand, serializeAws_json1_1DescribePermissionsCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var DescribePermissionsCommand = /** @class */ (function (_super) {
    __extends(DescribePermissionsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DescribePermissionsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DescribePermissionsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "OpsWorksClient";
        var commandName = "DescribePermissionsCommand";
    ...
    DescribePermissionsCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DescribePermissionsCommand(input, context);
    };
    DescribePermissionsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DescribePermissionsCommand(output, context);
    };
    return DescribePermissionsCommand;
}($Command));
export { DescribePermissionsCommand };
