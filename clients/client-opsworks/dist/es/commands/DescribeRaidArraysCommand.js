...
import { deserializeAws_json1_1DescribeRaidArraysCommand, serializeAws_json1_1DescribeRaidArraysCommand, } from "../protocols/Aws_json1_1";
 ...
 *
 */
var DescribeRaidArraysCommand = /** @class */ (function (_super) {
    __extends(DescribeRaidArraysCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DescribeRaidArraysCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DescribeRaidArraysCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "OpsWorksClient";
        var commandName = "DescribeRaidArraysCommand";
    ...
    DescribeRaidArraysCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DescribeRaidArraysCommand(input, context);
    };
    DescribeRaidArraysCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DescribeRaidArraysCommand(output, context);
    };
    return DescribeRaidArraysCommand;
}($Command));
export { DescribeRaidArraysCommand };
