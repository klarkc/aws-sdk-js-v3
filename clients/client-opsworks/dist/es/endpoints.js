...
var AWS_TEMPLATE = "opsworks.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "opsworks.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "opsworks.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "opsworks.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "opsworks.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "opsworks" }, regionInfo));
};
