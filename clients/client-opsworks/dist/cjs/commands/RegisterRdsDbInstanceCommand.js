...
exports.RegisterRdsDbInstanceCommand = void 0;
 ...
 *
 */
class RegisterRdsDbInstanceCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.RegisterRdsDbInstanceRequest.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_json1_1_1.serializeAws_json1_1RegisterRdsDbInstanceCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_json1_1_1.deserializeAws_json1_1RegisterRdsDbInstanceCommand(output, context);
    }
}
exports.RegisterRdsDbInstanceCommand = RegisterRdsDbInstanceCommand;
