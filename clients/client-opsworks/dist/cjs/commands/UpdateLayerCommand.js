...
exports.UpdateLayerCommand = void 0;
 ...
 *
 */
class UpdateLayerCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.UpdateLayerRequest.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_json1_1_1.serializeAws_json1_1UpdateLayerCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_json1_1_1.deserializeAws_json1_1UpdateLayerCommand(output, context);
    }
}
exports.UpdateLayerCommand = UpdateLayerCommand;
