...
exports.SetTimeBasedAutoScalingCommand = void 0;
 ...
 *
 */
class SetTimeBasedAutoScalingCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.SetTimeBasedAutoScalingRequest.filterSensitiveLog,
    ...
    serialize(input, context) {
        return Aws_json1_1_1.serializeAws_json1_1SetTimeBasedAutoScalingCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_json1_1_1.deserializeAws_json1_1SetTimeBasedAutoScalingCommand(output, context);
    }
}
exports.SetTimeBasedAutoScalingCommand = SetTimeBasedAutoScalingCommand;
