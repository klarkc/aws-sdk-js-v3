...
exports.DescribeAppsCommand = void 0;
 ...
 *
 */
class DescribeAppsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DescribeAppsRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.DescribeAppsResult.filterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return Aws_json1_1_1.serializeAws_json1_1DescribeAppsCommand(input, context);
    }
    deserialize(output, context) {
        return Aws_json1_1_1.deserializeAws_json1_1DescribeAppsCommand(output, context);
    }
}
exports.DescribeAppsCommand = DescribeAppsCommand;
