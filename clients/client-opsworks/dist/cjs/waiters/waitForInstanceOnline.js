...
exports.waitUntilInstanceOnline = exports.waitForInstanceOnline = void 0;
 ...
 */
const waitForInstanceOnline = async (params, input) => {
    const serviceDefaults = { minDelay: 15, maxDelay: 120 };
    return util_waiter_1.createWaiter({ ...serviceDefaults, ...params }, input, checkState);
};
exports.waitForInstanceOnline = waitForInstanceOnline;
/**
 * Wait until OpsWorks instance is online.
 *  @param params - Waiter configuration options.
 *  @param input - The input to DescribeInstancesCommand for polling.
 */
const waitUntilInstanceOnline = async (params, input) => {
    const serviceDefaults = { minDelay: 15, maxDelay: 120 };
    const result = await util_waiter_1.createWaiter({ ...serviceDefaults, ...params }, input, checkState);
    return util_waiter_1.checkExceptions(result);
};
exports.waitUntilInstanceOnline = waitUntilInstanceOnline;
