...
const AWS_TEMPLATE = "iotthingsgraph.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "iotthingsgraph.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "iotthingsgraph.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "iotthingsgraph.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "iotthingsgraph.{region}.amazonaws.com";
// Partition regions
