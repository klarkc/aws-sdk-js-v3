...
var AWS_TEMPLATE = "iotthingsgraph.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "iotthingsgraph.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "iotthingsgraph.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "iotthingsgraph.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "iotthingsgraph.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "iotthingsgraph" }, regionInfo));
};
