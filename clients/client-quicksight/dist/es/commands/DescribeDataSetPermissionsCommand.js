 ...
 *
 */
var DescribeDataSetPermissionsCommand = /** @class */ (function (_super) {
    __extends(DescribeDataSetPermissionsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DescribeDataSetPermissionsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DescribeDataSetPermissionsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "QuickSightClient";
        var commandName = "DescribeDataSetPermissionsCommand";
    ...
    DescribeDataSetPermissionsCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1DescribeDataSetPermissionsCommand(input, context);
    };
    DescribeDataSetPermissionsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1DescribeDataSetPermissionsCommand(output, context);
    };
    return DescribeDataSetPermissionsCommand;
}($Command));
export { DescribeDataSetPermissionsCommand };
