 ...
 *
 */
var ListGroupMembershipsCommand = /** @class */ (function (_super) {
    __extends(ListGroupMembershipsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListGroupMembershipsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListGroupMembershipsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "QuickSightClient";
        var commandName = "ListGroupMembershipsCommand";
    ...
    ListGroupMembershipsCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1ListGroupMembershipsCommand(input, context);
    };
    ListGroupMembershipsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1ListGroupMembershipsCommand(output, context);
    };
    return ListGroupMembershipsCommand;
}($Command));
export { ListGroupMembershipsCommand };
