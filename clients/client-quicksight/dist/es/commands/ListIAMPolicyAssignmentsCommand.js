 ...
 *
 */
var ListIAMPolicyAssignmentsCommand = /** @class */ (function (_super) {
    __extends(ListIAMPolicyAssignmentsCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function ListIAMPolicyAssignmentsCommand(input) {
        var _this = 
     ...
     * @internal
     */
    ListIAMPolicyAssignmentsCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "QuickSightClient";
        var commandName = "ListIAMPolicyAssignmentsCommand";
    ...
    ListIAMPolicyAssignmentsCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1ListIAMPolicyAssignmentsCommand(input, context);
    };
    ListIAMPolicyAssignmentsCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1ListIAMPolicyAssignmentsCommand(output, context);
    };
    return ListIAMPolicyAssignmentsCommand;
}($Command));
export { ListIAMPolicyAssignmentsCommand };
