 ...
 *
 */
var CreateIAMPolicyAssignmentCommand = /** @class */ (function (_super) {
    __extends(CreateIAMPolicyAssignmentCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function CreateIAMPolicyAssignmentCommand(input) {
        var _this = 
     ...
     * @internal
     */
    CreateIAMPolicyAssignmentCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "QuickSightClient";
        var commandName = "CreateIAMPolicyAssignmentCommand";
    ...
    CreateIAMPolicyAssignmentCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1CreateIAMPolicyAssignmentCommand(input, context);
    };
    CreateIAMPolicyAssignmentCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_restJson1CreateIAMPolicyAssignmentCommand(output, context);
    };
    return CreateIAMPolicyAssignmentCommand;
}($Command));
export { CreateIAMPolicyAssignmentCommand };
