...
const AWS_TEMPLATE = "dax.{region}.amazonaws.com";
const AWS_CN_TEMPLATE = "dax.{region}.amazonaws.com.cn";
const AWS_ISO_TEMPLATE = "dax.{region}.c2s.ic.gov";
const AWS_ISO_B_TEMPLATE = "dax.{region}.sc2s.sgov.gov";
const AWS_US_GOV_TEMPLATE = "dax.{region}.amazonaws.com";
// Partition regions
