...
var AWS_TEMPLATE = "dax.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "dax.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "dax.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "dax.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "dax.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "dax" }, regionInfo));
};
