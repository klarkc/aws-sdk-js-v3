 ...
 *
 */
var DeleteContainerPolicyCommand = /** @class */ (function (_super) {
    __extends(DeleteContainerPolicyCommand, _super);
    // Start section: command_properties
    // End section: command_properties
    function DeleteContainerPolicyCommand(input) {
        var _this = 
     ...
     * @internal
     */
    DeleteContainerPolicyCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        this.middlewareStack.use(getSerdePlugin(configuration, this.serialize, this.deserialize));
        var stack = clientStack.concat(this.middlewareStack);
        var logger = configuration.logger;
        var clientName = "MediaStoreClient";
        var commandName = "DeleteContainerPolicyCommand";
    ...
    DeleteContainerPolicyCommand.prototype.serialize = function (input, context) {
        return serializeAws_json1_1DeleteContainerPolicyCommand(input, context);
    };
    DeleteContainerPolicyCommand.prototype.deserialize = function (output, context) {
        return deserializeAws_json1_1DeleteContainerPolicyCommand(output, context);
    };
    return DeleteContainerPolicyCommand;
}($Command));
export { DeleteContainerPolicyCommand };
