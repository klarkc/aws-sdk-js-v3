...
var UpdateVodSourceCommand = /** @class */ (function (_super) {
    ...
    UpdateVodSourceCommand.prototype.resolveMiddleware = function (clientStack, configuration, options) {
        ...
        var commandName = "UpdateVodSourceCommand";
    ...
    UpdateVodSourceCommand.prototype.serialize = function (input, context) {
        return serializeAws_restJson1UpdateVodSourceCommand(input, context);
    };
    UpdateVodSourceCommand.prototype.deserialize = function (output, context) {
